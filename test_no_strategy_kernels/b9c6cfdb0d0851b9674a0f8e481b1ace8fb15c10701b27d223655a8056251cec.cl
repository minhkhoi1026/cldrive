...
kernel void des_encrypt_kern(ulong key_start, ulong data, global ulong4* output) {
  ...
  output[hook(2, gti)] = DESEncrypt((ulong4)(data, data, data, data), (ulong4)(c_key, c_key + 1, c_key + 2, c_key + 3));
}