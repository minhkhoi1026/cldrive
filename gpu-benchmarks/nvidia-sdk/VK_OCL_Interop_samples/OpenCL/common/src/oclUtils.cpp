...
//////////////////////////////////////////////////////////////////////////////
//! Gets the platform ID for NVIDIA if available, otherwise return NVIDIA_PLATFORM_NOT_FOUND.
//!
//! @return the id
    ...
    if (ciErrNum != CL_SUCCESS) {
        ...
        if (num_platforms == 0) {
            ...
            if (*clSelectedPlatformID == NULL) {
                shrLog("WARNING: NVIDIA OpenCL platform not found\n\n");
                result = NVIDIA_PLATFORM_NOT_FOUND;
            }
            free(clPlatformIDs);
        }
    }
...
{
    // cl_channel_order
    if (uiImageFormat == CL_R) {
        return "CL_R";
    }

    if (uiImageFormat == CL_A) {
        return "CL_A";
    }

    if (uiImageFormat == CL_RG) {
        return "CL_RG";
    }

    if (uiImageFormat == CL_RA) {
        return "CL_RA";
    }

    if (uiImageFormat == CL_RGB) {
        return "CL_RGB";
    }

    if (uiImageFormat == CL_RGBA) {
        return "CL_RGBA";
    }

    if (uiImageFormat == CL_BGRA) {
        return "CL_BGRA";
    }

    if (uiImageFormat == CL_ARGB) {
        return "CL_ARGB";
    }

    if (uiImageFormat == CL_INTENSITY) {
        return "CL_INTENSITY";
    }

    if (uiImageFormat == CL_LUMINANCE) {
        return "CL_LUMINANCE";
    }

    // cl_channel_type
    if (uiImageFormat == CL_SNORM_INT8) {
        return "CL_SNORM_INT8";
    }

    if (uiImageFormat == CL_SNORM_INT16) {
        return "CL_SNORM_INT16";
    }

    if (uiImageFormat == CL_UNORM_INT8) {
        return "CL_UNORM_INT8";
    }

    if (uiImageFormat == CL_UNORM_INT16) {
        return "CL_UNORM_INT16";
    }

    if (uiImageFormat == CL_UNORM_SHORT_565) {
        return "CL_UNORM_SHORT_565";
    }

    if (uiImageFormat == CL_UNORM_SHORT_555) {
        return "CL_UNORM_SHORT_555";
    }

    if (uiImageFormat == CL_UNORM_INT_101010) {
        return "CL_UNORM_INT_101010";
    }

    if (uiImageFormat == CL_SIGNED_INT8) {
        return "CL_SIGNED_INT8";
    }

    if (uiImageFormat == CL_SIGNED_INT16) {
        return "CL_SIGNED_INT16";
    }

    if (uiImageFormat == CL_SIGNED_INT32) {
        return "CL_SIGNED_INT32";
    }

    if (uiImageFormat == CL_UNSIGNED_INT8) {
        return "CL_UNSIGNED_INT8";
    }

    if (uiImageFormat == CL_UNSIGNED_INT16) {
        return "CL_UNSIGNED_INT16";
    }

    if (uiImageFormat == CL_UNSIGNED_INT32) {
        return "CL_UNSIGNED_INT32";
    }

    if (uiImageFormat == CL_HALF_FLOAT) {
        return "CL_HALF_FLOAT";
    }

    if (uiImageFormat == CL_FLOAT) {
        return "CL_FLOAT";
    }
