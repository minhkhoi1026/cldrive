                ...
                const    int bench)
{
    ...
    uchar4 color[4];
    color[hook(8, 0)].s0 = ((1.0f + native_cos(c)) * 0.5f) * 255;
    color[hook(8, 0)].s1 = ((1.0f + native_cos(2.0f * c + 2.0f * 3.1416f / 3.0f)) * 0.5f) * 255;
    color[hook(8, 0)].s2 = ((1.0f + native_cos(c - 2.0f * 3.1416f / 3.0f)) * 0.5f) * 255;
    color[hook(8, 0)].s3 = 0xff;
    ...
    if (bench)
    {
        color[hook(8, 0)].s0 = ccount.s0 & 0xff;
        color[hook(8, 0)].s1 = (ccount.s0 & 0xff00) >> 8;
        color[hook(8, 0)].s2 = (ccount.s0 & 0xff0000) >> 16;
        color[hook(8, 0)].s3 = (ccount.s0 & 0xff000000) >> 24;
    }
    mandelbrotImage[hook(0, 4 * tid)] = color[hook(8, 0)];    
    c = fc.s1 * 2.0f * 3.1416f / 256.0f;
    color[hook(8, 1)].s0 = ((1.0f + native_cos(c)) * 0.5f) * 255;
    color[hook(8, 1)].s1 = ((1.0f + native_cos(2.0f * c + 2.0f * 3.1416f / 3.0f)) * 0.5f) * 255;
    color[hook(8, 1)].s2 = ((1.0f + native_cos(c - 2.0f * 3.1416f / 3.0f)) * 0.5f) * 255;
    color[hook(8, 1)].s3 = 0xff;
    ...
    if (bench)
    {
        color[hook(8, 1)].s0 = ccount.s1 & 0xff;
        color[hook(8, 1)].s1 = (ccount.s1 & 0xff00) >> 8;
        color[hook(8, 1)].s2 = (ccount.s1 & 0xff0000) >> 16;
        color[hook(8, 1)].s3 = (ccount.s1 & 0xff000000) >> 24;
    }
    mandelbrotImage[hook(0, 4 * tid + 1)] = color[hook(8, 1)];    
    c = fc.s2 * 2.0f * 3.1416f / 256.0f;
    color[hook(8, 2)].s0 = ((1.0f + native_cos(c)) * 0.5f) * 255;
    color[hook(8, 2)].s1 = ((1.0f + native_cos(2.0f * c + 2.0f * 3.1416f / 3.0f)) * 0.5f) * 255;
    color[hook(8, 2)].s2 = ((1.0f + native_cos(c - 2.0f * 3.1416f / 3.0f)) * 0.5f) * 255;
    color[hook(8, 2)].s3 = 0xff;
    ...
    if (bench)
    {
        color[hook(8, 2)].s0 = ccount.s2 & 0xff;
        color[hook(8, 2)].s1 = (ccount.s2 & 0xff00) >> 8;
        color[hook(8, 2)].s2 = (ccount.s2 & 0xff0000) >> 16;
        color[hook(8, 2)].s3 = (ccount.s2 & 0xff000000) >> 24;
    }
    mandelbrotImage[hook(0, 4 * tid + 2)] = color[hook(8, 2)];    
    c = fc.s3 * 2.0f * 3.1416f / 256.0f;
    color[hook(8, 3)].s0 = ((1.0f + native_cos(c)) * 0.5f) * 255;
    color[hook(8, 3)].s1 = ((1.0f + native_cos(2.0f * c + 2.0f * 3.1416f / 3.0f)) * 0.5f) * 255;
    color[hook(8, 3)].s2 = ((1.0f + native_cos(c - 2.0f * 3.1416f / 3.0f)) * 0.5f) * 255;
    color[hook(8, 3)].s3 = 0xff;
    ...
    if (bench)
    {
        color[hook(8, 3)].s0 = ccount.s3 & 0xff;
        color[hook(8, 3)].s1 = (ccount.s3 & 0xff00) >> 8;
        color[hook(8, 3)].s2 = (ccount.s3 & 0xff0000) >> 16;
        color[hook(8, 3)].s3 = (ccount.s3 & 0xff000000) >> 24;
    }
    mandelbrotImage[hook(0, 4 * tid + 3)] = color[hook(8, 3)];
}
