                          ...
                          __global uchar4 *outputImage)
{
    ...
    red = inputImage[hook(0, index)].x;
    green = inputImage[hook(0, index)].y;
    blue = inputImage[hook(0, index)].z;
    ...
    outputImage[hook(1, index)].x = red;
    outputImage[hook(1, index)].y = green;
    outputImage[hook(1, index)].z = blue;
    outputImage[hook(1, index)].w = inputImage[hook(0, index)].w;
}
