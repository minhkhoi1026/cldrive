//{"input":0,"output":1,"output_height":3,"output_width":2}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void kernel_image_scaler(read_only image2d_t input, write_only image2d_t output, const unsigned int output_width, const unsigned int output_height) {
