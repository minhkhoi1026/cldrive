//{"image":0,"label":2,"segmentation":1,"upperThreshold":3}
...
kernel void thresholdingWithOnlyUpper(read_only image2d_t image, write_only image2d_t segmentation, private uchar label, private float upperThreshold) {
