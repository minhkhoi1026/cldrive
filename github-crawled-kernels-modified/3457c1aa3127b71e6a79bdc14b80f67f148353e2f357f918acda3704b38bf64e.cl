...
kernel void bpnn_adjust_weights_ocl(global float* restrict delta, int hid, global float* restrict ly, int in, global float* restrict w, global float* restrict oldw) {
