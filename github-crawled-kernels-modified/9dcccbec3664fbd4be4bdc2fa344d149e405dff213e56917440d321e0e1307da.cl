...
kernel void detail_filter(read_only image2d_t srcImg, write_only image2d_t dstImg, sampler_t sampler, int width, int height) {
  int4 kernelWeights[9] = {0, -1, 0, -1, 10, -1, 0, -1, 0};
  int scale = 6;
  int offset = 0;
