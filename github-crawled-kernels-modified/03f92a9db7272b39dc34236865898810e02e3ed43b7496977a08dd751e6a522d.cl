...
kernel void test_block_6_3_kern(global int* a0, global int* a1, global int* a2, global int* a3, global int* a4, global int* a5, global int* b0, global int* b1, global int* b2, local int* c0, local int* c1, local int* c2, local int* c3, local int* c4, local int* c5) {
  int i;
