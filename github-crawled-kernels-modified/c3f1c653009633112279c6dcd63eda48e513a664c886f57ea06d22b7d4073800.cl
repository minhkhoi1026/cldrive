//{"activeRatio":4,"alpha":3,"biasesBack":0,"biasesFront":1,"hiddenStates":2}
...
kernel void cscLearnHiddenBiases(read_only image2d_t biasesBack, write_only image2d_t biasesFront, read_only image2d_t hiddenStates, float alpha, float activeRatio) {
