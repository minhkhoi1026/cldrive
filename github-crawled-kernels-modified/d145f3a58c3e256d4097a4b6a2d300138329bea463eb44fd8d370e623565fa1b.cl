...
kernel void GetSubMatrix(global float* Small_Matrix, global const float* Matrix, private int startRow, private int startColumn, private int smallNumberOfRows, private int smallNumberOfColumns, private int largeNumberOfRows, private int largeNumberOfColumns) {
