...
__attribute__((num_compute_units(4))) kernel void calc_histo(global float* histo, global const char* restrict img, const int widthStep, const int height, const int width) {
