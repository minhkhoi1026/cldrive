...
kernel void elemWisePow(const global float* gInput1, const global float* gInput2, global float* outputArr) {
  ...
  outputArr[hook(2, gid)] = pow(gInput1[hook(0, gid)], gInput2[hook(1, gid)]);
}