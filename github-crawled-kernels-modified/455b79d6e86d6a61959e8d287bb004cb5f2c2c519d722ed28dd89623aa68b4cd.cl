...
__attribute__((reqd_work_group_size(1, 1, 1))) kernel void desCipher(global uchar* restrict in, global unsigned int* restrict SK, global uchar* restrict out, unsigned int input_size) {
 private
  uchar state_in[8];
 private
  uchar state_out[8];
