...
__attribute__((num_simd_work_items(2))) __attribute__((reqd_work_group_size(16, 1, 1))) __attribute__((num_simd_work_items(2))) __attribute__((reqd_work_group_size(16, 1, 1))) kernel void nw_kernel2(global int* restrict reference_d, global int* restrict input_itemsets_d, int cols, int penalty, int blk, int block_width, int offset_r, int offset_c) {
