//{"brightness":4,"d_output":0,"density":3,"imageH":2,"imageW":1,"invViewMatrix":7,"transferOffset":5,"transferScale":6}
...
kernel void d_render(global unsigned int* d_output, unsigned int imageW, unsigned int imageH, float density, float brightness, float transferOffset, float transferScale, constant float* invViewMatrix
