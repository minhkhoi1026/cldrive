...
kernel void merge_vector_C4_D0(global uchar* mat_dst, int dst_step, int dst_offset, global uchar* mat_src0, int src0_step, int src0_offset, global uchar* mat_src1, int src1_step, int src1_offset, global uchar* mat_src2, int src2_step, int src2_offset, global uchar* mat_src3, int src3_step, int src3_offset, int rows, int cols, int dst_step1) {
  ...
  if ((x < cols) && (y < rows)) {
    ...
    *((global uchar4*)(mat_dst + dst_index + (x << 2))) = (uchar4)(src0, src1, src2, src3);
  }
}