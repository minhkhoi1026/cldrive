...
kernel void generate_mip_mips(unsigned int tex_id, unsigned int mip_level, unsigned int mipmap_start, global unsigned int* nums, global unsigned int* sizes, image_3d_write array, image_3d_read rarray) {
