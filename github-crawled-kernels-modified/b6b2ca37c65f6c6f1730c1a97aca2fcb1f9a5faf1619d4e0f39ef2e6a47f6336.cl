...
kernel void image_rotate_uint32(global unsigned int* src_data, global unsigned int* dst_data, int rotctr_x, int rotctr_y, int wd, int ht, int dst_wd, int dst_ht, int dst_dx, int dst_dy, double sin_theta, double cos_theta, unsigned int clip_val) {
