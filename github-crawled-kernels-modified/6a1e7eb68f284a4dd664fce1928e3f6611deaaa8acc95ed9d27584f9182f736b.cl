...
kernel void kmeans_kernel_c(global float* feature, global float* clusters, global int* membership, int npoints, int nclusters, int nfeatures, int offset, int size) {
