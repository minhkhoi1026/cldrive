...
kernel void Ssyr2_opt_async_lower(unsigned int n, float alpha, const constant float* x, int incx, const constant float* y, int incy, global float* A, unsigned int lda) {
