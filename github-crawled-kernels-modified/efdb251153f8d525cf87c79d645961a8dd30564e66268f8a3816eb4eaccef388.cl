...
void SHA256(uint4* restrict state0, uint4* restrict state1, const uint4 block0, const uint4 block1, const uint4 block2, const uint4 block3) {
  ...
  ;
  {
    ...
    tmp1 = (uint4)(W[hook(7, (0 + 0) % 4)].y, W[hook(7, (0 + 0) % 4)].z, W[hook(7, (0 + 0) % 4)].w, W[hook(7, (0 + 1) % 4)].x);
    tmp2 = (uint4)(W[hook(7, (0 + 2) % 4)].y, W[hook(7, (0 + 2) % 4)].z, W[hook(7, (0 + 2) % 4)].w, W[hook(7, (0 + 3) % 4)].x);
    tmp3 = (uint4)(W[hook(7, (0 + 3) % 4)].z, W[hook(7, (0 + 3) % 4)].w, 0, 0);
    W[hook(7, (0 + 0) % 4)] += tmp2 + (rotate(tmp1, 25U) ^ rotate(tmp1, 14U) ^ (tmp1 >> 3U)) + (rotate(tmp3, 15U) ^ rotate(tmp3, 13U) ^ (tmp3 >> 10U));
    tmp1 = (uint4)(0, 0, W[hook(7, (0 + 0) % 4)].x, W[hook(7, (0 + 0) % 4)].y);
    W[hook(7, (0 + 0) % 4)] += (rotate(tmp1, 15U) ^ rotate(tmp1, 13U) ^ (tmp1 >> 10U));
  };
  S1.w += (rotate(S1.x, 26U) ^ rotate(S1.x, 21U) ^ rotate(S1.x, 7U));
  S1.w += bitselect(S1.z, S1.y, S1.x);
  ...
  {
    uint4 tmp1, tmp2, tmp3;
    tmp1 = (uint4)(W[hook(7, (1 + 0) % 4)].y, W[hook(7, (1 + 0) % 4)].z, W[hook(7, (1 + 0) % 4)].w, W[hook(7, (1 + 1) % 4)].x);
    tmp2 = (uint4)(W[hook(7, (1 + 2) % 4)].y, W[hook(7, (1 + 2) % 4)].z, W[hook(7, (1 + 2) % 4)].w, W[hook(7, (1 + 3) % 4)].x);
    tmp3 = (uint4)(W[hook(7, (1 + 3) % 4)].z, W[hook(7, (1 + 3) % 4)].w, 0, 0);
    W[hook(7, (1 + 0) % 4)] += tmp2 + (rotate(tmp1, 25U) ^ rotate(tmp1, 14U) ^ (tmp1 >> 3U)) + (rotate(tmp3, 15U) ^ rotate(tmp3, 13U) ^ (tmp3 >> 10U));
    tmp1 = (uint4)(0, 0, W[hook(7, (1 + 0) % 4)].x, W[hook(7, (1 + 0) % 4)].y);
    W[hook(7, (1 + 0) % 4)] += (rotate(tmp1, 15U) ^ rotate(tmp1, 13U) ^ (tmp1 >> 10U));
  };
  S0.w += (rotate(S0.x, 26U) ^ rotate(S0.x, 21U) ^ rotate(S0.x, 7U));
  S0.w += bitselect(S0.z, S0.y, S0.x);
  ...
  {
    uint4 tmp1, tmp2, tmp3;
    tmp1 = (uint4)(W[hook(7, (2 + 0) % 4)].y, W[hook(7, (2 + 0) % 4)].z, W[hook(7, (2 + 0) % 4)].w, W[hook(7, (2 + 1) % 4)].x);
    tmp2 = (uint4)(W[hook(7, (2 + 2) % 4)].y, W[hook(7, (2 + 2) % 4)].z, W[hook(7, (2 + 2) % 4)].w, W[hook(7, (2 + 3) % 4)].x);
    tmp3 = (uint4)(W[hook(7, (2 + 3) % 4)].z, W[hook(7, (2 + 3) % 4)].w, 0, 0);
    W[hook(7, (2 + 0) % 4)] += tmp2 + (rotate(tmp1, 25U) ^ rotate(tmp1, 14U) ^ (tmp1 >> 3U)) + (rotate(tmp3, 15U) ^ rotate(tmp3, 13U) ^ (tmp3 >> 10U));
    tmp1 = (uint4)(0, 0, W[hook(7, (2 + 0) % 4)].x, W[hook(7, (2 + 0) % 4)].y);
    W[hook(7, (2 + 0) % 4)] += (rotate(tmp1, 15U) ^ rotate(tmp1, 13U) ^ (tmp1 >> 10U));
  };
  S1.w += (rotate(S1.x, 26U) ^ rotate(S1.x, 21U) ^ rotate(S1.x, 7U));
  S1.w += bitselect(S1.z, S1.y, S1.x);
  ...
  {
    uint4 tmp1, tmp2, tmp3;
    tmp1 = (uint4)(W[hook(7, (3 + 0) % 4)].y, W[hook(7, (3 + 0) % 4)].z, W[hook(7, (3 + 0) % 4)].w, W[hook(7, (3 + 1) % 4)].x);
    tmp2 = (uint4)(W[hook(7, (3 + 2) % 4)].y, W[hook(7, (3 + 2) % 4)].z, W[hook(7, (3 + 2) % 4)].w, W[hook(7, (3 + 3) % 4)].x);
    tmp3 = (uint4)(W[hook(7, (3 + 3) % 4)].z, W[hook(7, (3 + 3) % 4)].w, 0, 0);
    W[hook(7, (3 + 0) % 4)] += tmp2 + (rotate(tmp1, 25U) ^ rotate(tmp1, 14U) ^ (tmp1 >> 3U)) + (rotate(tmp3, 15U) ^ rotate(tmp3, 13U) ^ (tmp3 >> 10U));
    tmp1 = (uint4)(0, 0, W[hook(7, (3 + 0) % 4)].x, W[hook(7, (3 + 0) % 4)].y);
    W[hook(7, (3 + 0) % 4)] += (rotate(tmp1, 15U) ^ rotate(tmp1, 13U) ^ (tmp1 >> 10U));
  };
  S0.w += (rotate(S0.x, 26U) ^ rotate(S0.x, 21U) ^ rotate(S0.x, 7U));
  S0.w += bitselect(S0.z, S0.y, S0.x);
