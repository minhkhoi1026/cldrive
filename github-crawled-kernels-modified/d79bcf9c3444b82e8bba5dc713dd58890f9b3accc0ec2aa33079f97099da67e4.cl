...
kernel void entry(global ulong* result, global int* sequence_input) {
  ...
  transparent_crc_no_string(&crc64_context, p_3->g_2.x);
  transparent_crc_no_string(&crc64_context, p_3->g_2.y);
