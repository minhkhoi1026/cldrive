...
kernel void extract_slice_nearest(read_only image3d_t volume, global float* image, const float4 volSize_imgWidth, const unsigned int stride, const float4 origin, const float4 xAxis, const float4 yAxis, const float4 areaRect) {
