...
__attribute__((reqd_work_group_size(8, 8, 1))) kernel void lkSparse(image2d_t I, image2d_t J, global const float2* prevPts, global float2* nextPts, global uchar* status, global float* err, const int level, const int rows, const int cols, int PATCH_X, int PATCH_Y, int c_winSize_x, int c_winSize_y, int c_iters, char calcErr) {
...

  {
    ...
    SetPatch(IPatchLocal, 0, 1, &I_patch[hook(23, 0)][hook(22, 1)], &dIdx_patch[hook(25, 0)][hook(24, 1)], &dIdy_patch[hook(27, 0)][hook(26, 1)], &A11, &A12, &A22, wx0);

    SetPatch(IPatchLocal, 0, 2, &I_patch[hook(23, 0)][hook(22, 2)], &dIdx_patch[hook(25, 0)][hook(24, 2)], &dIdy_patch[hook(27, 0)][hook(26, 2)], &A11, &A12, &A22, wx1);
  }
  {
    SetPatch(IPatchLocal, 1, 0, &I_patch[hook(23, 1)][hook(28, 0)], &dIdx_patch[hook(25, 1)][hook(29, 0)], &dIdy_patch[hook(27, 1)][hook(30, 0)], &A11, &A12, &A22, wy0);

    SetPatch(IPatchLocal, 1, 1, &I_patch[hook(23, 1)][hook(28, 1)], &dIdx_patch[hook(25, 1)][hook(29, 1)], &dIdy_patch[hook(27, 1)][hook(30, 1)], &A11, &A12, &A22, wx0 * wy0);

    SetPatch(IPatchLocal, 1, 2, &I_patch[hook(23, 1)][hook(28, 2)], &dIdx_patch[hook(25, 1)][hook(29, 2)], &dIdy_patch[hook(27, 1)][hook(30, 2)], &A11, &A12, &A22, wx1 * wy0);
  }
  {
    SetPatch(IPatchLocal, 2, 0, &I_patch[hook(23, 2)][hook(31, 0)], &dIdx_patch[hook(25, 2)][hook(32, 0)], &dIdy_patch[hook(27, 2)][hook(33, 0)], &A11, &A12, &A22, wy1);

    SetPatch(IPatchLocal, 2, 1, &I_patch[hook(23, 2)][hook(31, 1)], &dIdx_patch[hook(25, 2)][hook(32, 1)], &dIdy_patch[hook(27, 2)][hook(33, 1)], &A11, &A12, &A22, wx0 * wy1);

    SetPatch(IPatchLocal, 2, 2, &I_patch[hook(23, 2)][hook(31, 2)], &dIdx_patch[hook(25, 2)][hook(32, 2)], &dIdy_patch[hook(27, 2)][hook(33, 2)], &A11, &A12, &A22, wx1 * wy1);
  }
  ...
  if (calcErr) {
    {
      GetError(J, loc0.x, loc0.y, &I_patch[hook(23, 0)][hook(22, 0)], &D, 1);
      GetError(J, loc1.x, loc0.y, &I_patch[hook(23, 0)][hook(22, 1)], &D, wx0);
    }
    {
      GetError(J, loc0.x, loc1.y, &I_patch[hook(23, 1)][hook(28, 0)], &D, wy0);
      GetError(J, loc1.x, loc1.y, &I_patch[hook(23, 1)][hook(28, 1)], &D, wx0 * wy0);
    }
    if (xBase < c_winSize_x) {
      GetError(J, loc2.x, loc0.y, &I_patch[hook(23, 0)][hook(22, 2)], &D, wx1);
      GetError(J, loc2.x, loc1.y, &I_patch[hook(23, 1)][hook(28, 2)], &D, wx1 * wy0);
    }
    if (yBase < c_winSize_y) {
      GetError(J, loc0.x, loc2.y, &I_patch[hook(23, 2)][hook(31, 0)], &D, wy1);
      GetError(J, loc1.x, loc2.y, &I_patch[hook(23, 2)][hook(31, 1)], &D, wx0 * wy1);
      if (xBase < c_winSize_x)
        GetError(J, loc2.x, loc2.y, &I_patch[hook(23, 2)][hook(31, 2)], &D, wx1 * wy1);
    }
