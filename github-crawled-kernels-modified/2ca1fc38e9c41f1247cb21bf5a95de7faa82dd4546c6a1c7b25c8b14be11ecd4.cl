...
kernel void computePlus(read_only image2d_t input, read_only image2d_t distImg, global float* accBuf, global float* weightBuf, const int Nx, const int Ny, const int dx, const int dy, const float sigma) {
