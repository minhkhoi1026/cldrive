...
__attribute__((num_simd_work_items(2))) __attribute__((num_compute_units(2))) __attribute__((reqd_work_group_size(16, 1, 1))) __attribute__((num_simd_work_items(2))) __attribute__((num_compute_units(2))) __attribute__((reqd_work_group_size(16, 1, 1))) kernel void needle_opencl_shared_2(global int* restrict referrence, global int* restrict matrix_opencl, int cols, int penalty, int i, int block_width) {
