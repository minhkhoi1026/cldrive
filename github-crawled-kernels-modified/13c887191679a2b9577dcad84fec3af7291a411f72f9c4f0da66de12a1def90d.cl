...
kernel void force_spike2(global float* pot, global float* rec, global float* spkd, global uchar* hasSpkd, global int* offsets, global float* ctime) {
