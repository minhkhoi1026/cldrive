//{"hiddenSize":5,"hiddenStates":0,"hiddenToVisible":7,"radius":8,"reconstructionError":2,"reverseRadii":9,"visibleSize":4,"visibleStatesPrev":1,"visibleToHidden":6,"weights":3}
...
kernel void predReconstructionErrorSwarm(read_only image2d_t hiddenStates, read_only image2d_t visibleStatesPrev, write_only image2d_t reconstructionError, read_only image3d_t weights, int2 visibleSize, int2 hiddenSize, float2 visibleToHidden, float2 hiddenToVisible, int radius, int2 reverseRadii) {
