//{"C":3,"F0_OUT":4,"F1_OUT":6,"P":0,"SK":2,"WK":1,"X0":7,"X1":11,"X2":8,"X3":12,"X4":9,"X5":13,"X6":10,"X7":14,"_P":16,"out":15,"outCipher":17,"x":5}
...
kernel void hightCipher(global ulong* P, global uchar* WK, global uchar* SK, global ulong* C) {
 private
  int gid;
  gid = get_global_id(0);
 private
  ulong _P[1];
  _P[hook(16, 0)] = P[hook(0, gid)];
 ...
 private
  ...
  C[hook(3, gid)] = outCipher[hook(17, 0)];
}