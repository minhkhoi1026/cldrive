...
kernel void CalculateStatisticalMapSearchlight_19(global float* Classifier_Performance, global const float* Volumes, global const float* Mask, constant float* c_d, constant float* c_Correct_Classes, private int DATA_W, private int DATA_H, private int DATA_D, private int NUMBER_OF_VOLUMES, private float n, private int EPOCS) {
  ...
  for (int validation = 0; validation < NUMBER_OF_VOLUMES; validation++) {
    ...
    x1 = Volumes[hook(1, Calculate4DIndex(x - 1, y, z - 1, validation, DATA_W, DATA_H, DATA_D))];
    x2 = Volumes[hook(1, Calculate4DIndex(x, y - 1, z - 1, validation, DATA_W, DATA_H, DATA_D))];
    x3 = Volumes[hook(1, Calculate4DIndex(x, y, z - 1, validation, DATA_W, DATA_H, DATA_D))];
    x4 = Volumes[hook(1, Calculate4DIndex(x, y + 1, z - 1, validation, DATA_W, DATA_H, DATA_D))];
    x5 = Volumes[hook(1, Calculate4DIndex(x + 1, y, z - 1, validation, DATA_W, DATA_H, DATA_D))];

    x6 = Volumes[hook(1, Calculate4DIndex(x - 1, y - 1, z, validation, DATA_W, DATA_H, DATA_D))];
    x7 = Volumes[hook(1, Calculate4DIndex(x - 1, y, z, validation, DATA_W, DATA_H, DATA_D))];
    x8 = Volumes[hook(1, Calculate4DIndex(x - 1, y + 1, z, validation, DATA_W, DATA_H, DATA_D))];
    x9 = Volumes[hook(1, Calculate4DIndex(x, y - 1, z, validation, DATA_W, DATA_H, DATA_D))];
    x10 = Volumes[hook(1, Calculate4DIndex(x, y, z, validation, DATA_W, DATA_H, DATA_D))];
    x11 = Volumes[hook(1, Calculate4DIndex(x, y + 1, z, validation, DATA_W, DATA_H, DATA_D))];
    x12 = Volumes[hook(1, Calculate4DIndex(x + 1, y - 1, z, validation, DATA_W, DATA_H, DATA_D))];
    x13 = Volumes[hook(1, Calculate4DIndex(x + 1, y, z, validation, DATA_W, DATA_H, DATA_D))];
    x14 = Volumes[hook(1, Calculate4DIndex(x + 1, y + 1, z, validation, DATA_W, DATA_H, DATA_D))];

    x15 = Volumes[hook(1, Calculate4DIndex(x - 1, y, z + 1, validation, DATA_W, DATA_H, DATA_D))];
    x16 = Volumes[hook(1, Calculate4DIndex(x, y - 1, z + 1, validation, DATA_W, DATA_H, DATA_D))];
    x17 = Volumes[hook(1, Calculate4DIndex(x, y, z + 1, validation, DATA_W, DATA_H, DATA_D))];
    x18 = Volumes[hook(1, Calculate4DIndex(x, y + 1, z + 1, validation, DATA_W, DATA_H, DATA_D))];
    x19 = Volumes[hook(1, Calculate4DIndex(x + 1, y, z + 1, validation, DATA_W, DATA_H, DATA_D))];
