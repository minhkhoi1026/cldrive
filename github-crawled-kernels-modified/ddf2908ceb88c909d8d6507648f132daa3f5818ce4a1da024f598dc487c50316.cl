...
kernel void Reduce2_MIN_ADD(global float* buffer1, global float* buffer2, local float* scratch, const int length, global float* result, const int offset1, const int step1, const int offset2, const int step2) {
