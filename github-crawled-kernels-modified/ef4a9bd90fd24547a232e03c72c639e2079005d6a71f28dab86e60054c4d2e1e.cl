//{"convolution_real":0,"nX":2,"nY":3,"nZ":4,"sumFootprintNMDA":1}
...
kernel void postConvolution_NMDA(global const float* convolution_real, global float* sumFootprintNMDA, const unsigned int nX, const unsigned int nY, const unsigned int nZ) {
  ...
  sumFootprintNMDA[hook(1, index_fp)] = convolution_real[hook(0, index_conv)];
}