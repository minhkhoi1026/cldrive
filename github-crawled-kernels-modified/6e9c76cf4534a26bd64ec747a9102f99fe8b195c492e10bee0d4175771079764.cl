...
kernel void ztranspose2_32(global magmaDoubleComplex* B, int offsetB, int ldb, global magmaDoubleComplex* A, int offsetA, int lda, int m, int m32, int n, int n32) {
