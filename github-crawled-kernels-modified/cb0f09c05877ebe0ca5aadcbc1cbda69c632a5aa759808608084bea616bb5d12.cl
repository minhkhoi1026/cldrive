//{"hiddenToVisible":5,"qBiases":1,"qStatesFront":3,"qStatesPrev":2,"qWeights":0,"radius":6,"visibleSize":4}
...
kernel void qLastForward(read_only image3d_t qWeights, read_only image2d_t qBiases, read_only image2d_t qStatesPrev, write_only image2d_t qStatesFront, int2 visibleSize, float2 hiddenToVisible, int radius) {
