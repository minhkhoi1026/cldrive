...
unsigned int func_1(struct S0* p_4);
unsigned int func_1(struct S0* p_4) {
  short l_2[8] = {0x7CB5L, 0x7CB5L, 0x7CB5L, 0x7CB5L, 0x7CB5L, 0x7CB5L, 0x7CB5L, 0x7CB5L};
  int i;
  for (p_4->g_3 = 0; p_4->g_3 < 8; p_4->g_3 += 1) {
    l_2[hook(3, p_4->g_3)] = 0x5688L;
  }
  return p_4->g_3;
}
