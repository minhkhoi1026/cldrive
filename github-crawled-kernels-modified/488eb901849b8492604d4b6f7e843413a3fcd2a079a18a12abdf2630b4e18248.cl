//{"l_2":4,"l_2[0]":3,"l_2[0][3]":2,"result":0,"sequence_input":1}
...
unsigned int func_1(struct S1* p_3) {
  ushort l_2[8][9][1] = {{{0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}}, {{0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}}, {{0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}}, {{0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}}, {{0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}}, {{0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}}, {{0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}}, {{0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}, {0x249AL}}};
  int i, j, k;
  return l_2[hook(4, 0)][hook(3, 3)][hook(2, 0)];
}
