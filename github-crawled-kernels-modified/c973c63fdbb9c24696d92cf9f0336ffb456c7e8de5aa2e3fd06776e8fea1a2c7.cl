...
kernel void InterpolateVolumeLinearLinear(global float* Volume, read_only image3d_t Original_Volume, constant float* c_Parameter_Vector, private int DATA_W, private int DATA_H, private int DATA_D, private int VOLUME) {
