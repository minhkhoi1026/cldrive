...
kernel void cscForward(read_only image2d_t hiddenStates, write_only image2d_t reconstruction, read_only image3d_t weights, int2 visibleSize, int2 hiddenSize, float2 visibleToHidden, float2 hiddenToVisible, int radius, int2 reverseRadii) {
