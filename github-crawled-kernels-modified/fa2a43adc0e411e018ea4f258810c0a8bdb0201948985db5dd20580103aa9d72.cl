...
kernel void compute_stereo_oblique_dir_kernel_3(global const uchar4* d_matching_cost, global ushort* d_scost, int width, int height) {
  ...
  int pathIdx = get_group_id(0) * 8 + get_local_id(1);
