...
kernel void CalculateStatisticalMapsGLMBayesian(global float* Statistical_Maps, global float* Beta_Volumes, global float* AR_Estimates, global const float* Volumes, global const float* Mask, global const int* Seeds, constant float* c_X_GLM, constant float* c_InvOmega0, constant float* c_S00, constant float* c_S01, constant float* c_S11, private int DATA_W, private int DATA_H, private int DATA_D, private int NUMBER_OF_VOLUMES, private int NUMBER_OF_REGRESSORS, private int NUMBER_OF_ITERATIONS, private int slice) {
