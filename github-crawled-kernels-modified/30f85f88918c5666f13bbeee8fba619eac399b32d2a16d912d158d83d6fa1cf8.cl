...
kernel void NCHWBufferToImage(private const int global_size_dim0, private const int global_size_dim1, global const float* input_ptr, private const int height, private const int width, private const int channels, write_only image2d_t output) {
