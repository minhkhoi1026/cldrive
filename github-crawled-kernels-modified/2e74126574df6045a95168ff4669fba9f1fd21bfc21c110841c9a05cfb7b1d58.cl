...
__attribute__((reqd_work_group_size(64, 1, 1))) __attribute__((reqd_work_group_size(64, 1, 1))) kernel void scan_exclusive_float4(global float4 const* in_array, global float4* out_array, unsigned int numElems, local float* shmem) {
