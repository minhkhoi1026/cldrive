...
kernel void x_solve1(global double* g_qs, global double* g_rho_i, global double* g_square, global double* g_u, global double* g_fjac, global double* g_njac, int gp0, int gp1, int gp2) {
  ...
  fjac[hook(72, i)][hook(71, 0)][hook(70, 0)] = 0.0;
  fjac[hook(72, i)][hook(71, 1)][hook(73, 0)] = 1.0;
  fjac[hook(72, i)][hook(71, 2)][hook(74, 0)] = 0.0;
  fjac[hook(72, i)][hook(71, 3)][hook(75, 0)] = 0.0;
  fjac[hook(72, i)][hook(71, 4)][hook(76, 0)] = 0.0;

  fjac[hook(72, i)][hook(71, 0)][hook(70, 1)] = -(p_u[hook(65, 1)] * tmp2 * p_u[hook(65, 1)]) + 0.4 * qs[hook(79, k)][hook(78, j)][hook(77, i)];
  fjac[hook(72, i)][hook(71, 1)][hook(73, 1)] = (2.0 - 0.4) * (p_u[hook(65, 1)] / p_u[hook(65, 0)]);
  fjac[hook(72, i)][hook(71, 2)][hook(74, 1)] = -0.4 * (p_u[hook(65, 2)] * tmp1);
  fjac[hook(72, i)][hook(71, 3)][hook(75, 1)] = -0.4 * (p_u[hook(65, 3)] * tmp1);
  fjac[hook(72, i)][hook(71, 4)][hook(76, 1)] = 0.4;

  fjac[hook(72, i)][hook(71, 0)][hook(70, 2)] = -(p_u[hook(65, 1)] * p_u[hook(65, 2)]) * tmp2;
  fjac[hook(72, i)][hook(71, 1)][hook(73, 2)] = p_u[hook(65, 2)] * tmp1;
  fjac[hook(72, i)][hook(71, 2)][hook(74, 2)] = p_u[hook(65, 1)] * tmp1;
  fjac[hook(72, i)][hook(71, 3)][hook(75, 2)] = 0.0;
  fjac[hook(72, i)][hook(71, 4)][hook(76, 2)] = 0.0;

  fjac[hook(72, i)][hook(71, 0)][hook(70, 3)] = -(p_u[hook(65, 1)] * p_u[hook(65, 3)]) * tmp2;
  fjac[hook(72, i)][hook(71, 1)][hook(73, 3)] = p_u[hook(65, 3)] * tmp1;
  fjac[hook(72, i)][hook(71, 2)][hook(74, 3)] = 0.0;
  fjac[hook(72, i)][hook(71, 3)][hook(75, 3)] = p_u[hook(65, 1)] * tmp1;
  fjac[hook(72, i)][hook(71, 4)][hook(76, 3)] = 0.0;

  fjac[hook(72, i)][hook(71, 0)][hook(70, 4)] = (0.4 * 2.0 * square[hook(82, k)][hook(81, j)][hook(80, i)] - 1.4 * p_u[hook(65, 4)]) * (p_u[hook(65, 1)] * tmp2);
  fjac[hook(72, i)][hook(71, 1)][hook(73, 4)] = 1.4 * p_u[hook(65, 4)] * tmp1 - 0.4 * (p_u[hook(65, 1)] * p_u[hook(65, 1)] * tmp2 + qs[hook(79, k)][hook(78, j)][hook(77, i)]);
  fjac[hook(72, i)][hook(71, 2)][hook(74, 4)] = -0.4 * (p_u[hook(65, 2)] * p_u[hook(65, 1)]) * tmp2;
  fjac[hook(72, i)][hook(71, 3)][hook(75, 4)] = -0.4 * (p_u[hook(65, 3)] * p_u[hook(65, 1)]) * tmp2;
  fjac[hook(72, i)][hook(71, 4)][hook(76, 4)] = 1.4 * (p_u[hook(65, 1)] * tmp1);

  njac[hook(85, i)][hook(84, 0)][hook(83, 0)] = 0.0;
  njac[hook(85, i)][hook(84, 1)][hook(86, 0)] = 0.0;
  njac[hook(85, i)][hook(84, 2)][hook(87, 0)] = 0.0;
  njac[hook(85, i)][hook(84, 3)][hook(88, 0)] = 0.0;
  njac[hook(85, i)][hook(84, 4)][hook(89, 0)] = 0.0;

  njac[hook(85, i)][hook(84, 0)][hook(83, 1)] = -(4.0 / 3.0) * (0.1 * 1.0) * tmp2 * p_u[hook(65, 1)];
  njac[hook(85, i)][hook(84, 1)][hook(86, 1)] = (4.0 / 3.0) * (0.1 * 1.0) * tmp1;
  njac[hook(85, i)][hook(84, 2)][hook(87, 1)] = 0.0;
  njac[hook(85, i)][hook(84, 3)][hook(88, 1)] = 0.0;
  njac[hook(85, i)][hook(84, 4)][hook(89, 1)] = 0.0;

  njac[hook(85, i)][hook(84, 0)][hook(83, 2)] = -(0.1 * 1.0) * tmp2 * p_u[hook(65, 2)];
  njac[hook(85, i)][hook(84, 1)][hook(86, 2)] = 0.0;
  njac[hook(85, i)][hook(84, 2)][hook(87, 2)] = (0.1 * 1.0) * tmp1;
  njac[hook(85, i)][hook(84, 3)][hook(88, 2)] = 0.0;
  njac[hook(85, i)][hook(84, 4)][hook(89, 2)] = 0.0;

  njac[hook(85, i)][hook(84, 0)][hook(83, 3)] = -(0.1 * 1.0) * tmp2 * p_u[hook(65, 3)];
  njac[hook(85, i)][hook(84, 1)][hook(86, 3)] = 0.0;
  njac[hook(85, i)][hook(84, 2)][hook(87, 3)] = 0.0;
  njac[hook(85, i)][hook(84, 3)][hook(88, 3)] = (0.1 * 1.0) * tmp1;
  njac[hook(85, i)][hook(84, 4)][hook(89, 3)] = 0.0;

  njac[hook(85, i)][hook(84, 0)][hook(83, 4)] = -((4.0 / 3.0) * (0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp3 * (p_u[hook(65, 1)] * p_u[hook(65, 1)]) - ((0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp3 * (p_u[hook(65, 2)] * p_u[hook(65, 2)]) - ((0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp3 * (p_u[hook(65, 3)] * p_u[hook(65, 3)]) - ((1.4 * 1.4) * (0.1 * 1.0)) * tmp2 * p_u[hook(65, 4)];

  njac[hook(85, i)][hook(84, 1)][hook(86, 4)] = ((4.0 / 3.0) * (0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp2 * p_u[hook(65, 1)];
  njac[hook(85, i)][hook(84, 2)][hook(87, 4)] = ((0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp2 * p_u[hook(65, 2)];
  njac[hook(85, i)][hook(84, 3)][hook(88, 4)] = ((0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp2 * p_u[hook(65, 3)];
  njac[hook(85, i)][hook(84, 4)][hook(89, 4)] = (((1.4 * 1.4) * (0.1 * 1.0))) * tmp1;
}