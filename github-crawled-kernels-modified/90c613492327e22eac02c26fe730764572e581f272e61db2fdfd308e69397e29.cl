//{"d_I":12,"d_Nc":1,"d_Nr":0,"d_c":11,"d_dE":8,"d_dN":6,"d_dS":7,"d_dW":9,"d_iN":2,"d_iS":3,"d_jE":4,"d_jW":5,"d_q0sqr":10}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
__attribute__((max_global_work_dim(0))) __attribute__((max_global_work_dim(0))) __attribute__((max_global_work_dim(0))) kernel void srad_kernel(int d_Nr, int d_Nc, global int* restrict d_iN, global int* restrict d_iS, global int* restrict d_jE, global int* restrict d_jW, global float* restrict d_dN, global float* restrict d_dS, global float* restrict d_dE, global float* restrict d_dW, float d_q0sqr, global float* restrict d_c, global float* restrict d_I) {
