...
kernel void lumaDownsample(read_only image2d_t src, write_only image2d_t dst) {
  ...
  const float3 srcColor = read_imagef((src), (sampler), (normalizePos(dstPos, dstSize))).xyz;
