//{"bitmap":6,"colid":1,"data":2,"midrow":7,"result":4,"row_num":5,"rowinfo":8,"rowptr":0,"start":9,"vec":3}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void gpu_csr_ve_slm_pm_fs(global int* rowptr, global int* colid, global float* data, global float* vec, global float* result, int row_num, global unsigned long* bitmap, int midrow, global int* rowinfo, int start) {
