...
kernel void __cl_copy_image_1d_array_to_1d_array(read_only image1d_array_t src_image, write_only image1d_array_t dst_image, unsigned int region0, unsigned int region1, unsigned int region2, unsigned int src_origin0, unsigned int src_origin1, unsigned int src_origin2, unsigned int dst_origin0, unsigned int dst_origin1, unsigned int dst_origin2) {
