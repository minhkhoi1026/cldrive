...
kernel void matchTemplate_Naive_SQDIFF_C1_D0(global const uchar* img, global const uchar* tpl, global float* res, int img_rows, int img_cols, int tpl_rows, int tpl_cols, int res_rows, int res_cols, int img_offset, int tpl_offset, int res_offset, int img_step, int tpl_step, int res_step) {
