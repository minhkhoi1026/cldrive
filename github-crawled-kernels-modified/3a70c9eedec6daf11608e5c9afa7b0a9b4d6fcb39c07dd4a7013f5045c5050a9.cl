//{"C":18,"D1":15,"D2":17,"FLINV_IN":13,"FLINV_OUT":14,"FL_IN":11,"FL_OUT":12,"F_IN":5,"F_OUT":10,"M":16,"in":0,"k":2,"ke":3,"kw":1,"out":4,"outCipher":19,"sbox1":6,"sbox2":7,"sbox3":8,"sbox4":9}
...
kernel void camellia192256Cipher(global ulong* in, global ulong* kw, global ulong* k, global ulong* ke, global ulong* out) {
 private
  int gid;
  gid = get_global_id(0);
 ...
 private
  ulong M[2];
  M[hook(16, 0)] = in[hook(0, 2 * gid)];
  M[hook(16, 1)] = in[hook(0, 2 * gid + 1)];
 ...
 private
  ...
  out[hook(4, 2 * gid)] = outCipher[hook(19, 0)];
  out[hook(4, 2 * gid + 1)] = outCipher[hook(19, 1)];
}