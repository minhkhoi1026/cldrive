...
kernel void image2columarray1x1(int n, global float* data_im, int height, int width, int ksize, const int pad, int stride, int height_col, int width_col, global float* data_col, global float* reset_arr, int workgroup_size) {
