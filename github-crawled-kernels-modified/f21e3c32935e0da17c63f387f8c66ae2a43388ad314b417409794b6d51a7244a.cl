//{"dst":0,"members":1,"members[id % 3].name":2}
...
kernel void compiler_global_constant3(global int* dst) {
  int id = (int)get_global_id(0);

  dst[hook(0, id)] = members[hook(1, id % 3)].idNumber.z + members[hook(1, id % 3)].name[hook(2, 2)];
}