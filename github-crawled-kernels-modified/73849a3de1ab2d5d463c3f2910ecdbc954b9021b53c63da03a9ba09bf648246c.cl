...
kernel void image_resize_float64(global const double* src_data, global double* dst_data, const int old_wd, const int new_wd, const double scale_x, const double scale_y) {
