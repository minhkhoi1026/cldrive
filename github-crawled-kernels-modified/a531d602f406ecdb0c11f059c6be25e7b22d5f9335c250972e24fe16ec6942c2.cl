...
kernel void arithm_bitwise_not_D2(global ushort* src1, int src1_step, int src1_offset, global ushort* dst, int dst_step, int dst_offset, int rows, int cols, int dst_step1) {
  ...
  if (x < cols && y < rows) {
    ...
    ushort4 src1_data = vload4(0, (global ushort*)((global char*)src1 + src1_index));

    ushort4 dst_data = *((global ushort4*)((global char*)dst + dst_index));
    ...
    *((global ushort4*)((global char*)dst + dst_index)) = dst_data;
  }
}