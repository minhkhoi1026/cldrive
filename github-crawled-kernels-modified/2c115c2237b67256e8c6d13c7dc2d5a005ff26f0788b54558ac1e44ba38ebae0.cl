...
kernel void MatrixMultiplication_float(global float* matrixA, global float* matrixB, global float* output, int matrixSize, int matrixWidth, local int* localB, int localSize) {
  float sum;
