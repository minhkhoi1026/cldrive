...
ushort func_1(struct S1* p_7);
ushort func_1(struct S1* p_7) {
  int* l_2[3][2][4] = {{{&p_7->g_3, &p_7->g_3, &p_7->g_3, &p_7->g_3}, {&p_7->g_3, &p_7->g_3, &p_7->g_3, &p_7->g_3}}, {{&p_7->g_3, &p_7->g_3, &p_7->g_3, &p_7->g_3}, {&p_7->g_3, &p_7->g_3, &p_7->g_3, &p_7->g_3}}, {{&p_7->g_3, &p_7->g_3, &p_7->g_3, &p_7->g_3}, {&p_7->g_3, &p_7->g_3, &p_7->g_3, &p_7->g_3}}};
  int i, j, k;
  --p_7->g_4;
  return p_7->g_3;
}
