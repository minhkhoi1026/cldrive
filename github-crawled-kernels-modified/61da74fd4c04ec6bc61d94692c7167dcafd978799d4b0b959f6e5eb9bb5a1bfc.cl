...
kernel void reduce_xt_vec_chunks(const int observations, const int subject_chunks, const int chunk_clusters, const int max_work_group_size, global double* Xt_vec_chunks, global double* Xt_vec, local double* local_xt) {
