//{"((__global unsigned int *)Camellia_global_SBOX)":5,"((__local unsigned int *)Camellia_SBOX[0])":3,"((__local unsigned int *)Camellia_SBOX[1])":6,"((__local unsigned int *)Camellia_SBOX[2])":7,"((__local unsigned int *)Camellia_SBOX[3])":8,"(k + 0)":9,"(k + 10)":18,"(k + 2)":14,"(k + 4)":15,"(k + 6)":16,"(k + 8)":17,"Camellia_SBOX":4,"Camellia_SBOX[0]":12,"Camellia_SBOX[1]":10,"Camellia_SBOX[2]":13,"Camellia_SBOX[3]":11,"Camellia_global_SBOX":2,"data":0,"k":1}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void CMLLencKernel(global unsigned long* data, constant unsigned int* k, global unsigned int* Camellia_global_SBOX) {
 ...
 private
  ...
  do {
    unsigned int _t0, _t1, _t2, _t3;
    _t0 = s2 ^ (k + 2)[hook(14, 1)];
    _t3 = Camellia_SBOX[hook(4, 1)][hook(10, _t0 & 255)];
    _t1 = s3 ^ (k + 2)[hook(14, 0)];
    _t3 ^= Camellia_SBOX[hook(4, 3)][hook(11, (_t0 >> 8) & 255)];
    _t2 = Camellia_SBOX[hook(4, 0)][hook(12, _t1 & 255)];
    _t3 ^= Camellia_SBOX[hook(4, 2)][hook(13, (_t0 >> 16) & 255)];
    _t2 ^= Camellia_SBOX[hook(4, 1)][hook(10, (_t1 >> 8) & 255)];
  ...
  do {
    unsigned int _t0, _t1, _t2, _t3;
    _t0 = s0 ^ (k + 4)[hook(15, 1)];
    _t3 = Camellia_SBOX[hook(4, 1)][hook(10, _t0 & 255)];
    _t1 = s1 ^ (k + 4)[hook(15, 0)];
    _t3 ^= Camellia_SBOX[hook(4, 3)][hook(11, (_t0 >> 8) & 255)];
    _t2 = Camellia_SBOX[hook(4, 0)][hook(12, _t1 & 255)];
    _t3 ^= Camellia_SBOX[hook(4, 2)][hook(13, (_t0 >> 16) & 255)];
    _t2 ^= Camellia_SBOX[hook(4, 1)][hook(10, (_t1 >> 8) & 255)];
  ...
  do {
    unsigned int _t0, _t1, _t2, _t3;
    _t0 = s2 ^ (k + 6)[hook(16, 1)];
    _t3 = Camellia_SBOX[hook(4, 1)][hook(10, _t0 & 255)];
    _t1 = s3 ^ (k + 6)[hook(16, 0)];
    _t3 ^= Camellia_SBOX[hook(4, 3)][hook(11, (_t0 >> 8) & 255)];
    _t2 = Camellia_SBOX[hook(4, 0)][hook(12, _t1 & 255)];
    _t3 ^= Camellia_SBOX[hook(4, 2)][hook(13, (_t0 >> 16) & 255)];
    _t2 ^= Camellia_SBOX[hook(4, 1)][hook(10, (_t1 >> 8) & 255)];
  ...
  do {
    unsigned int _t0, _t1, _t2, _t3;
    _t0 = s0 ^ (k + 8)[hook(17, 1)];
    _t3 = Camellia_SBOX[hook(4, 1)][hook(10, _t0 & 255)];
    _t1 = s1 ^ (k + 8)[hook(17, 0)];
    _t3 ^= Camellia_SBOX[hook(4, 3)][hook(11, (_t0 >> 8) & 255)];
    _t2 = Camellia_SBOX[hook(4, 0)][hook(12, _t1 & 255)];
    _t3 ^= Camellia_SBOX[hook(4, 2)][hook(13, (_t0 >> 16) & 255)];
    _t2 ^= Camellia_SBOX[hook(4, 1)][hook(10, (_t1 >> 8) & 255)];
  ...
  do {
    unsigned int _t0, _t1, _t2, _t3;
    _t0 = s2 ^ (k + 10)[hook(18, 1)];
    _t3 = Camellia_SBOX[hook(4, 1)][hook(10, _t0 & 255)];
    _t1 = s3 ^ (k + 10)[hook(18, 0)];
    _t3 ^= Camellia_SBOX[hook(4, 3)][hook(11, (_t0 >> 8) & 255)];
    _t2 = Camellia_SBOX[hook(4, 0)][hook(12, _t1 & 255)];
    _t3 ^= Camellia_SBOX[hook(4, 2)][hook(13, (_t0 >> 16) & 255)];
    _t2 ^= Camellia_SBOX[hook(4, 1)][hook(10, (_t1 >> 8) & 255)];
  ...
  s1 ^= (((s0 & k[hook(1, 1)]) << (1)) + ((s0 & k[hook(1, 1)]) >> (32 - 1)));
  s2 ^= s3 | k[hook(1, 2)];
  s0 ^= s1 | k[hook(1, 0)];
  s3 ^= (((s2 & k[hook(1, 3)]) << (1)) + ((s2 & k[hook(1, 3)]) >> (32 - 1)));
  k += 4;
