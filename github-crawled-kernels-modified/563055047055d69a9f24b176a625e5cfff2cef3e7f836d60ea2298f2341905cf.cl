...
kernel void sharpen_filter(read_only image2d_t srcImg, write_only image2d_t dstImg, sampler_t sampler, int width, int height) {
  int4 kernelWeights[9] = {-2, -2, -2, -2, 32, -2, -2, -2, -2};
  int scale = 16;
  int offset = 0;
