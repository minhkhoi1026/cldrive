...
kernel void min_constant(global const uchar* source, global uchar* dest, int src_step, int dst_step, int width, float value_arg) {
  ...
  *(global uchar8*)(dest + gx * 8) = convert_uchar8_sat(((min(src, value))));
}