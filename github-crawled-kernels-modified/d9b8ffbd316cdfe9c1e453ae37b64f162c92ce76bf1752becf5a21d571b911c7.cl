...
kernel void AES192decKernel_cbc(global unsigned int* data, global unsigned int* Tdg, constant unsigned int* aes_key, global unsigned long* d_iv, global unsigned int* out) {
