...
kernel void MatrixMultiplication_double(global double* matrixA, global double* matrixB, global double* output, int matrixSize, int matrixWidth, local int* localB, int localSize) {
  double sum;
