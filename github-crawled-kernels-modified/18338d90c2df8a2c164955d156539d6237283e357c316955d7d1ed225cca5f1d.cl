...
kernel void MatrixMultiplication_2(global int* matrixA, global int* matrixB, global int* output, int matrixSize, int matrixWidth, local int* localA, local int* localB, int localSize) {
  int sum, tmpA, tmpB;
