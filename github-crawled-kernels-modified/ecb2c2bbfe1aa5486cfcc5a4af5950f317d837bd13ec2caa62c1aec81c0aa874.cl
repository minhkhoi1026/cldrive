//{"dst_img":1,"height":3,"previewBuffer":4,"src_img":0,"width":2}
...
kernel void image_conversion(global uchar* src_img, global uchar* dst_img, unsigned int width, unsigned int height, global struct PreviewObject* previewBuffer) {
