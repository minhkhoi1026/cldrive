...
kernel void bilat2_short(read_only image2d_t input, global short* output, const int Nx, const int Ny, const int fSize, const float sigmaX, const float sigmaP) {
