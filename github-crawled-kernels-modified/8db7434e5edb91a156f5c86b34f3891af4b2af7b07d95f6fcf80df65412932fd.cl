...
kernel void smooth_filter(read_only image2d_t srcImg, write_only image2d_t dstImg, sampler_t sampler, int width, int height) {
  int4 kernelWeights[9] = {1, 1, 1, 1, 5, 1, 1, 1, 1};
  int scale = 13;
  int offset = 0;
