...
kernel void z_solve2(global double* g_lhs, int gp0, int gp1, int gp2) {
  ...
  for (n = 0; n < 5; n++) {
    for (m = 0; m < 5; m++) {
      lhs[hook(25, k)][hook(59, 0)][hook(58, n)][hook(57, m)] = 0.0;
      lhs[hook(25, k)][hook(59, 1)][hook(61, n)][hook(60, m)] = 0.0;
      lhs[hook(25, k)][hook(59, 2)][hook(63, n)][hook(62, m)] = 0.0;
    }
    lhs[hook(25, k)][hook(59, 1)][hook(61, n)][hook(60, n)] = 1.0;
  }
}