...
kernel void computeMinus(read_only image3d_t input, read_only image3d_t distImg, global float* accBuf, global float* weightBuf, const int Nx, const int Ny, const int Nz, const int dx, const int dy, const int dz, const float sigma) {
  ...
  unsigned int dist = read_imageui(distImg, sampler, (int4)(i0 - dx, j0 - dy, k0 - dz, 0)).x;
