...
kernel void compObjWave_SinglePass(global float* pc, unsigned int pc_size, global float2* of, float hologram_z, float k, float pitch, float corner_x, float corner_y) {
