//{"image":0,"label":2,"lowerThreshold":3,"segmentation":1,"upperThreshold":4}
...
kernel void thresholding(read_only image2d_t image, write_only image2d_t segmentation, private uchar label, private float lowerThreshold, private float upperThreshold) {
