...
kernel void DWFilterBufferToImage(private const int global_size_dim0, private const int global_size_dim1, global const float* input_ptr, private const int4 kernel_shape, private const int height_width_size, write_only image2d_t output) {
