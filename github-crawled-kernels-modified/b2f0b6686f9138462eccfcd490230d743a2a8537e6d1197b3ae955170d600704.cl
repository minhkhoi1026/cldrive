...
kernel void Laplacian_32f(global float* Input, global float* Processed) {
  ...
  float temp = xminus1 + xplus1 + yminus1 + yplus1 + zminus1 + zplus1 - 4 * Input[hook(0, linear_coords)];
