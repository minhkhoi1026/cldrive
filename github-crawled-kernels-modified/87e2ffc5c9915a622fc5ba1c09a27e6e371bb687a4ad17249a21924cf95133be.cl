...
kernel void bitonicSort_hard_float(global float* a, unsigned stage, unsigned passOfStage, unsigned direction) {
  ...
  float leftElement = a[hook(0, leftIndex)];
  float rightElement = a[hook(0, rightIndex)];
