...
kernel void matchTemplate_Naive_SQDIFF_C4_D5(global const float4* img, global const float4* tpl, global float* res, int img_rows, int img_cols, int tpl_rows, int tpl_cols, int res_rows, int res_cols, int img_offset, int tpl_offset, int res_offset, int img_step, int tpl_step, int res_step) {
