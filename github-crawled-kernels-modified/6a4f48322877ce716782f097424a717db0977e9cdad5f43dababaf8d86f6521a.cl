...
kernel void ConvertFromN8UC4(private const int global_size_dim0, private const int global_size_dim1, write_only image2d_t output, global const uchar* input_ptr, private const int height, private const int width, private const int channels, private const float4 scale, private const float4 bias) {
