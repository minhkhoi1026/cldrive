//{"Neffect_radius":6,"Nq":2,"background":8,"charge":9,"cutoff":5,"dielectconst":13,"gMSAWave":14,"loops":4,"loops_g":3,"q":0,"result":1,"saltconc":12,"scale":7,"temperature":11,"volfraction":10}
...
float Iq(float QQ, float effect_radius, float zz, float VolFrac, float Temp, float csalt, float dialec) {
  ...
  gMSAWave[hook(14, 5)] = Beta * charge * charge / (pi * Perm * SIdiam * pow((2.0f + Kappa * SIdiam), 2));

  Qdiam = QQ * diam;
  gMSAWave[hook(14, 6)] = Kappa * SIdiam;
  gMSAWave[hook(14, 4)] = VolFrac;

  ss = pow(gMSAWave[hook(14, 4)], (1.0f / 3.0f));
  gMSAWave[hook(14, 9)] = 2.0f * ss * gMSAWave[hook(14, 5)] * exp(gMSAWave[hook(14, 6)] - gMSAWave[hook(14, 6)] / ss);
...
int sqcoef(int ir, float gMSAWave[]) {
  ...
  ig = 1;
  if (gMSAWave[hook(14, 6)] >= (1.0f + 8.0f * gMSAWave[hook(14, 4)])) {
    ig = 0;
    gMSAWave[hook(14, 15)] = gMSAWave[hook(14, 14)];
    gMSAWave[hook(14, 16)] = gMSAWave[hook(14, 4)];
    ix = 1;
    ir = sqfun(ix, ir, gMSAWave);
    gMSAWave[hook(14, 14)] = gMSAWave[hook(14, 15)];
    gMSAWave[hook(14, 4)] = gMSAWave[hook(14, 16)];
    if ((ir < 0.0f) || (gMSAWave[hook(14, 14)] >= 0.0f)) {
      return ir;
    }
  }
  gMSAWave[hook(14, 10)] = fmin(gMSAWave[hook(14, 4)], 0.20f);
  if ((ig != 1) || (gMSAWave[hook(14, 9)] >= 0.15f)) {
    ii = 0;
    do {
      ii = ii + 1;
      if (ii > itm) {
      ...
      if (gMSAWave[hook(14, 10)] <= 0.0f) {
        gMSAWave[hook(14, 10)] = gMSAWave[hook(14, 4)] / ii;
      }
      if (gMSAWave[hook(14, 10)] > 0.6f) {
        gMSAWave[hook(14, 10)] = 0.35f / ii;
      }
      e1 = gMSAWave[hook(14, 10)];
      gMSAWave[hook(14, 15)] = f1;
      gMSAWave[hook(14, 16)] = e1;
      ix = 2;
      ir = sqfun(ix, ir, gMSAWave);
      f1 = gMSAWave[hook(14, 15)];
      e1 = gMSAWave[hook(14, 16)];
      e2 = gMSAWave[hook(14, 10)] * 1.01f;
      gMSAWave[hook(14, 15)] = f2;
      gMSAWave[hook(14, 16)] = e2;
      ix = 2;
      ir = sqfun(ix, ir, gMSAWave);
      f2 = gMSAWave[hook(14, 15)];
      e2 = gMSAWave[hook(14, 16)];
      e2 = e1 - (e2 - e1) * f1 / (f2 - f1);
      gMSAWave[hook(14, 10)] = e2;
      del = fabs((e2 - e1) / e1);
    } while (del > acc);
    gMSAWave[hook(14, 15)] = gMSAWave[hook(14, 14)];
    gMSAWave[hook(14, 16)] = e2;
    ...
    e2 = gMSAWave[hook(14, 16)];
    ir = ii;
    if ((ig != 1) || (gMSAWave[hook(14, 10)] >= gMSAWave[hook(14, 4)])) {
      return ir;
    }
  }
  gMSAWave[hook(14, 15)] = gMSAWave[hook(14, 14)];
  ...
  gMSAWave[hook(14, 14)] = gMSAWave[hook(14, 15)];
  gMSAWave[hook(14, 4)] = gMSAWave[hook(14, 16)];
  if ((ir >= 0) && (gMSAWave[hook(14, 14)] < 0.0f)) {
    ir = -3;
  }
  return ir;
}
...
int sqfun(int ix, int ir, float gMSAWave[]) {
  ...
  reta = gMSAWave[hook(14, 16)];
  eta2 = reta * reta;
  eta3 = eta2 * reta;
  e12 = 12.0f * reta;
  e24 = e12 + e12;
  gMSAWave[hook(14, 13)] = pow((gMSAWave[hook(14, 4)] / gMSAWave[hook(14, 16)]), (1.0f / 3.0f));
  gMSAWave[hook(14, 12)] = gMSAWave[hook(14, 6)] / gMSAWave[hook(14, 13)];
  ibig = 0;
  if ((gMSAWave[hook(14, 12)] > 15.0f) && (ix == 1)) {
    ibig = 1;
  }

  gMSAWave[hook(14, 11)] = gMSAWave[hook(14, 5)] * gMSAWave[hook(14, 13)] * exp(gMSAWave[hook(14, 6)] - gMSAWave[hook(14, 12)]);
  rgek = gMSAWave[hook(14, 11)];
  rak = gMSAWave[hook(14, 12)];
  ak2 = rak * rak;
  ak1 = 1.0f + rak;
  dak2 = 1.0f / ak2;
  dak4 = dak2 * dak2;
  ...
  if (ibig != 0) {
    ...
    fa = -w46 / w56;
    ca = -fa;
    gMSAWave[hook(14, 3)] = fa;
    gMSAWave[hook(14, 2)] = ca;
    gMSAWave[hook(14, 1)] = b1 + b3 * fa;
    gMSAWave[hook(14, 0)] = a1 + a3 * fa;
    gMSAWave[hook(14, 8)] = v1 + v3 * fa;
    gMSAWave[hook(14, 14)] = -(p1 + p3 * fa);
    gMSAWave[hook(14, 15)] = gMSAWave[hook(14, 14)];
    if (fabs(gMSAWave[hook(14, 15)]) < 1.0e-3f) {
      gMSAWave[hook(14, 15)] = 0.0f;
    }
    gMSAWave[hook(14, 10)] = gMSAWave[hook(14, 16)];
    ...
    if ((ix == 1) || (ix == 3)) {
      ...
      if (ix == 1) {
        ...
        gMSAWave[hook(14, 14)] = 0.5f * eta2d * dd2 * exp(-rgek);
        if ((gMSAWave[hook(14, 11)] <= 2.0f) && (gMSAWave[hook(14, 11)] >= 0.0f) && (gMSAWave[hook(14, 12)] <= 1.0f)) {
          e24g = e24 * rgek * exp(rak);
          pwk = sqrt(e24g);
          qpw = (1.0f - sqrt(1.0f + 2.0f * d2 * d * pwk / eta22)) * eta21 / d;
          gMSAWave[hook(14, 14)] = -qpw * qpw / e24 + 0.5f * eta2d * dd2;
        }
        pg = p1 + gMSAWave[hook(14, 14)];
        ca = ak2 * pg + 2.0f * (b3 * pg - b1 * p3) + e12 * gMSAWave[hook(14, 14)] * gMSAWave[hook(14, 14)] * p3;
      ...
      gMSAWave[hook(14, 14)] = -(p1 + p2 * ca + p3 * fa);
      gMSAWave[hook(14, 15)] = gMSAWave[hook(14, 14)];
      if (fabs(gMSAWave[hook(14, 15)]) < 1.0e-3f) {
        gMSAWave[hook(14, 15)] = 0.0f;
      }
      ...
      fa = -(p1 + p2 * ca) / p3;
      if (ix == 2) {
        gMSAWave[hook(14, 15)] = um1 * ca * ca + (um2 + um3 * fa) * ca + um4 + um5 * fa + um6 * fa * fa;
      }
      if (ix == 4) {
        gMSAWave[hook(14, 15)] = -(p1 + p2 * ca + p3 * fa);
      }
    }
    gMSAWave[hook(14, 3)] = fa;
    gMSAWave[hook(14, 2)] = ca;
    gMSAWave[hook(14, 1)] = b1 + b2 * ca + b3 * fa;
    gMSAWave[hook(14, 0)] = a1 + a2 * ca + a3 * fa;
    gMSAWave[hook(14, 8)] = (v1 + v2 * ca + v3 * fa) / gMSAWave[hook(14, 0)];
  }
  g24 = e24 * rgek * ex1;
  gMSAWave[hook(14, 7)] = (rak * ak2 * ca - g24) / (ak2 * g24);
  return (ir);
}
...
float sqhcal(float qq, float gMSAWave[]) {
  ...
  etaz = gMSAWave[hook(14, 10)];
  akz = gMSAWave[hook(14, 12)];
  gekz = gMSAWave[hook(14, 11)];
  e24 = 24.0f * etaz;
  x1 = exp(akz);
  x2 = 0.0f;
  if (gMSAWave[hook(14, 12)] < 20.0f) {
  ...
  if (qq <= 0.0f) {
    SofQ = -1.0f / gMSAWave[hook(14, 0)];
  } else {
    qk = qq / gMSAWave[hook(14, 13)];
    q2k = qk * qk;
    qk2 = 1.0f / q2k;
    qk3 = qk2 / qk;
    qqk = 1.0f / (qk * (q2k + ak2));
    ...
    asink = akz * sink;
    qcosk = qk * cosk;
    aqk = gMSAWave[hook(14, 0)] * (sink - qcosk);
    aqk = aqk + gMSAWave[hook(14, 1)] * ((2.0f * qk2 - 1.0f) * qcosk + 2.0f * sink - 2.0f / qk);
    inter = 24.0f * qk3 + 4.0f * (1.0f - 6.0f * qk2) * sink;
    aqk = (aqk + 0.5f * etaz * gMSAWave[hook(14, 0)] * (inter - (1.0f - 12.0f * qk2 + 24.0f * qk2 * qk2) * qcosk)) * qk3;
    aqk = aqk + gMSAWave[hook(14, 2)] * (ck * asink - sk * qcosk) * qqk;
    aqk = aqk + gMSAWave[hook(14, 3)] * (sk * asink - qk * (ck * cosk - 1.0f)) * qqk;
    aqk = aqk + gMSAWave[hook(14, 3)] * (cosk - 1.0f) * qk2;
...
kernel void HayterMSAsq_Iq(global const float* q, global float* result, const int Nq,
...

  {
    ...
    for (int effect_radius_i = 0; effect_radius_i < Neffect_radius; effect_radius_i++) {
      ...
      if (weight > cutoff) {
        const float scattering = Iq(qi, effect_radius, charge, volfraction, temperature, saltconc, dielectconst);
