...
kernel void x_solve(global double* g_rhs, global double* g_lhs, int gp0, int gp1, int gp2) {
  ...
  isize = gp0 - 1;
  binvcrhs(lhs[hook(26, 0)][hook(25, 1)], lhs[hook(26, 0)][hook(25, 2)], rhs[hook(40, k)][hook(39, j)][hook(38, 0)]);

  for (i = 1; i <= isize - 1; i++) {
    matvec_sub(lhs[hook(26, i)][hook(41, 0)], rhs[hook(40, k)][hook(39, j)][hook(38, i - 1)], rhs[hook(40, k)][hook(39, j)][hook(38, i)]);

    matmul_sub(lhs[hook(26, i)][hook(41, 0)], lhs[hook(26, i - 1)][hook(42, 2)], lhs[hook(26, i)][hook(41, 1)]);

    binvcrhs(lhs[hook(26, i)][hook(41, 1)], lhs[hook(26, i)][hook(41, 2)], rhs[hook(40, k)][hook(39, j)][hook(38, i)]);
  }

  matvec_sub(lhs[hook(26, isize)][hook(43, 0)], rhs[hook(40, k)][hook(39, j)][hook(38, isize - 1)], rhs[hook(40, k)][hook(39, j)][hook(38, isize)]);

  matmul_sub(lhs[hook(26, isize)][hook(43, 0)], lhs[hook(26, isize - 1)][hook(44, 2)], lhs[hook(26, isize)][hook(43, 1)]);

  binvrhs(lhs[hook(26, isize)][hook(43, 1)], rhs[hook(40, k)][hook(39, j)][hook(38, isize)]);

  for (i = isize - 1; i >= 0; i--) {
    for (m = 0; m < 5; m++) {
      for (n = 0; n < 5; n++) {
        rhs[hook(40, k)][hook(39, j)][hook(38, i)][hook(45, m)] = rhs[hook(40, k)][hook(39, j)][hook(38, i)][hook(45, m)] - lhs[hook(26, i)][hook(41, 2)][hook(47, n)][hook(46, m)] * rhs[hook(40, k)][hook(39, j)][hook(38, i + 1)][hook(48, n)];
      }
    }
  }
}