...
kernel void maxpool_3d(const global float* restrict pInput, global float* restrict pOutput, const int iWidth, const int iHeight, const int nPoolsize, const int nStride) {
