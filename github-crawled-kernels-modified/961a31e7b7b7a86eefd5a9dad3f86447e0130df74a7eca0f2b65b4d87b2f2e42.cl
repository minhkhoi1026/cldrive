//{"ablock":8,"ablock[0]":7,"ablock[1]":10,"ablock[2]":11,"ablock[3]":12,"ablock[4]":13,"avec":9,"bblock":17,"bblock[0]":16,"bblock[1]":19,"bblock[2]":21,"bblock[3]":23,"bblock[4]":25,"bvec":6,"c":33,"c[0]":32,"c[1]":34,"c[2]":35,"c[3]":36,"c[4]":37,"cblock":15,"cblock[0]":14,"cblock[1]":18,"cblock[2]":20,"cblock[3]":22,"cblock[4]":24,"fjac":64,"fjac[k + 1]":95,"fjac[k + 1][0]":94,"fjac[k + 1][1]":99,"fjac[k + 1][2]":102,"fjac[k + 1][3]":105,"fjac[k + 1][4]":108,"fjac[k - 1]":63,"fjac[k - 1][0]":62,"fjac[k - 1][1]":69,"fjac[k - 1][2]":72,"fjac[k - 1][3]":75,"fjac[k - 1][4]":78,"g_fjac":0,"g_lhs":2,"g_matrix":42,"g_matrix[0]":41,"g_matrix[1]":44,"g_matrix[2]":46,"g_matrix[3]":48,"g_matrix[4]":50,"g_njac":1,"g_vector":58,"gp0":3,"gp1":4,"gp2":5,"lhs":27,"lhs[0]":26,"lhs[1]":28,"lhs[2]":29,"lhs[3]":30,"lhs[4]":31,"lhs[k]":61,"lhs[k][0]":60,"lhs[k][0][0]":59,"lhs[k][0][1]":68,"lhs[k][0][2]":71,"lhs[k][0][3]":74,"lhs[k][0][4]":77,"lhs[k][1]":81,"lhs[k][1][0]":80,"lhs[k][1][1]":84,"lhs[k][1][2]":86,"lhs[k][1][3]":88,"lhs[k][1][4]":90,"lhs[k][2]":93,"lhs[k][2][0]":92,"lhs[k][2][1]":98,"lhs[k][2][2]":101,"lhs[k][2][3]":104,"lhs[k][2][4]":107,"njac":67,"njac[k + 1]":97,"njac[k + 1][0]":96,"njac[k + 1][1]":100,"njac[k + 1][2]":103,"njac[k + 1][3]":106,"njac[k + 1][4]":109,"njac[k - 1]":66,"njac[k - 1][0]":65,"njac[k - 1][1]":70,"njac[k - 1][2]":73,"njac[k - 1][3]":76,"njac[k - 1][4]":79,"njac[k]":83,"njac[k][0]":82,"njac[k][1]":85,"njac[k][2]":87,"njac[k][3]":89,"njac[k][4]":91,"p_matrix":40,"p_matrix[0]":39,"p_matrix[1]":43,"p_matrix[2]":45,"p_matrix[3]":47,"p_matrix[4]":49,"p_source":52,"p_source[0]":51,"p_source[1]":53,"p_source[2]":54,"p_source[3]":55,"p_source[4]":56,"p_vector":57,"r":38}
...
kernel void z_solve3(global double* g_fjac, global double* g_njac, global double* g_lhs, int gp0, int gp1, int gp2) {
  int i, j, k;
  double tmp1, tmp2;
  ...
  lhs[hook(27, k)][hook(61, 0)][hook(60, 0)][hook(59, 0)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 0)][hook(62, 0)] - tmp1 * njac[hook(67, k - 1)][hook(66, 0)][hook(65, 0)] - tmp1 * 1.0;
  lhs[hook(27, k)][hook(61, 0)][hook(60, 1)][hook(68, 0)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 1)][hook(69, 0)] - tmp1 * njac[hook(67, k - 1)][hook(66, 1)][hook(70, 0)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 2)][hook(71, 0)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 2)][hook(72, 0)] - tmp1 * njac[hook(67, k - 1)][hook(66, 2)][hook(73, 0)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 3)][hook(74, 0)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 3)][hook(75, 0)] - tmp1 * njac[hook(67, k - 1)][hook(66, 3)][hook(76, 0)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 4)][hook(77, 0)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 4)][hook(78, 0)] - tmp1 * njac[hook(67, k - 1)][hook(66, 4)][hook(79, 0)];

  lhs[hook(27, k)][hook(61, 0)][hook(60, 0)][hook(59, 1)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 0)][hook(62, 1)] - tmp1 * njac[hook(67, k - 1)][hook(66, 0)][hook(65, 1)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 1)][hook(68, 1)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 1)][hook(69, 1)] - tmp1 * njac[hook(67, k - 1)][hook(66, 1)][hook(70, 1)] - tmp1 * 1.0;
  lhs[hook(27, k)][hook(61, 0)][hook(60, 2)][hook(71, 1)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 2)][hook(72, 1)] - tmp1 * njac[hook(67, k - 1)][hook(66, 2)][hook(73, 1)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 3)][hook(74, 1)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 3)][hook(75, 1)] - tmp1 * njac[hook(67, k - 1)][hook(66, 3)][hook(76, 1)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 4)][hook(77, 1)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 4)][hook(78, 1)] - tmp1 * njac[hook(67, k - 1)][hook(66, 4)][hook(79, 1)];

  lhs[hook(27, k)][hook(61, 0)][hook(60, 0)][hook(59, 2)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 0)][hook(62, 2)] - tmp1 * njac[hook(67, k - 1)][hook(66, 0)][hook(65, 2)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 1)][hook(68, 2)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 1)][hook(69, 2)] - tmp1 * njac[hook(67, k - 1)][hook(66, 1)][hook(70, 2)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 2)][hook(71, 2)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 2)][hook(72, 2)] - tmp1 * njac[hook(67, k - 1)][hook(66, 2)][hook(73, 2)] - tmp1 * 1.0;
  lhs[hook(27, k)][hook(61, 0)][hook(60, 3)][hook(74, 2)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 3)][hook(75, 2)] - tmp1 * njac[hook(67, k - 1)][hook(66, 3)][hook(76, 2)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 4)][hook(77, 2)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 4)][hook(78, 2)] - tmp1 * njac[hook(67, k - 1)][hook(66, 4)][hook(79, 2)];

  lhs[hook(27, k)][hook(61, 0)][hook(60, 0)][hook(59, 3)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 0)][hook(62, 3)] - tmp1 * njac[hook(67, k - 1)][hook(66, 0)][hook(65, 3)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 1)][hook(68, 3)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 1)][hook(69, 3)] - tmp1 * njac[hook(67, k - 1)][hook(66, 1)][hook(70, 3)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 2)][hook(71, 3)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 2)][hook(72, 3)] - tmp1 * njac[hook(67, k - 1)][hook(66, 2)][hook(73, 3)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 3)][hook(74, 3)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 3)][hook(75, 3)] - tmp1 * njac[hook(67, k - 1)][hook(66, 3)][hook(76, 3)] - tmp1 * 1.0;
  lhs[hook(27, k)][hook(61, 0)][hook(60, 4)][hook(77, 3)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 4)][hook(78, 3)] - tmp1 * njac[hook(67, k - 1)][hook(66, 4)][hook(79, 3)];

  lhs[hook(27, k)][hook(61, 0)][hook(60, 0)][hook(59, 4)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 0)][hook(62, 4)] - tmp1 * njac[hook(67, k - 1)][hook(66, 0)][hook(65, 4)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 1)][hook(68, 4)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 1)][hook(69, 4)] - tmp1 * njac[hook(67, k - 1)][hook(66, 1)][hook(70, 4)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 2)][hook(71, 4)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 2)][hook(72, 4)] - tmp1 * njac[hook(67, k - 1)][hook(66, 2)][hook(73, 4)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 3)][hook(74, 4)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 3)][hook(75, 4)] - tmp1 * njac[hook(67, k - 1)][hook(66, 3)][hook(76, 4)];
  lhs[hook(27, k)][hook(61, 0)][hook(60, 4)][hook(77, 4)] = -tmp2 * fjac[hook(64, k - 1)][hook(63, 4)][hook(78, 4)] - tmp1 * njac[hook(67, k - 1)][hook(66, 4)][hook(79, 4)] - tmp1 * 1.0;

  lhs[hook(27, k)][hook(61, 1)][hook(81, 0)][hook(80, 0)] = 1.0 + tmp1 * 2.0 * njac[hook(67, k)][hook(83, 0)][hook(82, 0)] + tmp1 * 2.0 * 1.0;
  lhs[hook(27, k)][hook(61, 1)][hook(81, 1)][hook(84, 0)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 1)][hook(85, 0)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 2)][hook(86, 0)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 2)][hook(87, 0)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 3)][hook(88, 0)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 3)][hook(89, 0)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 4)][hook(90, 0)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 4)][hook(91, 0)];

  lhs[hook(27, k)][hook(61, 1)][hook(81, 0)][hook(80, 1)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 0)][hook(82, 1)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 1)][hook(84, 1)] = 1.0 + tmp1 * 2.0 * njac[hook(67, k)][hook(83, 1)][hook(85, 1)] + tmp1 * 2.0 * 1.0;
  lhs[hook(27, k)][hook(61, 1)][hook(81, 2)][hook(86, 1)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 2)][hook(87, 1)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 3)][hook(88, 1)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 3)][hook(89, 1)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 4)][hook(90, 1)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 4)][hook(91, 1)];

  lhs[hook(27, k)][hook(61, 1)][hook(81, 0)][hook(80, 2)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 0)][hook(82, 2)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 1)][hook(84, 2)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 1)][hook(85, 2)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 2)][hook(86, 2)] = 1.0 + tmp1 * 2.0 * njac[hook(67, k)][hook(83, 2)][hook(87, 2)] + tmp1 * 2.0 * 1.0;
  lhs[hook(27, k)][hook(61, 1)][hook(81, 3)][hook(88, 2)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 3)][hook(89, 2)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 4)][hook(90, 2)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 4)][hook(91, 2)];

  lhs[hook(27, k)][hook(61, 1)][hook(81, 0)][hook(80, 3)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 0)][hook(82, 3)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 1)][hook(84, 3)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 1)][hook(85, 3)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 2)][hook(86, 3)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 2)][hook(87, 3)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 3)][hook(88, 3)] = 1.0 + tmp1 * 2.0 * njac[hook(67, k)][hook(83, 3)][hook(89, 3)] + tmp1 * 2.0 * 1.0;
  lhs[hook(27, k)][hook(61, 1)][hook(81, 4)][hook(90, 3)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 4)][hook(91, 3)];

  lhs[hook(27, k)][hook(61, 1)][hook(81, 0)][hook(80, 4)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 0)][hook(82, 4)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 1)][hook(84, 4)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 1)][hook(85, 4)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 2)][hook(86, 4)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 2)][hook(87, 4)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 3)][hook(88, 4)] = tmp1 * 2.0 * njac[hook(67, k)][hook(83, 3)][hook(89, 4)];
  lhs[hook(27, k)][hook(61, 1)][hook(81, 4)][hook(90, 4)] = 1.0 + tmp1 * 2.0 * njac[hook(67, k)][hook(83, 4)][hook(91, 4)] + tmp1 * 2.0 * 1.0;

  lhs[hook(27, k)][hook(61, 2)][hook(93, 0)][hook(92, 0)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 0)][hook(94, 0)] - tmp1 * njac[hook(67, k + 1)][hook(97, 0)][hook(96, 0)] - tmp1 * 1.0;
  lhs[hook(27, k)][hook(61, 2)][hook(93, 1)][hook(98, 0)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 1)][hook(99, 0)] - tmp1 * njac[hook(67, k + 1)][hook(97, 1)][hook(100, 0)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 2)][hook(101, 0)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 2)][hook(102, 0)] - tmp1 * njac[hook(67, k + 1)][hook(97, 2)][hook(103, 0)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 3)][hook(104, 0)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 3)][hook(105, 0)] - tmp1 * njac[hook(67, k + 1)][hook(97, 3)][hook(106, 0)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 4)][hook(107, 0)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 4)][hook(108, 0)] - tmp1 * njac[hook(67, k + 1)][hook(97, 4)][hook(109, 0)];

  lhs[hook(27, k)][hook(61, 2)][hook(93, 0)][hook(92, 1)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 0)][hook(94, 1)] - tmp1 * njac[hook(67, k + 1)][hook(97, 0)][hook(96, 1)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 1)][hook(98, 1)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 1)][hook(99, 1)] - tmp1 * njac[hook(67, k + 1)][hook(97, 1)][hook(100, 1)] - tmp1 * 1.0;
  lhs[hook(27, k)][hook(61, 2)][hook(93, 2)][hook(101, 1)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 2)][hook(102, 1)] - tmp1 * njac[hook(67, k + 1)][hook(97, 2)][hook(103, 1)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 3)][hook(104, 1)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 3)][hook(105, 1)] - tmp1 * njac[hook(67, k + 1)][hook(97, 3)][hook(106, 1)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 4)][hook(107, 1)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 4)][hook(108, 1)] - tmp1 * njac[hook(67, k + 1)][hook(97, 4)][hook(109, 1)];

  lhs[hook(27, k)][hook(61, 2)][hook(93, 0)][hook(92, 2)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 0)][hook(94, 2)] - tmp1 * njac[hook(67, k + 1)][hook(97, 0)][hook(96, 2)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 1)][hook(98, 2)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 1)][hook(99, 2)] - tmp1 * njac[hook(67, k + 1)][hook(97, 1)][hook(100, 2)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 2)][hook(101, 2)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 2)][hook(102, 2)] - tmp1 * njac[hook(67, k + 1)][hook(97, 2)][hook(103, 2)] - tmp1 * 1.0;
  lhs[hook(27, k)][hook(61, 2)][hook(93, 3)][hook(104, 2)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 3)][hook(105, 2)] - tmp1 * njac[hook(67, k + 1)][hook(97, 3)][hook(106, 2)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 4)][hook(107, 2)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 4)][hook(108, 2)] - tmp1 * njac[hook(67, k + 1)][hook(97, 4)][hook(109, 2)];

  lhs[hook(27, k)][hook(61, 2)][hook(93, 0)][hook(92, 3)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 0)][hook(94, 3)] - tmp1 * njac[hook(67, k + 1)][hook(97, 0)][hook(96, 3)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 1)][hook(98, 3)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 1)][hook(99, 3)] - tmp1 * njac[hook(67, k + 1)][hook(97, 1)][hook(100, 3)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 2)][hook(101, 3)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 2)][hook(102, 3)] - tmp1 * njac[hook(67, k + 1)][hook(97, 2)][hook(103, 3)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 3)][hook(104, 3)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 3)][hook(105, 3)] - tmp1 * njac[hook(67, k + 1)][hook(97, 3)][hook(106, 3)] - tmp1 * 1.0;
  lhs[hook(27, k)][hook(61, 2)][hook(93, 4)][hook(107, 3)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 4)][hook(108, 3)] - tmp1 * njac[hook(67, k + 1)][hook(97, 4)][hook(109, 3)];

  lhs[hook(27, k)][hook(61, 2)][hook(93, 0)][hook(92, 4)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 0)][hook(94, 4)] - tmp1 * njac[hook(67, k + 1)][hook(97, 0)][hook(96, 4)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 1)][hook(98, 4)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 1)][hook(99, 4)] - tmp1 * njac[hook(67, k + 1)][hook(97, 1)][hook(100, 4)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 2)][hook(101, 4)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 2)][hook(102, 4)] - tmp1 * njac[hook(67, k + 1)][hook(97, 2)][hook(103, 4)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 3)][hook(104, 4)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 3)][hook(105, 4)] - tmp1 * njac[hook(67, k + 1)][hook(97, 3)][hook(106, 4)];
  lhs[hook(27, k)][hook(61, 2)][hook(93, 4)][hook(107, 4)] = tmp2 * fjac[hook(64, k + 1)][hook(95, 4)][hook(108, 4)] - tmp1 * njac[hook(67, k + 1)][hook(97, 4)][hook(109, 4)] - tmp1 * 1.0;
}