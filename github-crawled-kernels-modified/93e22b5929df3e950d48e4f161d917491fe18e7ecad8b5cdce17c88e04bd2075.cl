...
kernel void gaussBlurY(global float* io, const int width, const int height, const int radius, const float sigma, global float* gaussMatrix, global float* backup) {
