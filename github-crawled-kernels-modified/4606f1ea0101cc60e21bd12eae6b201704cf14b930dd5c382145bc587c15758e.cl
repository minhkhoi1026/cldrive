...
void ReadPatchIToLocalMem(image2d_t I, float2 float4, local float* IPatchLocal) {
  ...
  IPatchLocal[hook(21, mad24(mad24((0), 8, yid), (8 * 3 + 2), mad24((0), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((0), 8, float4.x + xid - 0.5f), mad((0), 8, float4.y + yid - 0.5f))).x;
  ;
  IPatchLocal[hook(21, mad24(mad24((0), 8, yid), (8 * 3 + 2), mad24((1), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((1), 8, float4.x + xid - 0.5f), mad((0), 8, float4.y + yid - 0.5f))).x;
  ;
  IPatchLocal[hook(21, mad24(mad24((0), 8, yid), (8 * 3 + 2), mad24((2), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((2), 8, float4.x + xid - 0.5f), mad((0), 8, float4.y + yid - 0.5f))).x;
  ;
  IPatchLocal[hook(21, mad24(mad24((1), 8, yid), (8 * 3 + 2), mad24((0), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((0), 8, float4.x + xid - 0.5f), mad((1), 8, float4.y + yid - 0.5f))).x;
  ;
  IPatchLocal[hook(21, mad24(mad24((1), 8, yid), (8 * 3 + 2), mad24((1), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((1), 8, float4.x + xid - 0.5f), mad((1), 8, float4.y + yid - 0.5f))).x;
  ;
  IPatchLocal[hook(21, mad24(mad24((1), 8, yid), (8 * 3 + 2), mad24((2), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((2), 8, float4.x + xid - 0.5f), mad((1), 8, float4.y + yid - 0.5f))).x;
  ;
  IPatchLocal[hook(21, mad24(mad24((2), 8, yid), (8 * 3 + 2), mad24((0), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((0), 8, float4.x + xid - 0.5f), mad((2), 8, float4.y + yid - 0.5f))).x;
  ;
  IPatchLocal[hook(21, mad24(mad24((2), 8, yid), (8 * 3 + 2), mad24((1), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((1), 8, float4.x + xid - 0.5f), mad((2), 8, float4.y + yid - 0.5f))).x;
  ;
  IPatchLocal[hook(21, mad24(mad24((2), 8, yid), (8 * 3 + 2), mad24((2), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((2), 8, float4.x + xid - 0.5f), mad((2), 8, float4.y + yid - 0.5f))).x;
  ;
  if (xid < 2) {
    IPatchLocal[hook(21, mad24(mad24((0), 8, yid), (8 * 3 + 2), mad24((3), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((3), 8, float4.x + xid - 0.5f), mad((0), 8, float4.y + yid - 0.5f))).x;
    ;
    IPatchLocal[hook(21, mad24(mad24((1), 8, yid), (8 * 3 + 2), mad24((3), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((3), 8, float4.x + xid - 0.5f), mad((1), 8, float4.y + yid - 0.5f))).x;
    ;
    IPatchLocal[hook(21, mad24(mad24((2), 8, yid), (8 * 3 + 2), mad24((3), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((3), 8, float4.x + xid - 0.5f), mad((2), 8, float4.y + yid - 0.5f))).x;
    ;
  }

  if (yid < 2) {
    IPatchLocal[hook(21, mad24(mad24((3), 8, yid), (8 * 3 + 2), mad24((0), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((0), 8, float4.x + xid - 0.5f), mad((3), 8, float4.y + yid - 0.5f))).x;
    ;
    IPatchLocal[hook(21, mad24(mad24((3), 8, yid), (8 * 3 + 2), mad24((1), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((1), 8, float4.x + xid - 0.5f), mad((3), 8, float4.y + yid - 0.5f))).x;
    ;
    IPatchLocal[hook(21, mad24(mad24((3), 8, yid), (8 * 3 + 2), mad24((2), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((2), 8, float4.x + xid - 0.5f), mad((3), 8, float4.y + yid - 0.5f))).x;
    ;
  }

  if (yid < 2 && xid < 2) {
    IPatchLocal[hook(21, mad24(mad24((3), 8, yid), (8 * 3 + 2), mad24((3), 8, xid)))] = read_imagef(I, sampler, (float2)(mad((3), 8, float4.x + xid - 0.5f), mad((3), 8, float4.y + yid - 0.5f))).x;
    ;
  }
  barrier(0x01);
}
