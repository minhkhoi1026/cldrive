...
kernel void AddVolumes(global float* Result, global const float* Volume1, global const float* Volume2, private int DATA_W, private int DATA_H, private int DATA_D) {
