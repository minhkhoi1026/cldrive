...
kernel void scharrV3(global const uchar* source, global uchar* dest, int src_step, int dst_step, int width, int height) {
  constant const float matrix[9] = {-3, 0, 3, -10, 0, 10, -3, 0, 3};
