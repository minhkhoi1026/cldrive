...
kernel void bpnn_adjust_weights(global float* restrict delta, int ndelta, global float* restrict ly, int nly, global float* restrict w, global float* restrict oldw) {
  float new_dw;
  int k, j;
  ly[hook(2, 0)] = 1.0;
