...
__attribute__((reqd_work_group_size(1, 1, 1))) __attribute__((reqd_work_group_size(1, 1, 1))) kernel void aesDecCipher(global uchar* restrict in, global unsigned int* restrict w, global uchar* restrict out, unsigned int num_rounds, unsigned int input_size) {
 private
  uchar state_in[16u];
 private
  uchar state_out[16u];
