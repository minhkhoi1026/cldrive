...
kernel void saxpy_dp_no_wait(const int numElems, const float factor, global const float* src_0, global const float* src_1, global float* dst_0) {
  ...
  int err_ret = enqueue_kernel(defQ, 0x0, ndrange, saxpy_dp_child_wrapper);
}