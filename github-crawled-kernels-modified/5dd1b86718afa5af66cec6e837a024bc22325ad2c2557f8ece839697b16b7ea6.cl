//{"hiddenSize":6,"hiddenStates":0,"hiddenToVisible":8,"qErrors":4,"qErrorsNext":3,"qStates":1,"qWeights":2,"radius":9,"reluLeak":11,"reverseRadii":10,"visibleSize":5,"visibleToHidden":7}
...
kernel void qBackward(read_only image2d_t hiddenStates, read_only image2d_t qStates, read_only image3d_t qWeights, read_only image2d_t qErrorsNext, write_only image2d_t qErrors, int2 visibleSize, int2 hiddenSize, float2 visibleToHidden, float2 hiddenToVisible, int radius, int2 reverseRadii, float reluLeak) {
