...
kernel void ninvr(global double* g_rhs, int nx2, int ny2, int nz2) {
  int i, j, k;
  ...
  rhs[hook(7, k)][hook(6, j)][hook(5, i)][hook(4, 0)] = -r2;
  rhs[hook(7, k)][hook(6, j)][hook(5, i)][hook(4, 1)] = r1;
  rhs[hook(7, k)][hook(6, j)][hook(5, i)][hook(4, 2)] = sqrt(0.5) * (r4 - r5);
