...
kernel void s_kernel_coo_permute(const int nnz, global const int* in_row, global const int* in_col, global const int* perm, global int* out_row, global int* out_col) {
