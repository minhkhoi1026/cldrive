//{"A":0,"B":1,"C":2,"K":5,"M":3,"N":4,"regA":10,"regA_bak":12,"regB":11,"regB_bak":13,"regC":7,"regC[0]":14,"regC[1]":15,"regC[2]":16,"regC[3]":17,"regC[4]":18,"regC[5]":19,"regC[6]":20,"regC[7]":21,"regC[i]":6,"tileA":8,"tileB":9}
...
kernel void gemm(const global float* A, const global float* B, global float* C, const int M, const int N, const int K) {
  ...
  for (int i = 0; i < K / NUM_UNROLL; ++i) {
    ...
    for (int k = 0; k < NUM_UNROLL; ++k) {
      if (k % 2 == 0) {
        regA_bak[hook(12, 0)] = tileA[hook(8, (k + 1) * tile_dim_x + local_thread_id_x * 8 + 0)];
        regA_bak[hook(12, 1)] = tileA[hook(8, (k + 1) * tile_dim_x + local_thread_id_x * 8 + 1)];
        regA_bak[hook(12, 2)] = tileA[hook(8, (k + 1) * tile_dim_x + local_thread_id_x * 8 + 2)];
        regA_bak[hook(12, 3)] = tileA[hook(8, (k + 1) * tile_dim_x + local_thread_id_x * 8 + 3)];
        regA_bak[hook(12, 4)] = tileA[hook(8, (k + 1) * tile_dim_x + local_thread_id_x * 8 + 4)];
        regA_bak[hook(12, 5)] = tileA[hook(8, (k + 1) * tile_dim_x + local_thread_id_x * 8 + 5)];
        regA_bak[hook(12, 6)] = tileA[hook(8, (k + 1) * tile_dim_x + local_thread_id_x * 8 + 6)];
        regA_bak[hook(12, 7)] = tileA[hook(8, (k + 1) * tile_dim_x + local_thread_id_x * 8 + 7)];

        regB_bak[hook(13, 0)] = tileB[hook(9, (k + 1) * tile_dim_y + local_thread_id_y * 8 + 0)];
        regB_bak[hook(13, 1)] = tileB[hook(9, (k + 1) * tile_dim_y + local_thread_id_y * 8 + 1)];
        regB_bak[hook(13, 2)] = tileB[hook(9, (k + 1) * tile_dim_y + local_thread_id_y * 8 + 2)];
        regB_bak[hook(13, 3)] = tileB[hook(9, (k + 1) * tile_dim_y + local_thread_id_y * 8 + 3)];
        regB_bak[hook(13, 4)] = tileB[hook(9, (k + 1) * tile_dim_y + local_thread_id_y * 8 + 4)];
        regB_bak[hook(13, 5)] = tileB[hook(9, (k + 1) * tile_dim_y + local_thread_id_y * 8 + 5)];
        regB_bak[hook(13, 6)] = tileB[hook(9, (k + 1) * tile_dim_y + local_thread_id_y * 8 + 6)];
        regB_bak[hook(13, 7)] = tileB[hook(9, (k + 1) * tile_dim_y + local_thread_id_y * 8 + 7)];

        regC[hook(7, 0)][hook(14, 0)] += regA[hook(10, 0)] * regB[hook(11, 0)];
        regC[hook(7, 0)][hook(14, 1)] += regA[hook(10, 0)] * regB[hook(11, 1)];
        regC[hook(7, 0)][hook(14, 2)] += regA[hook(10, 0)] * regB[hook(11, 2)];
        regC[hook(7, 0)][hook(14, 3)] += regA[hook(10, 0)] * regB[hook(11, 3)];
        regC[hook(7, 0)][hook(14, 4)] += regA[hook(10, 0)] * regB[hook(11, 4)];
        regC[hook(7, 0)][hook(14, 5)] += regA[hook(10, 0)] * regB[hook(11, 5)];
        regC[hook(7, 0)][hook(14, 6)] += regA[hook(10, 0)] * regB[hook(11, 6)];
        regC[hook(7, 0)][hook(14, 7)] += regA[hook(10, 0)] * regB[hook(11, 7)];

        regC[hook(7, 1)][hook(15, 0)] += regA[hook(10, 1)] * regB[hook(11, 0)];
        regC[hook(7, 1)][hook(15, 1)] += regA[hook(10, 1)] * regB[hook(11, 1)];
        regC[hook(7, 1)][hook(15, 2)] += regA[hook(10, 1)] * regB[hook(11, 2)];
        regC[hook(7, 1)][hook(15, 3)] += regA[hook(10, 1)] * regB[hook(11, 3)];
        regC[hook(7, 1)][hook(15, 4)] += regA[hook(10, 1)] * regB[hook(11, 4)];
        regC[hook(7, 1)][hook(15, 5)] += regA[hook(10, 1)] * regB[hook(11, 5)];
        regC[hook(7, 1)][hook(15, 6)] += regA[hook(10, 1)] * regB[hook(11, 6)];
        regC[hook(7, 1)][hook(15, 7)] += regA[hook(10, 1)] * regB[hook(11, 7)];

        regC[hook(7, 2)][hook(16, 0)] += regA[hook(10, 2)] * regB[hook(11, 0)];
        regC[hook(7, 2)][hook(16, 1)] += regA[hook(10, 2)] * regB[hook(11, 1)];
        regC[hook(7, 2)][hook(16, 2)] += regA[hook(10, 2)] * regB[hook(11, 2)];
        regC[hook(7, 2)][hook(16, 3)] += regA[hook(10, 2)] * regB[hook(11, 3)];
        regC[hook(7, 2)][hook(16, 4)] += regA[hook(10, 2)] * regB[hook(11, 4)];
        regC[hook(7, 2)][hook(16, 5)] += regA[hook(10, 2)] * regB[hook(11, 5)];
        regC[hook(7, 2)][hook(16, 6)] += regA[hook(10, 2)] * regB[hook(11, 6)];
        regC[hook(7, 2)][hook(16, 7)] += regA[hook(10, 2)] * regB[hook(11, 7)];
        ...
        regC[hook(7, 0)][hook(14, 0)] += regA_bak[hook(12, 0)] * regB_bak[hook(13, 0)];
        regC[hook(7, 0)][hook(14, 1)] += regA_bak[hook(12, 0)] * regB_bak[hook(13, 1)];
        regC[hook(7, 0)][hook(14, 2)] += regA_bak[hook(12, 0)] * regB_bak[hook(13, 2)];
        regC[hook(7, 0)][hook(14, 3)] += regA_bak[hook(12, 0)] * regB_bak[hook(13, 3)];
        regC[hook(7, 0)][hook(14, 4)] += regA_bak[hook(12, 0)] * regB_bak[hook(13, 4)];
        regC[hook(7, 0)][hook(14, 5)] += regA_bak[hook(12, 0)] * regB_bak[hook(13, 5)];
        regC[hook(7, 0)][hook(14, 6)] += regA_bak[hook(12, 0)] * regB_bak[hook(13, 6)];
        regC[hook(7, 0)][hook(14, 7)] += regA_bak[hook(12, 0)] * regB_bak[hook(13, 7)];

        regC[hook(7, 1)][hook(15, 0)] += regA_bak[hook(12, 1)] * regB_bak[hook(13, 0)];
        regC[hook(7, 1)][hook(15, 1)] += regA_bak[hook(12, 1)] * regB_bak[hook(13, 1)];
        regC[hook(7, 1)][hook(15, 2)] += regA_bak[hook(12, 1)] * regB_bak[hook(13, 2)];
        regC[hook(7, 1)][hook(15, 3)] += regA_bak[hook(12, 1)] * regB_bak[hook(13, 3)];
        regC[hook(7, 1)][hook(15, 4)] += regA_bak[hook(12, 1)] * regB_bak[hook(13, 4)];
        regC[hook(7, 1)][hook(15, 5)] += regA_bak[hook(12, 1)] * regB_bak[hook(13, 5)];
        regC[hook(7, 1)][hook(15, 6)] += regA_bak[hook(12, 1)] * regB_bak[hook(13, 6)];
        regC[hook(7, 1)][hook(15, 7)] += regA_bak[hook(12, 1)] * regB_bak[hook(13, 7)];

        regC[hook(7, 2)][hook(16, 0)] += regA_bak[hook(12, 2)] * regB_bak[hook(13, 0)];
        regC[hook(7, 2)][hook(16, 1)] += regA_bak[hook(12, 2)] * regB_bak[hook(13, 1)];
        regC[hook(7, 2)][hook(16, 2)] += regA_bak[hook(12, 2)] * regB_bak[hook(13, 2)];
        regC[hook(7, 2)][hook(16, 3)] += regA_bak[hook(12, 2)] * regB_bak[hook(13, 3)];
        regC[hook(7, 2)][hook(16, 4)] += regA_bak[hook(12, 2)] * regB_bak[hook(13, 4)];
        regC[hook(7, 2)][hook(16, 5)] += regA_bak[hook(12, 2)] * regB_bak[hook(13, 5)];
        regC[hook(7, 2)][hook(16, 6)] += regA_bak[hook(12, 2)] * regB_bak[hook(13, 6)];
        regC[hook(7, 2)][hook(16, 7)] += regA_bak[hook(12, 2)] * regB_bak[hook(13, 7)];

        regC[hook(7, 3)][hook(17, 0)] += regA_bak[hook(12, 3)] * regB_bak[hook(13, 0)];
        regC[hook(7, 3)][hook(17, 1)] += regA_bak[hook(12, 3)] * regB_bak[hook(13, 1)];
        regC[hook(7, 3)][hook(17, 2)] += regA_bak[hook(12, 3)] * regB_bak[hook(13, 2)];
        regC[hook(7, 3)][hook(17, 3)] += regA_bak[hook(12, 3)] * regB_bak[hook(13, 3)];
        regC[hook(7, 3)][hook(17, 4)] += regA_bak[hook(12, 3)] * regB_bak[hook(13, 4)];
        regC[hook(7, 3)][hook(17, 5)] += regA_bak[hook(12, 3)] * regB_bak[hook(13, 5)];
        regC[hook(7, 3)][hook(17, 6)] += regA_bak[hook(12, 3)] * regB_bak[hook(13, 6)];
        regC[hook(7, 3)][hook(17, 7)] += regA_bak[hook(12, 3)] * regB_bak[hook(13, 7)];

        regC[hook(7, 4)][hook(18, 0)] += regA_bak[hook(12, 4)] * regB_bak[hook(13, 0)];
        regC[hook(7, 4)][hook(18, 1)] += regA_bak[hook(12, 4)] * regB_bak[hook(13, 1)];
        regC[hook(7, 4)][hook(18, 2)] += regA_bak[hook(12, 4)] * regB_bak[hook(13, 2)];
        regC[hook(7, 4)][hook(18, 3)] += regA_bak[hook(12, 4)] * regB_bak[hook(13, 3)];
        regC[hook(7, 4)][hook(18, 4)] += regA_bak[hook(12, 4)] * regB_bak[hook(13, 4)];
        regC[hook(7, 4)][hook(18, 5)] += regA_bak[hook(12, 4)] * regB_bak[hook(13, 5)];
        regC[hook(7, 4)][hook(18, 6)] += regA_bak[hook(12, 4)] * regB_bak[hook(13, 6)];
        regC[hook(7, 4)][hook(18, 7)] += regA_bak[hook(12, 4)] * regB_bak[hook(13, 7)];

        regC[hook(7, 5)][hook(19, 0)] += regA_bak[hook(12, 5)] * regB_bak[hook(13, 0)];
        regC[hook(7, 5)][hook(19, 1)] += regA_bak[hook(12, 5)] * regB_bak[hook(13, 1)];
        regC[hook(7, 5)][hook(19, 2)] += regA_bak[hook(12, 5)] * regB_bak[hook(13, 2)];
        regC[hook(7, 5)][hook(19, 3)] += regA_bak[hook(12, 5)] * regB_bak[hook(13, 3)];
        regC[hook(7, 5)][hook(19, 4)] += regA_bak[hook(12, 5)] * regB_bak[hook(13, 4)];
        regC[hook(7, 5)][hook(19, 5)] += regA_bak[hook(12, 5)] * regB_bak[hook(13, 5)];
        regC[hook(7, 5)][hook(19, 6)] += regA_bak[hook(12, 5)] * regB_bak[hook(13, 6)];
        regC[hook(7, 5)][hook(19, 7)] += regA_bak[hook(12, 5)] * regB_bak[hook(13, 7)];

        regC[hook(7, 6)][hook(20, 0)] += regA_bak[hook(12, 6)] * regB_bak[hook(13, 0)];
        regC[hook(7, 6)][hook(20, 1)] += regA_bak[hook(12, 6)] * regB_bak[hook(13, 1)];
        regC[hook(7, 6)][hook(20, 2)] += regA_bak[hook(12, 6)] * regB_bak[hook(13, 2)];
        regC[hook(7, 6)][hook(20, 3)] += regA_bak[hook(12, 6)] * regB_bak[hook(13, 3)];
        regC[hook(7, 6)][hook(20, 4)] += regA_bak[hook(12, 6)] * regB_bak[hook(13, 4)];
        regC[hook(7, 6)][hook(20, 5)] += regA_bak[hook(12, 6)] * regB_bak[hook(13, 5)];
        regC[hook(7, 6)][hook(20, 6)] += regA_bak[hook(12, 6)] * regB_bak[hook(13, 6)];
        regC[hook(7, 6)][hook(20, 7)] += regA_bak[hook(12, 6)] * regB_bak[hook(13, 7)];

        regC[hook(7, 7)][hook(21, 0)] += regA_bak[hook(12, 7)] * regB_bak[hook(13, 0)];
        regC[hook(7, 7)][hook(21, 1)] += regA_bak[hook(12, 7)] * regB_bak[hook(13, 1)];
        regC[hook(7, 7)][hook(21, 2)] += regA_bak[hook(12, 7)] * regB_bak[hook(13, 2)];
        regC[hook(7, 7)][hook(21, 3)] += regA_bak[hook(12, 7)] * regB_bak[hook(13, 3)];
        regC[hook(7, 7)][hook(21, 4)] += regA_bak[hook(12, 7)] * regB_bak[hook(13, 4)];
        regC[hook(7, 7)][hook(21, 5)] += regA_bak[hook(12, 7)] * regB_bak[hook(13, 5)];
        regC[hook(7, 7)][hook(21, 6)] += regA_bak[hook(12, 7)] * regB_bak[hook(13, 6)];
        regC[hook(7, 7)][hook(21, 7)] += regA_bak[hook(12, 7)] * regB_bak[hook(13, 7)];
      }
    }
