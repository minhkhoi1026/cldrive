...
kernel void kernel_biyuv(read_only image2d_t srcYUV, write_only image2d_t dstYUV, float sigma_r, unsigned int imw, unsigned int imh, unsigned int vertical_offset) {
