//{"fg_map_in":1,"fg_map_out":2,"height":4,"input":0,"thresh":3}
...
kernel void erode_fg_bg_tb(read_only image2d_t input, read_only image2d_t fg_map_in, write_only image2d_t fg_map_out, int thresh, int height) {
