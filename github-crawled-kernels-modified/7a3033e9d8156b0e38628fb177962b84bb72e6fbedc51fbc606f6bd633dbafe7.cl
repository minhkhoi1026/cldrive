...
kernel void kernel_memory_alignment_local(global unsigned int* results, local char* mem0, local char2* mem2, local char2* mem3, local char4* mem4, local char8* mem8, local char16* mem16) {
