...
kernel void matrixAxpyKernelModular1024SP(global float* D, global float* A, global float* B, global float* C, const int widthA, const int widthB, const float mod) {
