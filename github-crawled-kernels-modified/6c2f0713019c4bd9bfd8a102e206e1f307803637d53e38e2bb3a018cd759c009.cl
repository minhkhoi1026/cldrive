...
kernel void bitonicSortLocal(global float* d_DstKey, global unsigned int* d_DstVal, global float* d_SrcKey, global unsigned int* d_SrcVal, unsigned int arrayLength, unsigned int dir) {
