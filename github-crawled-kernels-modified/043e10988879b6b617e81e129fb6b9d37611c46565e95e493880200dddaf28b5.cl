//{"brightness":4,"d_output":0,"density":3,"imageH":2,"imageW":1,"invViewMatrix":7,"transferFunc":9,"transferFuncSampler":11,"transferOffset":5,"transferScale":6,"volume":8,"volumeSampler":10}
...
kernel void d_render(global unsigned int* d_output, unsigned int imageW, unsigned int imageH, float density, float brightness, float transferOffset, float transferScale, constant float* invViewMatrix, read_only image3d_t volume, read_only image2d_t transferFunc, sampler_t volumeSampler, sampler_t transferFuncSampler)
