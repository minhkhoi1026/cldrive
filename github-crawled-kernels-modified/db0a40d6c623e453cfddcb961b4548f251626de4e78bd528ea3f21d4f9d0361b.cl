...
__attribute__((reqd_work_group_size(16, 16, 1))) kernel void erode3_cached(global const uchar* source, global uchar* dest, int src_step, int dst_step, int width, int height) {
