...
kernel void matrixAxpyKernelModular1DP(global double* D, global double* A, global double* B, global double* C, const int widthA, const int widthB, const double mod) {
