...
kernel void entry(global ulong* result, global int* sequence_input) {
  ...
  transparent_crc_no_string(&crc64_context, p_3->g_2.s0);
  transparent_crc_no_string(&crc64_context, p_3->g_2.s1);
  transparent_crc_no_string(&crc64_context, p_3->g_2.s2);
  transparent_crc_no_string(&crc64_context, p_3->g_2.s3);
  transparent_crc_no_string(&crc64_context, p_3->g_2.s4);
  transparent_crc_no_string(&crc64_context, p_3->g_2.s5);
  transparent_crc_no_string(&crc64_context, p_3->g_2.s6);
  transparent_crc_no_string(&crc64_context, p_3->g_2.s7);
