...
ulong func_1(struct S1* p_5) {
  int8 l_2 = (int8)(0x6DEEC541L, (int4)(0x6DEEC541L, (int2)(0x6DEEC541L, 1L), 1L), 1L, 0x6DEEC541L, 1L);
  int* l_3 = &p_5->g_4;
  int i;
  (*l_3) &= ((int16)(l_2.s2076474220572276)).sb;
  return p_5->g_4;
}
