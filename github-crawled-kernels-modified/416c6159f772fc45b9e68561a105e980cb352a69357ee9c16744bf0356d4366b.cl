...
kernel void nlm3_thresh_short(read_only image3d_t input, global short* output, const int Nx, const int Ny, int FSIZE, int BSIZE, const float SIGMA, const float thresh) {
