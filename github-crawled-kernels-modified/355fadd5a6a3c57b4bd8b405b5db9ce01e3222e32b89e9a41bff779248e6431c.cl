...
kernel void laplace3(global const uchar* source, global uchar* dest, int src_step, int dst_step, int width, int height) {
  constant const float matrix[9] = {-1, -1, -1, -1, 8, -1, -1, -1, -1};
