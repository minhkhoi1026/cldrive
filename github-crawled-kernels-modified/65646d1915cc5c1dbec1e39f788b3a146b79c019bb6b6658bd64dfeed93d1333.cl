...
kernel void PRNG_threefry4x32_uint_uniform(global uint4* randomnumber, threefry4x32_ctr_t ctr_i, unsigned int inf, unsigned int sup, unsigned int nrounds, unsigned int numrandom) {
  ...
  if (gdx < numrandom) {
    ...
    uint4 frnd;
    frnd.x = random4.v[hook(11, 0)] % (sup - inf) + inf;
    frnd.y = random4.v[hook(11, 1)] % (sup - inf) + inf;
    frnd.z = random4.v[hook(11, 2)] % (sup - inf) + inf;
    frnd.w = random4.v[hook(11, 3)] % (sup - inf) + inf;
