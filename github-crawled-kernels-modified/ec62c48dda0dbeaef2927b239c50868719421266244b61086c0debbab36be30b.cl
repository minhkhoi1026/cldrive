...
kernel void compiler_workgroup_broadcast_2D_int(global int* src, global int* dst, unsigned int wg_local_x, unsigned int wg_local_y, unsigned int wg_local_z) {
  ...
  int broadcast_val = work_group_broadcast(val, wg_local_x, wg_local_y);
