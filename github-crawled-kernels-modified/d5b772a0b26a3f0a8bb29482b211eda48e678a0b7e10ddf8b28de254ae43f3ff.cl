//{"hiddenStates":0,"hiddenToVisible":6,"qBiases":2,"qStatesFront":4,"qStatesPrev":3,"qWeights":1,"radius":7,"reluLeak":8,"visibleSize":5}
...
kernel void qForward(read_only image2d_t hiddenStates, read_only image3d_t qWeights, read_only image2d_t qBiases, read_only image2d_t qStatesPrev, write_only image2d_t qStatesFront, int2 visibleSize, float2 hiddenToVisible, int radius, float reluLeak) {
