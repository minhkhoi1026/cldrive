...
kernel void mma_tranpose_BFn(int rowsA, int rowsB, int colsA, int colsB, int A_offset, int B_offset, global float* a, global float* b, global float* c, int offset) {
