//{"Avg":5,"buffer":6,"img_height":4,"img_width":3,"result":1,"source":0,"src_step":2}
...
__attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) kernel void reduce_stddev_flush(global const uchar* source, global float* result, int src_step, int img_width, int img_height, float4 Avg) {
  ...
  buffer[hook(6, lid)] = (Res / 16);
  barrier(0x01);
  if (lid < 128)
    buffer[hook(6, lid)] = ((buffer[hook(6, lid)] + buffer[hook(6, lid + 128)] * 1) / (1 + 1));
  barrier(0x01);
  if (lid < 64)
    buffer[hook(6, lid)] = ((buffer[hook(6, lid)] + buffer[hook(6, lid + 64)] * 1) / (1 + 1));
  barrier(0x01);
  if (lid < 32)
    buffer[hook(6, lid)] = ((buffer[hook(6, lid)] + buffer[hook(6, lid + 32)] * 1) / (1 + 1));
  barrier(0x01);
  if (lid < 16)
    buffer[hook(6, lid)] = ((buffer[hook(6, lid)] + buffer[hook(6, lid + 16)] * 1) / (1 + 1));
  barrier(0x01);
  if (lid < 8)
    buffer[hook(6, lid)] = ((buffer[hook(6, lid)] + buffer[hook(6, lid + 8)] * 1) / (1 + 1));
  barrier(0x01);
  if (lid < 4)
    buffer[hook(6, lid)] = ((buffer[hook(6, lid)] + buffer[hook(6, lid + 4)] * 1) / (1 + 1));
  barrier(0x01);
  if (lid < 2)
    buffer[hook(6, lid)] = ((buffer[hook(6, lid)] + buffer[hook(6, lid + 2)] * 1) / (1 + 1));
  barrier(0x01);
  if (lid == 0) {
    buffer[hook(6, lid)] = ((buffer[hook(6, lid)] + buffer[hook(6, lid + 1)] * 1) / (1 + 1));
    store_value(result, buffer[hook(6, 0)], 16 * 16 * 16);
  }
}