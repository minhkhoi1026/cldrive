...
kernel void test_block_6_2_kern(global float* a0, global float* a1, global float* a2, global float* a3, global float* a4, global float* a5, global float* b0, global float* b1, local float* c0, local float* c1, local float* c2, local float* c3, local float* c4, local float* c5) {
  int i;
