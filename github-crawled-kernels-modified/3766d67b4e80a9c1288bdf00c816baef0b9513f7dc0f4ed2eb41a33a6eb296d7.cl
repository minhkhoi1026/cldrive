...
__attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) kernel void reduce_mean_sqr(global const uchar* source, global float* result, int src_step, int img_width, int img_height) {
  ...
  if (lid < 128)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 128)]) {
      ...
      buffer[hook(5, lid)] = ((buffer[hook(5, lid)] + buffer[hook(5, lid + 128)] * Weight) / (1 + Weight));
  ...
  if (lid < 64)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 64)]) {
      ...
      buffer[hook(5, lid)] = ((buffer[hook(5, lid)] + buffer[hook(5, lid + 64)] * Weight) / (1 + Weight));
  ...
  if (lid < 32)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 32)]) {
      ...
      buffer[hook(5, lid)] = ((buffer[hook(5, lid)] + buffer[hook(5, lid + 32)] * Weight) / (1 + Weight));
  ...
  if (lid < 16)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 16)]) {
      ...
      buffer[hook(5, lid)] = ((buffer[hook(5, lid)] + buffer[hook(5, lid + 16)] * Weight) / (1 + Weight));
  ...
  if (lid < 8)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 8)]) {
      ...
      buffer[hook(5, lid)] = ((buffer[hook(5, lid)] + buffer[hook(5, lid + 8)] * Weight) / (1 + Weight));
  ...
  if (lid < 4)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 4)]) {
      ...
      buffer[hook(5, lid)] = ((buffer[hook(5, lid)] + buffer[hook(5, lid + 4)] * Weight) / (1 + Weight));
  ...
  if (lid < 2)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 2)]) {
      ...
      buffer[hook(5, lid)] = ((buffer[hook(5, lid)] + buffer[hook(5, lid + 2)] * Weight) / (1 + Weight));
  ...
  if (lid == 0) {
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 1)]) {
      ...
      buffer[hook(5, lid)] = ((buffer[hook(5, lid)] + buffer[hook(5, lid + 1)] * Weight) / (1 + Weight));
      nb_pixels[hook(6, lid)] += nb_pixels[hook(6, lid + 1)];
    };
    store_value(result, buffer[hook(5, 0)], nb_pixels[hook(6, 0)]);
  }
}