...
kernel void sharpen3(global const uchar* source, global uchar* dest, int src_step, int dst_step, int width, int height) {
  constant const float matrix[9] = {-1.f / 8, -1.f / 8, -1.f / 8, -1.f / 8, 16.f / 8, -1.f / 8, -1.f / 8, -1.f / 8, -1.f / 8};
