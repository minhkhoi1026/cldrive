//{"T->vertices":7,"array":5,"flip":6,"ids_behind":15,"mipmap_start":2,"num":21,"nums":3,"passback":20,"points":10,"pr":18,"raw":13,"ret":11,"ret[0]":16,"ret[1]":17,"rotated":14,"size":22,"sizes":4,"tex":0,"tex_id":1,"triangle->vertices":12,"tris":19,"x":8,"y":9}
...
kernel void update_gpu_tex(read_only image2d_t tex, unsigned int tex_id, unsigned int mipmap_start, global unsigned int* nums, global unsigned int* sizes, image_3d_write array, int flip) {
  ...
  int slice = nums[hook(3, tex_id)] >> 16;
