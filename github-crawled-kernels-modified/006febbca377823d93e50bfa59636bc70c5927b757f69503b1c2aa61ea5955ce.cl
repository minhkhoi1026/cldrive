...
kernel void tensor_multiply(const unsigned int tensorDimension, global unsigned char* input1, global unsigned char* input2, global unsigned char* output, const unsigned int a, const unsigned int b, const unsigned int c) {
