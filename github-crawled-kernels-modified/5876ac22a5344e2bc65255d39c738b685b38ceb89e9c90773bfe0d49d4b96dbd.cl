...
kernel void medianFilter3_C1_D5(global float* src, global float* dst, int srcOffset, int dstOffset, int cols, int rows, int srcStep, int dstStep) {
  local float data[18][18];
  ...
  float p0 = data[hook(9, y)][hook(12, x)], p1 = data[hook(9, y)][hook(12, x + 1)], p2 = data[hook(9, y)][hook(12, x + 2)];
  float p3 = data[hook(9, y + 1)][hook(13, x)], p4 = data[hook(9, y + 1)][hook(13, x + 1)], p5 = data[hook(9, y + 1)][hook(13, x + 2)];
  float p6 = data[hook(9, y + 2)][hook(14, x)], p7 = data[hook(9, y + 2)][hook(14, x + 1)], p8 = data[hook(9, y + 2)][hook(14, x + 2)];
  float mid;
