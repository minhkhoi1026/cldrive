//{"intBuff":2,"iterationsGlobal":0,"iterationsInternal":1}
...
kernel void fibonacciLoop(const int iterationsGlobal, const int iterationsInternal, global unsigned long* intBuff) {
  unsigned long r = 0;
  for (int i = 0; i < iterationsGlobal; i++) {
    r = fibonacci(iterationsInternal);
  }

  size_t gid = get_global_id(0);
  intBuff[hook(2, gid)] = r;
}