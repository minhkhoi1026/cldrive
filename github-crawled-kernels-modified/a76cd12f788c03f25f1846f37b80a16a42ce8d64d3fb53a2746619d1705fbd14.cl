//{"p_3->g_2":4,"p_3->g_2[2]":3,"p_3->g_2[2][2]":2,"p_3->g_2[i]":6,"p_3->g_2[i][j]":5,"result":0,"sequence_input":1}
...
uchar func_1(struct S3* p_3);
uchar func_1(struct S3* p_3) {
  return p_3->g_2[hook(4, 2)][hook(3, 2)][hook(2, 1)];
}
...
kernel void entry(global ulong* result, global int* sequence_input) {
  ...
  struct S3* p_3 = &c_4;
  struct S3 c_5 = {
      {{{7L, 7L, (-7L)}, {7L, 7L, (-7L)}, {7L, 7L, (-7L)}}, {{7L, 7L, (-7L)}, {7L, 7L, (-7L)}, {7L, 7L, (-7L)}}, {{7L, 7L, (-7L)}, {7L, 7L, (-7L)}, {7L, 7L, (-7L)}}}, sequence_input[hook(1, get_global_id(0))], sequence_input[hook(1, get_global_id(1))], sequence_input[hook(1, get_global_id(2))], sequence_input[hook(1, get_local_id(0))], sequence_input[hook(1, get_local_id(1))], sequence_input[hook(1, get_local_id(2))], sequence_input[hook(1, get_group_id(0))], sequence_input[hook(1, get_group_id(1))], sequence_input[hook(1, get_group_id(2))],
  };
  c_4 = c_5;
  barrier(0x01 | 0x02);
  func_1(p_3);
