...
kernel void Sgemm_ntransA_transB(unsigned int k, float alpha, global float* A, unsigned int lda, global float* B, unsigned int ldb, float beta, global float* C, unsigned int ldc) {
