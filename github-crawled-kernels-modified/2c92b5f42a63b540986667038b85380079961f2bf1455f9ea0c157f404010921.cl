...
kernel void createMandleBrot(float scale, float offsetx, float offsety, global int* rgb) {
  ...
  rgb[hook(3, get_global_id(0) + get_global_id(1) * get_global_size(0))] = pallette[hook(4, count)];
}