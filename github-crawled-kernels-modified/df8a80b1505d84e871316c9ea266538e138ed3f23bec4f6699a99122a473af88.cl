//{"errors":2,"hiddenSize":5,"hiddenStatesPrev":1,"hiddenToVisible":7,"radius":8,"reverseRadii":9,"targets":0,"visibleSize":4,"visibleToHidden":6,"weights":3}
...
kernel void predErrorPropagateSwarm(read_only image2d_t targets, read_only image2d_t hiddenStatesPrev, write_only image2d_t errors, read_only image3d_t weights, int2 visibleSize, int2 hiddenSize, float2 visibleToHidden, float2 hiddenToVisible, int radius, int2 reverseRadii) {
