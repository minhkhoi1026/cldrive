//{"hiddenSize":5,"hiddenStates":0,"hiddenToVisible":7,"radius":8,"reconError":2,"reverseRadii":9,"visibleSize":4,"visibleStates":1,"visibleToHidden":6,"weights":3}
...
kernel void spReverseEncode(read_only image2d_t hiddenStates, read_only image2d_t visibleStates, write_only image2d_t reconError, read_only image3d_t weights, int2 visibleSize, int2 hiddenSize, float2 visibleToHidden, float2 hiddenToVisible, int radius, int2 reverseRadii) {
