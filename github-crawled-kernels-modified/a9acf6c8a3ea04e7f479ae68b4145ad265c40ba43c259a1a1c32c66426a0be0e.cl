...
;
;
kernel void mmul_block(const unsigned int N, global const float* restrict A, global const float* restrict B, global float* restrict C, local float* restrict Awrk, local float* restrict Bwrk) {
  int kloc, Kblk;
  float Ctmp = 0.0f;
