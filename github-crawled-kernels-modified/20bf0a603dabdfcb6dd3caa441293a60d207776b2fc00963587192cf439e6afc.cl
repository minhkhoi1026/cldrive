...
__attribute__((reqd_work_group_size(512, 1, 1))) kernel void Slice_normal_512(const int nthreads, global const float* in_data, const int num_slices, const int slice_size, const int in_slice_axis_size, const int out_slice_axis_size, const int offset_slice_axis, global float* out_data) {
