//{"ablock":8,"ablock[0]":7,"ablock[1]":10,"ablock[2]":11,"ablock[3]":12,"ablock[4]":13,"avec":9,"bblock":17,"bblock[0]":16,"bblock[1]":19,"bblock[2]":21,"bblock[3]":23,"bblock[4]":25,"bvec":6,"c":33,"c[0]":32,"c[1]":34,"c[2]":35,"c[3]":36,"c[4]":37,"cblock":15,"cblock[0]":14,"cblock[1]":18,"cblock[2]":20,"cblock[3]":22,"cblock[4]":24,"fjac":44,"fjac[j + 1]":75,"fjac[j + 1][0]":74,"fjac[j + 1][1]":79,"fjac[j + 1][2]":82,"fjac[j + 1][3]":85,"fjac[j + 1][4]":88,"fjac[j - 1]":43,"fjac[j - 1][0]":42,"fjac[j - 1][1]":49,"fjac[j - 1][2]":52,"fjac[j - 1][3]":55,"fjac[j - 1][4]":58,"g_fjac":0,"g_lhs":2,"g_njac":1,"gp0":3,"gp1":4,"gp2":5,"lhs":27,"lhs[0]":26,"lhs[1]":28,"lhs[2]":29,"lhs[3]":30,"lhs[4]":31,"lhs[j]":41,"lhs[j][0]":40,"lhs[j][0][0]":39,"lhs[j][0][1]":48,"lhs[j][0][2]":51,"lhs[j][0][3]":54,"lhs[j][0][4]":57,"lhs[j][1]":61,"lhs[j][1][0]":60,"lhs[j][1][1]":64,"lhs[j][1][2]":66,"lhs[j][1][3]":68,"lhs[j][1][4]":70,"lhs[j][2]":73,"lhs[j][2][0]":72,"lhs[j][2][1]":78,"lhs[j][2][2]":81,"lhs[j][2][3]":84,"lhs[j][2][4]":87,"njac":47,"njac[j + 1]":77,"njac[j + 1][0]":76,"njac[j + 1][1]":80,"njac[j + 1][2]":83,"njac[j + 1][3]":86,"njac[j + 1][4]":89,"njac[j - 1]":46,"njac[j - 1][0]":45,"njac[j - 1][1]":50,"njac[j - 1][2]":53,"njac[j - 1][3]":56,"njac[j - 1][4]":59,"njac[j]":63,"njac[j][0]":62,"njac[j][1]":65,"njac[j][2]":67,"njac[j][3]":69,"njac[j][4]":71,"r":38}
...
kernel void y_solve3(global double* g_fjac, global double* g_njac, global double* g_lhs, int gp0, int gp1, int gp2) {
  ...
  lhs[hook(27, j)][hook(41, 0)][hook(40, 0)][hook(39, 0)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 0)][hook(42, 0)] - tmp1 * njac[hook(47, j - 1)][hook(46, 0)][hook(45, 0)] - tmp1 * 0.75;
  lhs[hook(27, j)][hook(41, 0)][hook(40, 1)][hook(48, 0)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 1)][hook(49, 0)] - tmp1 * njac[hook(47, j - 1)][hook(46, 1)][hook(50, 0)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 2)][hook(51, 0)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 2)][hook(52, 0)] - tmp1 * njac[hook(47, j - 1)][hook(46, 2)][hook(53, 0)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 3)][hook(54, 0)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 3)][hook(55, 0)] - tmp1 * njac[hook(47, j - 1)][hook(46, 3)][hook(56, 0)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 4)][hook(57, 0)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 4)][hook(58, 0)] - tmp1 * njac[hook(47, j - 1)][hook(46, 4)][hook(59, 0)];

  lhs[hook(27, j)][hook(41, 0)][hook(40, 0)][hook(39, 1)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 0)][hook(42, 1)] - tmp1 * njac[hook(47, j - 1)][hook(46, 0)][hook(45, 1)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 1)][hook(48, 1)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 1)][hook(49, 1)] - tmp1 * njac[hook(47, j - 1)][hook(46, 1)][hook(50, 1)] - tmp1 * 0.75;
  lhs[hook(27, j)][hook(41, 0)][hook(40, 2)][hook(51, 1)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 2)][hook(52, 1)] - tmp1 * njac[hook(47, j - 1)][hook(46, 2)][hook(53, 1)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 3)][hook(54, 1)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 3)][hook(55, 1)] - tmp1 * njac[hook(47, j - 1)][hook(46, 3)][hook(56, 1)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 4)][hook(57, 1)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 4)][hook(58, 1)] - tmp1 * njac[hook(47, j - 1)][hook(46, 4)][hook(59, 1)];

  lhs[hook(27, j)][hook(41, 0)][hook(40, 0)][hook(39, 2)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 0)][hook(42, 2)] - tmp1 * njac[hook(47, j - 1)][hook(46, 0)][hook(45, 2)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 1)][hook(48, 2)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 1)][hook(49, 2)] - tmp1 * njac[hook(47, j - 1)][hook(46, 1)][hook(50, 2)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 2)][hook(51, 2)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 2)][hook(52, 2)] - tmp1 * njac[hook(47, j - 1)][hook(46, 2)][hook(53, 2)] - tmp1 * 0.75;
  lhs[hook(27, j)][hook(41, 0)][hook(40, 3)][hook(54, 2)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 3)][hook(55, 2)] - tmp1 * njac[hook(47, j - 1)][hook(46, 3)][hook(56, 2)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 4)][hook(57, 2)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 4)][hook(58, 2)] - tmp1 * njac[hook(47, j - 1)][hook(46, 4)][hook(59, 2)];

  lhs[hook(27, j)][hook(41, 0)][hook(40, 0)][hook(39, 3)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 0)][hook(42, 3)] - tmp1 * njac[hook(47, j - 1)][hook(46, 0)][hook(45, 3)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 1)][hook(48, 3)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 1)][hook(49, 3)] - tmp1 * njac[hook(47, j - 1)][hook(46, 1)][hook(50, 3)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 2)][hook(51, 3)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 2)][hook(52, 3)] - tmp1 * njac[hook(47, j - 1)][hook(46, 2)][hook(53, 3)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 3)][hook(54, 3)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 3)][hook(55, 3)] - tmp1 * njac[hook(47, j - 1)][hook(46, 3)][hook(56, 3)] - tmp1 * 0.75;
  lhs[hook(27, j)][hook(41, 0)][hook(40, 4)][hook(57, 3)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 4)][hook(58, 3)] - tmp1 * njac[hook(47, j - 1)][hook(46, 4)][hook(59, 3)];

  lhs[hook(27, j)][hook(41, 0)][hook(40, 0)][hook(39, 4)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 0)][hook(42, 4)] - tmp1 * njac[hook(47, j - 1)][hook(46, 0)][hook(45, 4)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 1)][hook(48, 4)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 1)][hook(49, 4)] - tmp1 * njac[hook(47, j - 1)][hook(46, 1)][hook(50, 4)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 2)][hook(51, 4)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 2)][hook(52, 4)] - tmp1 * njac[hook(47, j - 1)][hook(46, 2)][hook(53, 4)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 3)][hook(54, 4)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 3)][hook(55, 4)] - tmp1 * njac[hook(47, j - 1)][hook(46, 3)][hook(56, 4)];
  lhs[hook(27, j)][hook(41, 0)][hook(40, 4)][hook(57, 4)] = -tmp2 * fjac[hook(44, j - 1)][hook(43, 4)][hook(58, 4)] - tmp1 * njac[hook(47, j - 1)][hook(46, 4)][hook(59, 4)] - tmp1 * 0.75;

  lhs[hook(27, j)][hook(41, 1)][hook(61, 0)][hook(60, 0)] = 1.0 + tmp1 * 2.0 * njac[hook(47, j)][hook(63, 0)][hook(62, 0)] + tmp1 * 2.0 * 0.75;
  lhs[hook(27, j)][hook(41, 1)][hook(61, 1)][hook(64, 0)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 1)][hook(65, 0)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 2)][hook(66, 0)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 2)][hook(67, 0)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 3)][hook(68, 0)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 3)][hook(69, 0)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 4)][hook(70, 0)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 4)][hook(71, 0)];

  lhs[hook(27, j)][hook(41, 1)][hook(61, 0)][hook(60, 1)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 0)][hook(62, 1)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 1)][hook(64, 1)] = 1.0 + tmp1 * 2.0 * njac[hook(47, j)][hook(63, 1)][hook(65, 1)] + tmp1 * 2.0 * 0.75;
  lhs[hook(27, j)][hook(41, 1)][hook(61, 2)][hook(66, 1)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 2)][hook(67, 1)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 3)][hook(68, 1)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 3)][hook(69, 1)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 4)][hook(70, 1)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 4)][hook(71, 1)];

  lhs[hook(27, j)][hook(41, 1)][hook(61, 0)][hook(60, 2)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 0)][hook(62, 2)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 1)][hook(64, 2)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 1)][hook(65, 2)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 2)][hook(66, 2)] = 1.0 + tmp1 * 2.0 * njac[hook(47, j)][hook(63, 2)][hook(67, 2)] + tmp1 * 2.0 * 0.75;
  lhs[hook(27, j)][hook(41, 1)][hook(61, 3)][hook(68, 2)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 3)][hook(69, 2)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 4)][hook(70, 2)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 4)][hook(71, 2)];

  lhs[hook(27, j)][hook(41, 1)][hook(61, 0)][hook(60, 3)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 0)][hook(62, 3)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 1)][hook(64, 3)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 1)][hook(65, 3)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 2)][hook(66, 3)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 2)][hook(67, 3)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 3)][hook(68, 3)] = 1.0 + tmp1 * 2.0 * njac[hook(47, j)][hook(63, 3)][hook(69, 3)] + tmp1 * 2.0 * 0.75;
  lhs[hook(27, j)][hook(41, 1)][hook(61, 4)][hook(70, 3)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 4)][hook(71, 3)];

  lhs[hook(27, j)][hook(41, 1)][hook(61, 0)][hook(60, 4)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 0)][hook(62, 4)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 1)][hook(64, 4)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 1)][hook(65, 4)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 2)][hook(66, 4)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 2)][hook(67, 4)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 3)][hook(68, 4)] = tmp1 * 2.0 * njac[hook(47, j)][hook(63, 3)][hook(69, 4)];
  lhs[hook(27, j)][hook(41, 1)][hook(61, 4)][hook(70, 4)] = 1.0 + tmp1 * 2.0 * njac[hook(47, j)][hook(63, 4)][hook(71, 4)] + tmp1 * 2.0 * 0.75;

  lhs[hook(27, j)][hook(41, 2)][hook(73, 0)][hook(72, 0)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 0)][hook(74, 0)] - tmp1 * njac[hook(47, j + 1)][hook(77, 0)][hook(76, 0)] - tmp1 * 0.75;
  lhs[hook(27, j)][hook(41, 2)][hook(73, 1)][hook(78, 0)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 1)][hook(79, 0)] - tmp1 * njac[hook(47, j + 1)][hook(77, 1)][hook(80, 0)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 2)][hook(81, 0)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 2)][hook(82, 0)] - tmp1 * njac[hook(47, j + 1)][hook(77, 2)][hook(83, 0)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 3)][hook(84, 0)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 3)][hook(85, 0)] - tmp1 * njac[hook(47, j + 1)][hook(77, 3)][hook(86, 0)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 4)][hook(87, 0)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 4)][hook(88, 0)] - tmp1 * njac[hook(47, j + 1)][hook(77, 4)][hook(89, 0)];

  lhs[hook(27, j)][hook(41, 2)][hook(73, 0)][hook(72, 1)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 0)][hook(74, 1)] - tmp1 * njac[hook(47, j + 1)][hook(77, 0)][hook(76, 1)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 1)][hook(78, 1)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 1)][hook(79, 1)] - tmp1 * njac[hook(47, j + 1)][hook(77, 1)][hook(80, 1)] - tmp1 * 0.75;
  lhs[hook(27, j)][hook(41, 2)][hook(73, 2)][hook(81, 1)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 2)][hook(82, 1)] - tmp1 * njac[hook(47, j + 1)][hook(77, 2)][hook(83, 1)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 3)][hook(84, 1)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 3)][hook(85, 1)] - tmp1 * njac[hook(47, j + 1)][hook(77, 3)][hook(86, 1)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 4)][hook(87, 1)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 4)][hook(88, 1)] - tmp1 * njac[hook(47, j + 1)][hook(77, 4)][hook(89, 1)];

  lhs[hook(27, j)][hook(41, 2)][hook(73, 0)][hook(72, 2)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 0)][hook(74, 2)] - tmp1 * njac[hook(47, j + 1)][hook(77, 0)][hook(76, 2)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 1)][hook(78, 2)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 1)][hook(79, 2)] - tmp1 * njac[hook(47, j + 1)][hook(77, 1)][hook(80, 2)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 2)][hook(81, 2)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 2)][hook(82, 2)] - tmp1 * njac[hook(47, j + 1)][hook(77, 2)][hook(83, 2)] - tmp1 * 0.75;
  lhs[hook(27, j)][hook(41, 2)][hook(73, 3)][hook(84, 2)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 3)][hook(85, 2)] - tmp1 * njac[hook(47, j + 1)][hook(77, 3)][hook(86, 2)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 4)][hook(87, 2)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 4)][hook(88, 2)] - tmp1 * njac[hook(47, j + 1)][hook(77, 4)][hook(89, 2)];

  lhs[hook(27, j)][hook(41, 2)][hook(73, 0)][hook(72, 3)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 0)][hook(74, 3)] - tmp1 * njac[hook(47, j + 1)][hook(77, 0)][hook(76, 3)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 1)][hook(78, 3)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 1)][hook(79, 3)] - tmp1 * njac[hook(47, j + 1)][hook(77, 1)][hook(80, 3)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 2)][hook(81, 3)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 2)][hook(82, 3)] - tmp1 * njac[hook(47, j + 1)][hook(77, 2)][hook(83, 3)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 3)][hook(84, 3)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 3)][hook(85, 3)] - tmp1 * njac[hook(47, j + 1)][hook(77, 3)][hook(86, 3)] - tmp1 * 0.75;
  lhs[hook(27, j)][hook(41, 2)][hook(73, 4)][hook(87, 3)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 4)][hook(88, 3)] - tmp1 * njac[hook(47, j + 1)][hook(77, 4)][hook(89, 3)];

  lhs[hook(27, j)][hook(41, 2)][hook(73, 0)][hook(72, 4)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 0)][hook(74, 4)] - tmp1 * njac[hook(47, j + 1)][hook(77, 0)][hook(76, 4)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 1)][hook(78, 4)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 1)][hook(79, 4)] - tmp1 * njac[hook(47, j + 1)][hook(77, 1)][hook(80, 4)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 2)][hook(81, 4)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 2)][hook(82, 4)] - tmp1 * njac[hook(47, j + 1)][hook(77, 2)][hook(83, 4)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 3)][hook(84, 4)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 3)][hook(85, 4)] - tmp1 * njac[hook(47, j + 1)][hook(77, 3)][hook(86, 4)];
  lhs[hook(27, j)][hook(41, 2)][hook(73, 4)][hook(87, 4)] = tmp2 * fjac[hook(44, j + 1)][hook(75, 4)][hook(88, 4)] - tmp1 * njac[hook(47, j + 1)][hook(77, 4)][hook(89, 4)] - tmp1 * 0.75;
}