...
kernel void matrixMuladdKernelModular1024DP(global double* D, double alpha, global double* A, global double* B, double beta, global double* C, const int widthA, const int widthB, const double mod) {
