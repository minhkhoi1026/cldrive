...
kernel void gemm_f_naive(private int inputA_nrow, private int inputA_ncol, private int inputB_nrow, private int inputB_ncol, private float alpha, private float beta, global float* inputAT, global float* inputB, global float* output) {
