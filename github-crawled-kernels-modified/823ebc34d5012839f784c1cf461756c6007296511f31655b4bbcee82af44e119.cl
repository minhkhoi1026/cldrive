//{"convolution_real":0,"nX":2,"nY":3,"nZ":4,"sumFootprintAMPA":1}
...
kernel void postConvolution_AMPA(global const float* convolution_real, global float* sumFootprintAMPA, const unsigned int nX, const unsigned int nY, const unsigned int nZ) {
  ...
  sumFootprintAMPA[hook(1, index_fp)] = convolution_real[hook(0, index_conv)];
}