...
kernel void arithm_flip_cols(global T* src, int src_step, int src_offset, global T* dst, int dst_step, int dst_offset, int rows, int cols, int thread_rows, int thread_cols) {
