//{"csize":4,"h":1,"index":3,"nh":5,"ny":6,"x":0,"y":2}
...
kernel void ocl_DSPF_sp_fircirc(global const float* x, global float* h, global float* restrict y, int index, int csize, int nh, int ny) {
