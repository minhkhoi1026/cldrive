...
kernel void gemm_f_dot4sum4x2(private int inputA_nrow, private int inputA_ncol, private int inputB_nrow, private int inputB_ncol, private float alpha, private float beta, global float4* inputAT, global float4* inputB, global float* output) {
