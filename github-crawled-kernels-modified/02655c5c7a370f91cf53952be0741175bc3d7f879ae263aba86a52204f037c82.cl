...
kernel void RescaleVolumeNearest(global float* Volume, read_only image3d_t Original_Volume, private float VOXEL_DIFFERENCE_X, private float VOXEL_DIFFERENCE_Y, private float VOXEL_DIFFERENCE_Z, private int DATA_W, private int DATA_H, private int DATA_D) {
