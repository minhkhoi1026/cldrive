...
kernel void arithm_bitwise_not_D0(global uchar* src1, int src1_step, int src1_offset, global uchar* dst, int dst_step, int dst_offset, int rows, int cols, int dst_step1) {
