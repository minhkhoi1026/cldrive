...
kernel void merge_vector_C3_D0(global uchar* mat_dst, int dst_step, int dst_offset, global uchar* mat_src0, int src0_step, int src0_offset, global uchar* mat_src1, int src1_step, int src1_offset, global uchar* mat_src2, int src2_step, int src2_offset, int offset_cols, int rows, int cols, int dst_step1) {
  ...
  if ((x < cols) && (y < rows)) {
    ...
    uchar4 dst_data0 = *((global uchar4*)(mat_dst + dst_index + 0));
    uchar4 dst_data1 = *((global uchar4*)(mat_dst + dst_index + 4));
    uchar4 dst_data2 = *((global uchar4*)(mat_dst + dst_index + 8));
    ...
    *((global uchar4*)(mat_dst + dst_index + 0)) = tmp_data0;
    *((global uchar4*)(mat_dst + dst_index + 4)) = tmp_data1;
    *((global uchar4*)(mat_dst + dst_index + 8)) = tmp_data2;
  }
}