...
kernel void compute_rhs3(global const double* g_u, global const double* g_us, global const double* g_vs, global const double* g_ws, global const double* g_qs, global const double* g_rho_i, global const double* g_square, global double* g_rhs, int gp0, int gp1, int gp2) {
  ...
  i = gp0 - 2;
  for (m = 0; m < 5; m++) {
    rhs[hook(17, k)][hook(16, j)][hook(15, i)][hook(14, m)] = rhs[hook(17, k)][hook(16, j)][hook(15, i)][hook(14, m)] - (0.25 * ((0.75) > (((0.75) > (1.0) ? (0.75) : (1.0))) ? (0.75) : (((0.75) > (1.0) ? (0.75) : (1.0))))) * (u[hook(21, k)][hook(20, j)][hook(19, i - 2)][hook(40, m)] - 4. * u[hook(21, k)][hook(20, j)][hook(19, i - 1)][hook(23, m)] + 5. * u[hook(21, k)][hook(20, j)][hook(19, i)][hook(22, m)]);
  }
}