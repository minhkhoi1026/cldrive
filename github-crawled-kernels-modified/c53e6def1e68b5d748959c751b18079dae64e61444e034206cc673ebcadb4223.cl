//{"p_3->g_2":3,"p_3->g_2[0]":2,"p_3->g_2[i]":4,"result":0,"sequence_input":1}
...
unsigned int func_1(struct S1* p_3) {
  return p_3->g_2[hook(3, 0)][hook(2, 3)];
}
...
kernel void entry(global ulong* result, global int* sequence_input) {
  ...
  struct S1* p_3 = &c_4;
  struct S1 c_5 = {
      {{254UL, 1UL, 0xDDL, 0x22L, 1UL, 0x22L}, {254UL, 1UL, 0xDDL, 0x22L, 1UL, 0x22L}, {254UL, 1UL, 0xDDL, 0x22L, 1UL, 0x22L}}, sequence_input[hook(1, get_global_id(0))], sequence_input[hook(1, get_global_id(1))], sequence_input[hook(1, get_global_id(2))], sequence_input[hook(1, get_local_id(0))], sequence_input[hook(1, get_local_id(1))], sequence_input[hook(1, get_local_id(2))], sequence_input[hook(1, get_group_id(0))], sequence_input[hook(1, get_group_id(1))], sequence_input[hook(1, get_group_id(2))],
  };
  c_4 = c_5;
  barrier(0x01 | 0x02);
  func_1(p_3);
  ...
  for (i = 0; i < 3; i++) {
    for (j = 0; j < 6; j++) {
      transparent_crc_no_string(&crc64_context, p_3->g_2[hook(3, i)][hook(4, j)]);
    }
  }
