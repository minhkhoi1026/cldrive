//{"ballPosX":2,"ballRad":3,"ballVelX":5,"maxTime":1,"result":6,"time":0,"width":4}
...
kernel void is_terminal_state(global const int* time, global const int* maxTime, global const float* ballPosX, global const int* ballRad, global const int* width, global const float* ballVelX, global int* result) {
