//{"gain":4,"inputFrame":0,"inputFrame0":1,"outputFrame":2,"thr_C":6,"thr_Y":5,"vertical_offset":3}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void kernel_tnr_yuv(read_only image2d_t inputFrame, read_only image2d_t inputFrame0, write_only image2d_t outputFrame, unsigned int vertical_offset, float gain, float thr_Y, float thr_C) {
