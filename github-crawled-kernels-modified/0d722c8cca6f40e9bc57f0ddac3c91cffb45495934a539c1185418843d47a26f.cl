//{"g_atomic_input":1,"g_special_values":2,"p_3->g_2":4,"result":0,"sequence_input":3}
...
kernel void entry(global ulong* result, global volatile unsigned int* g_atomic_input, global volatile unsigned int* g_special_values, global int* sequence_input) {
  ...
  struct S0* p_3 = &c_4;
  struct S0 c_5 = {
      {0x48F69F7FD1E814B7L, (-2L), 0x48F69F7FD1E814B7L, 0x48F69F7FD1E814B7L, (-2L), 0x48F69F7FD1E814B7L, 0x48F69F7FD1E814B7L, (-2L)}, sequence_input[hook(3, get_global_id(0))], sequence_input[hook(3, get_global_id(1))], sequence_input[hook(3, get_global_id(2))], sequence_input[hook(3, get_local_id(0))], sequence_input[hook(3, get_local_id(1))], sequence_input[hook(3, get_local_id(2))], sequence_input[hook(3, get_group_id(0))], sequence_input[hook(3, get_group_id(1))], sequence_input[hook(3, get_group_id(2))],
  };
  c_4 = c_5;
  barrier(0x01 | 0x02);
  func_1(p_3);
  ...
  for (i = 0; i < 8; i++) {
    transparent_crc_no_string(&crc64_context, p_3->g_2[hook(4, i)]);
  }
