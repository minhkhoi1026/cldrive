...
kernel void CalculateAMatrixAndHVector2DValuesX(global float* A_matrix_2D_values, global float* h_vector_2D_values, global const float* Phase_Differences, global const float* Phase_Gradients, global const float* Phase_Certainties, private int DATA_W, private int DATA_H, private int DATA_D, private int FILTER_SIZE) {
