...
unsigned int func_1(struct S3* p_9);
unsigned int func_1(struct S3* p_9) {
  ulong l_2[6];
  int* l_5[8] = {&p_9->g_4, &p_9->g_4, &p_9->g_4, &p_9->g_4, &p_9->g_4, &p_9->g_4, &p_9->g_4, &p_9->g_4};
  ushort l_6 = 7UL;
  int i;
  for (i = 0; i < 6; i++)
    l_2[hook(2, i)] = 1UL;
  (*p_9->g_3) = l_2[hook(2, 0)];
  l_6++;
  return p_9->g_4;
}
