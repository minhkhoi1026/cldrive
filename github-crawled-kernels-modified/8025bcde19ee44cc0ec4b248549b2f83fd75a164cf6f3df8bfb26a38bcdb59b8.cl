//{"actions":0,"actionsExploratory":1,"expBreak":3,"expPert":2,"seed":4}
...
kernel void phExploration(read_only image2d_t actions, write_only image2d_t actionsExploratory, float expPert, float expBreak, uint2 seed) {
