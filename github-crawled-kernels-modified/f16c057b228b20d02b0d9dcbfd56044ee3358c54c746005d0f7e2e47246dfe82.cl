...
kernel void filter(const unsigned int width, const int pixelPitch, global const unsigned char* gs, global unsigned char* rgb) {
  ...
  int hx = (int)(
      ...
      - gs[hook(2, row1 + x + 0)] * 2 + gs[hook(2, row1 + x + 2)] * 2

      - gs[hook(2, row2 + x + 0)] + gs[hook(2, row2 + x + 2)]);

  int hy = (int)(

      -gs[hook(2, row0 + x + 0)] - gs[hook(2, row0 + x + 1)] * 2 - gs[hook(2, row0 + x + 2)]

      + gs[hook(2, row2 + x + 0)] + gs[hook(2, row2 + x + 1)] * 2 + gs[hook(2, row2 + x + 2)]);
