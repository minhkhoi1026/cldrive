//{"actualOutput":3,"layerSize":0,"n":6,"out":4,"patTypes":1,"shared":5,"targets":2}
...
kernel void spol_computeSseFn(int layerSize, global char* patTypes, global float* targets, global float* actualOutput, global float* out, local float* shared, int n) {
