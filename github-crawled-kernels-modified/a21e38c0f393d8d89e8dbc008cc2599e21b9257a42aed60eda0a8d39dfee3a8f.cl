//{"T->vertices":6,"array":5,"col":0,"ids_behind":14,"mipmap_start":2,"num":20,"nums":3,"passback":19,"points":9,"pr":17,"raw":12,"ret":10,"ret[0]":15,"ret[1]":16,"rotated":13,"size":21,"sizes":4,"tex_id":1,"triangle->vertices":11,"tris":18,"x":7,"y":8}
...
kernel void update_gpu_tex_colour(float4 col, unsigned int tex_id, unsigned int mipmap_start, global unsigned int* nums, global unsigned int* sizes, image_3d_write array) {
  ...
  for (int i = 0; i < 4; i++) {
    int mtexid = tex_id * 4 + mipmap_start + i;
