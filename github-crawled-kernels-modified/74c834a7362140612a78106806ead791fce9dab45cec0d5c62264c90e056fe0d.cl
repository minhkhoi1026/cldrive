//{"global_size_dim0":0,"global_size_dim1":1,"height_width_size":6,"ic_h_w_size":5,"input_ptr":2,"kernel_wh":4,"output":7,"output_channel":3}
...
kernel void Conv2DFilterBufferToImage(private const int global_size_dim0, private const int global_size_dim1, global const float* input_ptr, private const int output_channel, private const int2 kernel_wh, private const int ic_h_w_size, private const int height_width_size, write_only image2d_t output) {
