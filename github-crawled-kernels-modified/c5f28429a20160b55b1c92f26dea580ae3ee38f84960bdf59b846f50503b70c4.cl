...
__attribute__((reqd_work_group_size(256, 1, 1))) kernel void Ssymv_opt_locgr_1_big_upper(unsigned int n, float alpha, global float* A, unsigned int lda, global float* x, int incx, float beta, global float* y, int incy) {
