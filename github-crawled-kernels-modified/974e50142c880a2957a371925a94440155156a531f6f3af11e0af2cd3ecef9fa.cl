...
kernel void toLabelImage2ClassesConf(const global float* gInput, global float* outputArr, float class0offset, float class1offset) {
  ...
  outputArr[hook(1, index)] = prob1 / (prob1 + prob0);
}