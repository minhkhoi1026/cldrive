...
inline int ID(int x, int y, int width) {
...
kernel void compiler_mandelbrot(global char* out) {
  ...
  if (iteration == max_iteration) {
    ...
    out[hook(0, idx + 1)] = 0;
    out[hook(0, idx + 2)] = 0;
    out[hook(0, idx + 3)] = 255;
  } else {
    out[hook(0, idx)] = iteration;
    out[hook(0, idx + 1)] = iteration;
    out[hook(0, idx + 2)] = iteration;
    out[hook(0, idx + 3)] = 255;
  }
}