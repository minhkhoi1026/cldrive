//{"g_atomic_reduction":1,"l_2":4,"l_2[p_6->g_3]":3,"l_atomic_reduction":5,"result":0,"sequence_input":2}
...
long func_1(struct S1* p_6) {
  uchar l_2[6][9] = {{0x5DL, 246UL, 0xA6L, 0xB7L, 246UL, 0xB7L, 0xA6L, 246UL, 0x5DL}, {0x5DL, 246UL, 0xA6L, 0xB7L, 246UL, 0xB7L, 0xA6L, 246UL, 0x5DL}, {0x5DL, 246UL, 0xA6L, 0xB7L, 246UL, 0xB7L, 0xA6L, 246UL, 0x5DL}, {0x5DL, 246UL, 0xA6L, 0xB7L, 246UL, 0xB7L, 0xA6L, 246UL, 0x5DL}, {0x5DL, 246UL, 0xA6L, 0xB7L, 246UL, 0xB7L, 0xA6L, 246UL, 0x5DL}, {0x5DL, 246UL, 0xA6L, 0xB7L, 246UL, 0xB7L, 0xA6L, 246UL, 0x5DL}};
  int* l_5[5][10] = {{&p_6->g_3, &p_6->g_4, (void*)0, &p_6->g_3, &p_6->g_4, &p_6->g_3, (void*)0, &p_6->g_4, &p_6->g_3, (void*)0}, {&p_6->g_3, &p_6->g_4, (void*)0, &p_6->g_3, &p_6->g_4, &p_6->g_3, (void*)0, &p_6->g_4, &p_6->g_3, (void*)0}, {&p_6->g_3, &p_6->g_4, (void*)0, &p_6->g_3, &p_6->g_4, &p_6->g_3, (void*)0, &p_6->g_4, &p_6->g_3, (void*)0}, {&p_6->g_3, &p_6->g_4, (void*)0, &p_6->g_3, &p_6->g_4, &p_6->g_3, (void*)0, &p_6->g_4, &p_6->g_3, (void*)0}, {&p_6->g_3, &p_6->g_4, (void*)0, &p_6->g_3, &p_6->g_4, &p_6->g_3, (void*)0, &p_6->g_4, &p_6->g_3, (void*)0}};
  int i, j;
  for (p_6->g_3 = 0; p_6->g_3 < 6; p_6->g_3 += 1) {
    for (p_6->g_4 = 0; p_6->g_4 < 9; p_6->g_4 += 1) {
      l_2[hook(4, p_6->g_3)][hook(3, p_6->g_4)] = 251UL;
    }
  }
  p_6->g_4 = p_6->g_4;
  return p_6->g_4;
...
kernel void entry(global ulong* result, global volatile int* g_atomic_reduction, global int* sequence_input) {
  ...
  transparent_crc_no_string(&crc64_context, p_6->g_3);
  transparent_crc_no_string(&crc64_context, p_6->g_4);
