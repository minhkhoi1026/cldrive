//{"inputsLeft":0,"inputsRight":1,"minAttention":3,"states":2}
...
kernel void phModulate(read_only image2d_t inputsLeft, read_only image2d_t inputsRight, write_only image2d_t states, float minAttention) {
