//{"p_3->g_2":4,"p_3->g_2[2]":3,"p_3->g_2[2][6]":2,"p_3->g_2[i]":6,"p_3->g_2[i][j]":5,"result":0,"sequence_input":1}
...
unsigned int func_1(struct S3* p_3) {
  return p_3->g_2[hook(4, 2)][hook(3, 6)][hook(2, 4)];
}
