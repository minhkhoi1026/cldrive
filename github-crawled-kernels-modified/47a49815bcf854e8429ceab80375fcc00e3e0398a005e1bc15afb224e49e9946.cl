//{"l_2":4,"l_2[7]":3,"l_2[7][0]":2,"result":0,"sequence_input":1}
...
unsigned int func_1(struct S1* p_3) {
  ushort l_2[9][1][4] = {{{0UL, 0UL, 0UL, 0UL}}, {{0UL, 0UL, 0UL, 0UL}}, {{0UL, 0UL, 0UL, 0UL}}, {{0UL, 0UL, 0UL, 0UL}}, {{0UL, 0UL, 0UL, 0UL}}, {{0UL, 0UL, 0UL, 0UL}}, {{0UL, 0UL, 0UL, 0UL}}, {{0UL, 0UL, 0UL, 0UL}}, {{0UL, 0UL, 0UL, 0UL}}};
  int i, j, k;
  return l_2[hook(4, 7)][hook(3, 0)][hook(2, 3)];
}
