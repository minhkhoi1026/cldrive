...
kernel void kernel_demosaic(read_only image2d_t input, write_only image2d_t output) {
  ...
  int y0 = y - 1;
  float4 p[16];
  p[hook(2, 0)] = read_imagef(input, sampler, (int2)(x0, y0));
  p[hook(2, 1)] = read_imagef(input, sampler, (int2)(x0 + 1, y0));
  p[hook(2, 2)] = read_imagef(input, sampler, (int2)(x0 + 2, y0));
  p[hook(2, 3)] = read_imagef(input, sampler, (int2)(x0 + 3, y0));
  p[hook(2, 4)] = read_imagef(input, sampler, (int2)(x0, y0 + 1));
  p[hook(2, 5)] = read_imagef(input, sampler, (int2)(x0 + 1, y0 + 1));
  p[hook(2, 6)] = read_imagef(input, sampler, (int2)(x0 + 2, y0 + 1));
  p[hook(2, 7)] = read_imagef(input, sampler, (int2)(x0 + 3, y0 + 1));
  p[hook(2, 8)] = read_imagef(input, sampler, (int2)(x0, y0 + 2));
  p[hook(2, 9)] = read_imagef(input, sampler, (int2)(x0 + 1, y0 + 2));
  p[hook(2, 10)] = read_imagef(input, sampler, (int2)(x0 + 2, y0 + 2));
  p[hook(2, 11)] = read_imagef(input, sampler, (int2)(x0 + 3, y0 + 2));
  p[hook(2, 12)] = read_imagef(input, sampler, (int2)(x0, y0 + 3));
  p[hook(2, 13)] = read_imagef(input, sampler, (int2)(x0 + 1, y0 + 3));
  p[hook(2, 14)] = read_imagef(input, sampler, (int2)(x0 + 2, y0 + 3));
  p[hook(2, 15)] = read_imagef(input, sampler, (int2)(x0 + 3, y0 + 3));
