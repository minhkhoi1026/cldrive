...
kernel void img_compare_GQ(global const uchar* source1, global const uchar* source2, global uchar* dest, int src1_step, int src2_step, int dst_step, int width) {
  ...
  *(global uchar8*)(dest + gx * 8) = convert_uchar8_sat((((src1 >= src2 ? ((uchar8)(255)) : ((uchar8)(0))))));
}