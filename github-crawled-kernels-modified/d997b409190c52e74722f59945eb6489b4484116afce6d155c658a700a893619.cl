...
kernel void ocl_DSPF_sp_iir(global float* restrict y1, global const float* x, global float* restrict y2, global const float* hb, global const float* ha, int nr) {
