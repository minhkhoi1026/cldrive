...
kernel void emboss_filter(read_only image2d_t srcImg, write_only image2d_t dstImg, sampler_t sampler, int width, int height) {
  int4 kernelWeights[9] = {-1, 0, 0, 0, 1, 0, 0, 0, 0};
  int scale = 1;
  int offset = 128;
