...
kernel void find_extrema_reduce_max(unsigned int count, local int* block, local unsigned int* block_idx, global unsigned int* _buf0, global int* _buf1, global int* _buf2) {
