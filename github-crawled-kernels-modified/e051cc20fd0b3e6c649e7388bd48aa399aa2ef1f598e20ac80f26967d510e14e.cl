//{"(input)":3,"(output)":12,"SB1":11,"SB2":7,"SB3":10,"SB4":6,"SB5":9,"SB6":5,"SB7":8,"SB8":4,"SK":0,"_input":13,"input":1,"outCipher":14,"output":2}
...
void des_crypt(global unsigned int* SK, private uchar input[8], private uchar output[8]) {
 private
  ...
  { (X) = ((unsigned int)(input)[hook(3, (0))] << 24) | ((unsigned int)(input)[hook(3, (0) + 1)] << 16) | ((unsigned int)(input)[hook(3, (0) + 2)] << 8) | ((unsigned int)(input)[hook(3, (0) + 3)]); };
  { (Y) = ((unsigned int)(input)[hook(3, (4))] << 24) | ((unsigned int)(input)[hook(3, (4) + 1)] << 16) | ((unsigned int)(input)[hook(3, (4) + 2)] << 8) | ((unsigned int)(input)[hook(3, (4) + 3)]); };
  ...
  {
    T = *SK++ ^ Y;
    X ^= SB8[hook(4, (T) & 63)] ^ SB6[hook(5, (T >> 8) & 63)] ^ SB4[hook(6, (T >> 16) & 63)] ^ SB2[hook(7, (T >> 24) & 63)];
    T = *SK++ ^ ((Y << 28) | (Y >> 4));
    X ^= SB7[hook(8, (T) & 63)] ^ SB5[hook(9, (T >> 8) & 63)] ^ SB3[hook(10, (T >> 16) & 63)] ^ SB1[hook(11, (T >> 24) & 63)];
  };
  {
    T = *SK++ ^ X;
    Y ^= SB8[hook(4, (T) & 63)] ^ SB6[hook(5, (T >> 8) & 63)] ^ SB4[hook(6, (T >> 16) & 63)] ^ SB2[hook(7, (T >> 24) & 63)];
    T = *SK++ ^ ((X << 28) | (X >> 4));
    Y ^= SB7[hook(8, (T) & 63)] ^ SB5[hook(9, (T >> 8) & 63)] ^ SB3[hook(10, (T >> 16) & 63)] ^ SB1[hook(11, (T >> 24) & 63)];
  };
  {
    T = *SK++ ^ Y;
    X ^= SB8[hook(4, (T) & 63)] ^ SB6[hook(5, (T >> 8) & 63)] ^ SB4[hook(6, (T >> 16) & 63)] ^ SB2[hook(7, (T >> 24) & 63)];
  ...
  {
    (output)[hook(12, (0))] = (uchar)((Y) >> 24);
    (output)[hook(12, (0) + 1)] = (uchar)((Y) >> 16);
    (output)[hook(12, (0) + 2)] = (uchar)((Y) >> 8);
    (output)[hook(12, (0) + 3)] = (uchar)((Y));
  };
  {
    (output)[hook(12, (4))] = (uchar)((X) >> 24);
    (output)[hook(12, (4) + 1)] = (uchar)((X) >> 16);
    (output)[hook(12, (4) + 2)] = (uchar)((X) >> 8);
    (output)[hook(12, (4) + 3)] = (uchar)((X));
  };
}
...
kernel void des3Cipher(global unsigned int* SK, global uchar* input, global uchar* output) {
 private
  size_t gid;
  gid = get_global_id(0);
 ...
 private
  ...
  for (size_t i = 0; i < 8; ++i) {
    ...
    _input[hook(13, i)] = input[hook(1, offset)];
  }
 ...
 private
  ...
  for (size_t i = 0; i < 8; i++) {
    size_t offset = gid * 8 + i;
    output[hook(2, offset)] = outCipher[hook(14, i)];
  }
}