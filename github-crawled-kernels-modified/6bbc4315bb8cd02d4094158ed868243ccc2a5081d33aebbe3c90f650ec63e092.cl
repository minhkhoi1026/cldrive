//{"activeRatio":5,"baselineDecay":6,"hiddenBaselinesBack":3,"hiddenBaselinesFront":4,"hiddenStates":1,"predictions":0,"rewards":2}
...
kernel void phPredictionReward(read_only image2d_t predictions, read_only image2d_t hiddenStates, write_only image2d_t rewards, read_only image2d_t hiddenBaselinesBack, write_only image2d_t hiddenBaselinesFront, float activeRatio, float baselineDecay) {
