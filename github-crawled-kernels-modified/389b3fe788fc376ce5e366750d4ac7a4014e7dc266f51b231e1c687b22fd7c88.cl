...
kernel void copy_matrix_to_tensor_area_scalar(global const float* M, unsigned int M_size1, unsigned int M_size2, unsigned int M_internal_size2, global float* T, unsigned int T_internal_size2, global const int* area) {
