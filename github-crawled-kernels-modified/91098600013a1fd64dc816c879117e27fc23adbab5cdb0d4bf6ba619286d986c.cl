//{"DATA_D":5,"DATA_H":4,"DATA_W":3,"Original_Volume":1,"VOLUME":6,"Volume":0,"d_Displacement_Field":2}
...
kernel void InterpolateVolumeCubicNonLinear(global float* Volume, read_only image3d_t Original_Volume, global const float* d_Displacement_Field, private int DATA_W, private int DATA_H, private int DATA_D, private int VOLUME) {
