...
__attribute__((reqd_work_group_size(256, 1, 1))) __attribute__((num_simd_work_items(16))) __attribute__((num_compute_units(2))) kernel void dynproc_kernel(int iteration, global int* restrict gpuWall, global int* restrict gpuSrc, global int* restrict gpuResults, int cols, int startStep, int border) {
