...
kernel void test_arg_3_5_kern(global float4* a0, global float4* a1, global float4* a2, global float4* b0, global float4* b1, global float4* b2, global float4* b3, global float4* b4) {
