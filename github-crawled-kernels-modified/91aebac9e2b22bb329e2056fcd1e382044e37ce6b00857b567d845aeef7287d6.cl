...
kernel void generate_mips_aggressive(unsigned int tex_id, unsigned int mipmap_start, global unsigned int* nums, global unsigned int* sizes, image_3d_write array, image_3d_read rarray) {
