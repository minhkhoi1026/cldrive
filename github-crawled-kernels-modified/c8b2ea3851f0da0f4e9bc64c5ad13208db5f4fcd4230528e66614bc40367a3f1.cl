//{"hiddenSize":5,"hiddenToVisible":7,"inputStates":0,"qErrors":3,"qErrorsNext":2,"qWeights":1,"radius":8,"reverseRadii":9,"visibleSize":4,"visibleToHidden":6}
...
kernel void qFirstBackward(read_only image2d_t inputStates, read_only image3d_t qWeights, read_only image2d_t qErrorsNext, write_only image2d_t qErrors, int2 visibleSize, int2 hiddenSize, float2 visibleToHidden, float2 hiddenToVisible, int radius, int2 reverseRadii) {
