//{"p_6->g_4":3,"p_6->g_4[6]":2,"p_6->g_4[i]":4,"result":0,"sequence_input":1}
...
kernel void entry(global ulong* result, global int* sequence_input) {
  ...
  struct S3* p_6 = &c_7;
  struct S3 c_8 = {
      0x65L, {{1L, 0x1F1EB32AL}, {1L, 0x1F1EB32AL}, {1L, 0x1F1EB32AL}, {1L, 0x1F1EB32AL}, {1L, 0x1F1EB32AL}, {1L, 0x1F1EB32AL}, {1L, 0x1F1EB32AL}, {1L, 0x1F1EB32AL}}, &p_6->g_4[hook(3, 6)][hook(2, 0)], sequence_input[hook(1, get_global_id(0))], sequence_input[hook(1, get_global_id(1))], sequence_input[hook(1, get_global_id(2))], sequence_input[hook(1, get_local_id(0))], sequence_input[hook(1, get_local_id(1))], sequence_input[hook(1, get_local_id(2))], sequence_input[hook(1, get_group_id(0))], sequence_input[hook(1, get_group_id(1))], sequence_input[hook(1, get_group_id(2))],
  };
  c_7 = c_8;
  barrier(0x01 | 0x02);
  func_1(p_6);
  ...
  for (i = 0; i < 8; i++) {
    for (j = 0; j < 2; j++) {
      transparent_crc_no_string(&crc64_context, p_6->g_4[hook(3, i)][hook(4, j)]);
    }
  }
