...
kernel void ParallelCompactKernel(global int* CompactOut_data, global int* CompactIn_data, global int* ScanResult_data, global int* numValidData, const unsigned int n) {
