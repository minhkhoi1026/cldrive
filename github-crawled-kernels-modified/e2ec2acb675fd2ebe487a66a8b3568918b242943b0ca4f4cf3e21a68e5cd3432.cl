...
kernel void sobelCross5(global const uchar* source, global uchar* dest, int src_step, int dst_step, int width, int height) {
  constant const float matrix[25] = {-1, -2, 0, 2, 1, -2, -4, 0, 4, 2, 0, 0, 0, 0, 0, 2, 4, 0, -4, -2, 1, 2, 0, -2, -1};
