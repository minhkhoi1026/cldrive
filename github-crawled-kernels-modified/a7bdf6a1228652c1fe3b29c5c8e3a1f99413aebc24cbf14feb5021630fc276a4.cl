//{"hiddenSize":5,"hiddenStates":0,"hiddenToVisible":7,"qErrors":3,"qStates":1,"qWeights":2,"radius":8,"reluLeak":10,"reverseRadii":9,"visibleSize":4,"visibleToHidden":6}
...
kernel void qLastBackward(read_only image2d_t hiddenStates, read_only image2d_t qStates, read_only image3d_t qWeights, write_only image2d_t qErrors, int2 visibleSize, int2 hiddenSize, float2 visibleToHidden, float2 hiddenToVisible, int radius, int2 reverseRadii, float reluLeak) {
