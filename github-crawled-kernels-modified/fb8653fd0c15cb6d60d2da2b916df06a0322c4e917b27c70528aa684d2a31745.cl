//{"convolution_real":0,"nX":2,"nY":3,"nZ":4,"sumFootprintGABAA":1}
...
kernel void postConvolution_GABAA(global const float* convolution_real, global float* sumFootprintGABAA, const unsigned int nX, const unsigned int nY, const unsigned int nZ) {
  ...
  sumFootprintGABAA[hook(1, index_fp)] = convolution_real[hook(0, index_conv)];
}