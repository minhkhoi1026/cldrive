...
kernel void gpu_bdia(global int* bandptr, global int* offset, global float* data, int aligned_length, int band_num, global float* vec, global float* result, int vecoffset) {
