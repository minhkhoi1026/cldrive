//{"d_data":1,"d_status":0,"d_status[bid].status":10,"params":3,"params->mask":7,"params->pos_tbl":11,"params->sh1_tbl":8,"params->sh2_tbl":9,"size":6,"status":2,"tex_param":4,"tex_single_temper":5}
...
kernel void mtgp32_single_kernel(global struct mtgp32_kernel_status_t* d_status, global float* d_data, local unsigned int* status, constant struct mtgp32_param_t* params, read_only image2d_t tex_param, read_only image2d_t tex_single_temper, int size) {
  ...
  for (int i = 0; i < size; i += (256 * 3)) {
    ...
    status[hook(2, tid)] = r;
    o = temper_single(r, status[hook(2, (256 * 3) - 351 + tid + pos - 1)], bid, params, tex_single_temper);
    ...
    o = temper_single(r, status[hook(2, (4 * 256 - 351 + tid + pos - 1) % (256 * 3))], bid, params, tex_single_temper);
    ...
    o = temper_single(r, status[hook(2, tid + pos - 1 + 2 * 256 - 351)], bid, params, tex_single_temper);
