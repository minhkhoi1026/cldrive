//{"A":0,"B":1,"C":2,"K":5,"M":3,"N":4,"loadA":7,"loadB":8,"regA":11,"regB":12,"regC":6,"tileA":9,"tileA_bak":13,"tileB":10,"tileB_bak":14}
...
kernel void gemm(const global float* A, const global float* B, global float* C, const int M, const int N, const int K) {
 ...
 private
  ...
  for (int i = 0; i < K / NUM_UNROLL; ++i) {
    if (i % 2 == 0) {
      tileA[hook(9, local_thread_id_y * 64 + local_thread_id_x * 8 + 0)] = loadA[hook(7, 0)];
      tileA[hook(9, local_thread_id_y * 64 + local_thread_id_x * 8 + 1)] = loadA[hook(7, 1)];
      tileA[hook(9, local_thread_id_y * 64 + local_thread_id_x * 8 + 2)] = loadA[hook(7, 2)];
      tileA[hook(9, local_thread_id_y * 64 + local_thread_id_x * 8 + 3)] = loadA[hook(7, 3)];
      tileA[hook(9, local_thread_id_y * 64 + local_thread_id_x * 8 + 4)] = loadA[hook(7, 4)];
      tileA[hook(9, local_thread_id_y * 64 + local_thread_id_x * 8 + 5)] = loadA[hook(7, 5)];
      tileA[hook(9, local_thread_id_y * 64 + local_thread_id_x * 8 + 6)] = loadA[hook(7, 6)];
      tileA[hook(9, local_thread_id_y * 64 + local_thread_id_x * 8 + 7)] = loadA[hook(7, 7)];

      tileB[hook(10, local_thread_id + 0 * tile_dim_y)] = loadB[hook(8, 0)];
      tileB[hook(10, local_thread_id + 1 * tile_dim_y)] = loadB[hook(8, 1)];
      tileB[hook(10, local_thread_id + 2 * tile_dim_y)] = loadB[hook(8, 2)];
      tileB[hook(10, local_thread_id + 3 * tile_dim_y)] = loadB[hook(8, 3)];
      tileB[hook(10, local_thread_id + 4 * tile_dim_y)] = loadB[hook(8, 4)];
      tileB[hook(10, local_thread_id + 5 * tile_dim_y)] = loadB[hook(8, 5)];
      tileB[hook(10, local_thread_id + 6 * tile_dim_y)] = loadB[hook(8, 6)];
      tileB[hook(10, local_thread_id + 7 * tile_dim_y)] = loadB[hook(8, 7)];
      ...
      for (int k = 0; k < NUM_UNROLL; ++k) {
        regA[hook(11, 0)] = tileA[hook(9, k * tile_dim_x + local_thread_id_x * 8 + 0)];
        regA[hook(11, 1)] = tileA[hook(9, k * tile_dim_x + local_thread_id_x * 8 + 1)];
        regA[hook(11, 2)] = tileA[hook(9, k * tile_dim_x + local_thread_id_x * 8 + 2)];
        regA[hook(11, 3)] = tileA[hook(9, k * tile_dim_x + local_thread_id_x * 8 + 3)];
        regA[hook(11, 4)] = tileA[hook(9, k * tile_dim_x + local_thread_id_x * 8 + 4)];
        regA[hook(11, 5)] = tileA[hook(9, k * tile_dim_x + local_thread_id_x * 8 + 5)];
        regA[hook(11, 6)] = tileA[hook(9, k * tile_dim_x + local_thread_id_x * 8 + 6)];
        regA[hook(11, 7)] = tileA[hook(9, k * tile_dim_x + local_thread_id_x * 8 + 7)];

        regB[hook(12, 0)] = tileB[hook(10, k * tile_dim_y + local_thread_id_y * 8 + 0)];
        regB[hook(12, 1)] = tileB[hook(10, k * tile_dim_y + local_thread_id_y * 8 + 1)];
        regB[hook(12, 2)] = tileB[hook(10, k * tile_dim_y + local_thread_id_y * 8 + 2)];
        regB[hook(12, 3)] = tileB[hook(10, k * tile_dim_y + local_thread_id_y * 8 + 3)];
        regB[hook(12, 4)] = tileB[hook(10, k * tile_dim_y + local_thread_id_y * 8 + 4)];
        regB[hook(12, 5)] = tileB[hook(10, k * tile_dim_y + local_thread_id_y * 8 + 5)];
        regB[hook(12, 6)] = tileB[hook(10, k * tile_dim_y + local_thread_id_y * 8 + 6)];
        regB[hook(12, 7)] = tileB[hook(10, k * tile_dim_y + local_thread_id_y * 8 + 7)];
      ...
      tileA_bak[hook(13, local_thread_id_y * 64 + local_thread_id_x * 8 + 0)] = loadA[hook(7, 0)];
      tileA_bak[hook(13, local_thread_id_y * 64 + local_thread_id_x * 8 + 1)] = loadA[hook(7, 1)];
      tileA_bak[hook(13, local_thread_id_y * 64 + local_thread_id_x * 8 + 2)] = loadA[hook(7, 2)];
      tileA_bak[hook(13, local_thread_id_y * 64 + local_thread_id_x * 8 + 3)] = loadA[hook(7, 3)];
      tileA_bak[hook(13, local_thread_id_y * 64 + local_thread_id_x * 8 + 4)] = loadA[hook(7, 4)];
      tileA_bak[hook(13, local_thread_id_y * 64 + local_thread_id_x * 8 + 5)] = loadA[hook(7, 5)];
      tileA_bak[hook(13, local_thread_id_y * 64 + local_thread_id_x * 8 + 6)] = loadA[hook(7, 6)];
      tileA_bak[hook(13, local_thread_id_y * 64 + local_thread_id_x * 8 + 7)] = loadA[hook(7, 7)];

      tileB_bak[hook(14, local_thread_id + 0 * tile_dim_y)] = loadB[hook(8, 0)];
      tileB_bak[hook(14, local_thread_id + 1 * tile_dim_y)] = loadB[hook(8, 1)];
      tileB_bak[hook(14, local_thread_id + 2 * tile_dim_y)] = loadB[hook(8, 2)];
      tileB_bak[hook(14, local_thread_id + 3 * tile_dim_y)] = loadB[hook(8, 3)];
      tileB_bak[hook(14, local_thread_id + 4 * tile_dim_y)] = loadB[hook(8, 4)];
      tileB_bak[hook(14, local_thread_id + 5 * tile_dim_y)] = loadB[hook(8, 5)];
      tileB_bak[hook(14, local_thread_id + 6 * tile_dim_y)] = loadB[hook(8, 6)];
      tileB_bak[hook(14, local_thread_id + 7 * tile_dim_y)] = loadB[hook(8, 7)];
      ...
      for (int k = 0; k < NUM_UNROLL; ++k) {
        regA[hook(11, 0)] = tileA_bak[hook(13, k * tile_dim_x + local_thread_id_x * 8 + 0)];
        regA[hook(11, 1)] = tileA_bak[hook(13, k * tile_dim_x + local_thread_id_x * 8 + 1)];
        regA[hook(11, 2)] = tileA_bak[hook(13, k * tile_dim_x + local_thread_id_x * 8 + 2)];
        regA[hook(11, 3)] = tileA_bak[hook(13, k * tile_dim_x + local_thread_id_x * 8 + 3)];
        regA[hook(11, 4)] = tileA_bak[hook(13, k * tile_dim_x + local_thread_id_x * 8 + 4)];
        regA[hook(11, 5)] = tileA_bak[hook(13, k * tile_dim_x + local_thread_id_x * 8 + 5)];
        regA[hook(11, 6)] = tileA_bak[hook(13, k * tile_dim_x + local_thread_id_x * 8 + 6)];
        regA[hook(11, 7)] = tileA_bak[hook(13, k * tile_dim_x + local_thread_id_x * 8 + 7)];

        regB[hook(12, 0)] = tileB_bak[hook(14, k * tile_dim_y + local_thread_id_y * 8 + 0)];
        regB[hook(12, 1)] = tileB_bak[hook(14, k * tile_dim_y + local_thread_id_y * 8 + 1)];
        regB[hook(12, 2)] = tileB_bak[hook(14, k * tile_dim_y + local_thread_id_y * 8 + 2)];
        regB[hook(12, 3)] = tileB_bak[hook(14, k * tile_dim_y + local_thread_id_y * 8 + 3)];
        regB[hook(12, 4)] = tileB_bak[hook(14, k * tile_dim_y + local_thread_id_y * 8 + 4)];
        regB[hook(12, 5)] = tileB_bak[hook(14, k * tile_dim_y + local_thread_id_y * 8 + 5)];
        regB[hook(12, 6)] = tileB_bak[hook(14, k * tile_dim_y + local_thread_id_y * 8 + 6)];
        regB[hook(12, 7)] = tileB_bak[hook(14, k * tile_dim_y + local_thread_id_y * 8 + 7)];
