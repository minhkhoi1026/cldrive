//{"Nlayers":9,"Nq":2,"Nthickness":6,"background":8,"cutoff":5,"loops":4,"loops_g":3,"q":0,"result":1,"scale":7,"sld":12,"solvent_sld":13,"spacing":10,"spacing_polydisp":11}
...
kernel void lamellarPC_Iq(global const float* q, global float* result, const int Nq,
...

  {
    ...
    for (int thickness_i = 0; thickness_i < Nthickness; thickness_i++) {
      ...
      if (weight > cutoff) {
        const float scattering = Iq(qi, thickness, Nlayers, spacing, spacing_polydisp, sld, solvent_sld);
