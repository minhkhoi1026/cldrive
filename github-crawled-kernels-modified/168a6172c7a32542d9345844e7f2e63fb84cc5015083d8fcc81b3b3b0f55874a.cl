//{"hiddenSize":4,"hiddenStates":0,"hiddenToVisible":6,"radius":7,"reconstruction":1,"reverseRadii":8,"visibleSize":3,"visibleToHidden":5,"weights":2}
...
kernel void scReconstructVisible(read_only image2d_t hiddenStates, write_only image2d_t reconstruction, read_only image3d_t weights, int2 visibleSize, int2 hiddenSize, float2 visibleToHidden, float2 hiddenToVisible, int radius, int2 reverseRadii) {
