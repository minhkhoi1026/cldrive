...
unsigned int func_1(struct S0* p_6);
unsigned int func_1(struct S0* p_6) {
  int* l_2[8] = {&p_6->g_3, &p_6->g_3, &p_6->g_3, &p_6->g_3, &p_6->g_3, &p_6->g_3, &p_6->g_3, &p_6->g_3};
  int** l_5 = &l_2[hook(3, 3)];
  int i;
  (*l_5) = l_2[hook(3, 0)];
  return p_6->g_3;
}
