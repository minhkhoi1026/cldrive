//{"a0":0,"a1":1,"a2":2,"a3":3,"a4":4,"b0":5,"b1":6,"b2":7,"b3":8,"c0":9,"c1":10,"c2":11,"c3":12,"c4":13}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void test_block_5_4_kern(global float* a0, global float* a1, global float* a2, global float* a3, global float* a4, global float* b0, global float* b1, global float* b2, global float* b3, local float* c0, local float* c1, local float* c2, local float* c3, local float* c4) {
  int i;
