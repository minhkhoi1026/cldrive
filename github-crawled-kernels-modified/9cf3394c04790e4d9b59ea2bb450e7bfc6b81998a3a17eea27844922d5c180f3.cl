...
__attribute__((max_work_group_size(1000))) kernel void batch_norm_layer(global float* restrict pMaps, global float* restrict pScale, global float* restrict pOffset, global float* restrict pOutput) {
