//{"((const __global uchar *)(input + srcIndex))":10,"BSx":7,"BSy":8,"alpha_s":3,"fore_th":4,"grad_dir":6,"input":5,"is_first_run":2,"is_minus1":0,"is_plus2":1,"mapRes":9}
...
kernel void SobelAndMagicDetectorNoCanny(const int is_minus1, const int is_plus2, const int is_first_run, const float alpha_s, const float fore_th, global const uchar16* restrict input, global float16* restrict grad_dir, global float16* restrict BSx, global float16* restrict BSy, global uchar16* restrict mapRes) {
  ...
  for (int k = 0; k < 16; ++k) {
    ...
    float i = ((global const uchar*)(input + srcIndex))[hook(10, 16)];
