//{"eps":4,"global_size_dim0":0,"global_size_dim1":1,"height":6,"input":2,"output":7,"scale":3,"width":5}
...
kernel void BatchNormBatch(private const int global_size_dim0, private const int global_size_dim1, read_only image2d_t input, read_only image2d_t scale, read_only image2d_t eps, private const int width, private const int height, write_only image2d_t output) {
