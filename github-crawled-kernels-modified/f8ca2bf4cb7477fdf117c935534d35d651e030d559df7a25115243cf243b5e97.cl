...
kernel void image_to_nhwc_buffer(private const int global_size_dim0, private const int global_size_dim1, global float* output, private const int height, private const int width, private const int channels, read_only image2d_t input_ptr) {
