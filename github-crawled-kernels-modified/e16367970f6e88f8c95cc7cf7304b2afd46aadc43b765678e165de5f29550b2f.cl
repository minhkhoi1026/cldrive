...
__attribute__((reqd_work_group_size(7, 7, 2))) __attribute__((reqd_work_group_size(14, 14, 2))) __attribute__((reqd_work_group_size(1, 1, 1))) __attribute__((reqd_work_group_size(16, 1, 1))) __attribute__((reqd_work_group_size(1, 1, 10))) __attribute__((reqd_work_group_size(12, 1, 1))) __attribute__((reqd_work_group_size(10, 1, 1))) kernel void rbf7(global float* out, global float* weight, global float* offset) {
