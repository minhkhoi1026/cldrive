...
__attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) __attribute__((reqd_work_group_size(16, 16, 1))) kernel void reduce_count_nz(global const uchar* source, global float* result, int src_step, int img_width, int img_height) {
  ...
  if (lid < 128)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 128)]) {
      ...
      buffer[hook(5, lid)] = (buffer[hook(5, lid)] + buffer[hook(5, lid + 128)]);
  ...
  if (lid < 64)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 64)]) {
      ...
      buffer[hook(5, lid)] = (buffer[hook(5, lid)] + buffer[hook(5, lid + 64)]);
  ...
  if (lid < 32)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 32)]) {
      ...
      buffer[hook(5, lid)] = (buffer[hook(5, lid)] + buffer[hook(5, lid + 32)]);
  ...
  if (lid < 16)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 16)]) {
      ...
      buffer[hook(5, lid)] = (buffer[hook(5, lid)] + buffer[hook(5, lid + 16)]);
  ...
  if (lid < 8)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 8)]) {
      ...
      buffer[hook(5, lid)] = (buffer[hook(5, lid)] + buffer[hook(5, lid + 8)]);
  ...
  if (lid < 4)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 4)]) {
      ...
      buffer[hook(5, lid)] = (buffer[hook(5, lid)] + buffer[hook(5, lid + 4)]);
  ...
  if (lid < 2)
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 2)]) {
      ...
      buffer[hook(5, lid)] = (buffer[hook(5, lid)] + buffer[hook(5, lid + 2)]);
  ...
  if (lid == 0) {
    if (nb_pixels[hook(6, lid)] && nb_pixels[hook(6, lid + 1)]) {
      ...
      buffer[hook(5, lid)] = (buffer[hook(5, lid)] + buffer[hook(5, lid + 1)]);
