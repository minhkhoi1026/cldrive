//{"actionAlpha":11,"actionsBack":3,"actionsFront":4,"hiddenErrors":0,"hiddenSize":5,"hiddenStates":1,"hiddenToVisible":7,"radius":9,"reverseRadii":10,"visibleSize":6,"visibleToHidden":8,"weights":2}
...
kernel void swarmHiddenPropagateToVisibleAction(read_only image2d_t hiddenErrors, read_only image2d_t hiddenStates, read_only image3d_t weights, read_only image2d_t actionsBack, write_only image2d_t actionsFront, int2 hiddenSize, int2 visibleSize, float2 hiddenToVisible, float2 visibleToHidden, int radius, int2 reverseRadii, float actionAlpha) {
