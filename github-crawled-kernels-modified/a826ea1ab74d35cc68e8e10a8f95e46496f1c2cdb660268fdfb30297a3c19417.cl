//{"hiddenStatesFront":1,"hiddenSummationTemp":0}
...
kernel void predSolveHiddenBinary(read_only image2d_t hiddenSummationTemp, write_only image2d_t hiddenStatesFront) {
