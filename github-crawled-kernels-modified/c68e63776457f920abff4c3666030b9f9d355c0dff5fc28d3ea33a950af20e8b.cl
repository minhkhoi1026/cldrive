...
kernel void matrixMuladdKernelModular32SP(global float* D, float alpha, global float* A, global float* B, float beta, global float* C, const int widthA, const int widthB, const float mod) {
