...
kernel void sobelV3(global const uchar* source, global uchar* dest, int src_step, int dst_step, int width, int height) {
  constant const float matrix[9] = {1, 0, -1, 2, 0, -2, 1, 0, -1};
