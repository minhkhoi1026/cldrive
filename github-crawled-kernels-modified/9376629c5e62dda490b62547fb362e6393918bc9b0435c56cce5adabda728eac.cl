...
kernel void buildWarpSphericalMaps(global uchar* xmapptr, int xmap_step, int xmap_offset, global uchar* ymapptr, int ymap_step, int ymap_offset, int rows, int cols, constant float* ck_rinv, int tl_u, int tl_v, float scale, int rowsPerWI) {
