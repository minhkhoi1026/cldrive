...
kernel __attribute((num_simd_work_items(8))) __attribute((reqd_work_group_size(256, 1, 1))) void ScanLargeArrays_kernel(global int* restrict output, global int* restrict input, const unsigned int block_size, global int* restrict sumBuffer) {
