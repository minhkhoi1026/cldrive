...
kernel void hcomp_kern(float4 src, int nx, int ny, int nz, float4 b, global float4* hh, global float4* ee) {
  ...
  local float4 w_hx000[260];
  local float4 w_hy000[260];
  local float4 w_hz000[260];
  ...
  w_hx000[hook(7, tz + 65)] = hh[hook(5, gci0103 + 0 * nz)];
  w_hy000[hook(8, tz + 65)] = hh[hook(5, gci0103 + 1 * nz)];
  w_hz000[hook(9, tz + 65)] = hh[hook(5, gci0103 + 2 * nz)];

  w_hx000[hook(7, tz + 130)] = hh[hook(5, gci0203 + 0 * nz)];
  w_hy000[hook(8, tz + 130)] = hh[hook(5, gci0203 + 1 * nz)];
  w_hz000[hook(9, tz + 130)] = hh[hook(5, gci0203 + 2 * nz)];

  w_hx000[hook(7, tz + 195)] = hh[hook(5, gci0303 + 0 * nz)];
  w_hy000[hook(8, tz + 195)] = hh[hook(5, gci0303 + 1 * nz)];
  w_hz000[hook(9, tz + 195)] = hh[hook(5, gci0303 + 2 * nz)];
  {
    int gci0003 = 3 * (gtx * nyz + y * nz) + gtz;
    int gci0103 = 3 * (gtx * nyz + y1 * nz) + gtz;
...

  {
    ...
    w_hx000[hook(7, tz + 65)] += bz4 * (w_ey000[hook(11, tz + 1)] - w_ey000[hook(11, tz)]) + by4 * (w_ez000[hook(12, tz)] - w_ez000[hook(12, tz + 65)]);
    w_hy000[hook(8, tz + 65)] += bx4 * (w_ez100[hook(15, tz)] - w_ez000[hook(12, tz)]) + bz4 * (w_ex000[hook(10, tz)] - w_ex000[hook(10, tz + 1)]);
    w_hz000[hook(9, tz + 65)] += by4 * (w_ex000[hook(10, tz + 65)] - w_ex000[hook(10, tz)]) + bx4 * (w_ey000[hook(11, tz)] - w_ey100[hook(14, tz)]);
  }

  {
    ...
    w_hx000[hook(7, tz + 130)] += bz4 * (w_ey000[hook(11, tz + 1)] - w_ey000[hook(11, tz)]) + by4 * (w_ez000[hook(12, tz)] - w_ez000[hook(12, tz + 65)]);
    w_hy000[hook(8, tz + 130)] += bx4 * (w_ez100[hook(15, tz)] - w_ez000[hook(12, tz)]) + bz4 * (w_ex000[hook(10, tz)] - w_ex000[hook(10, tz + 1)]);
    w_hz000[hook(9, tz + 130)] += by4 * (w_ex000[hook(10, tz + 65)] - w_ex000[hook(10, tz)]) + bx4 * (w_ey000[hook(11, tz)] - w_ey100[hook(14, tz)]);
  }

  {
    ...
    w_hx000[hook(7, tz + 195)] += bz4 * (w_ey000[hook(11, tz + 1)] - w_ey000[hook(11, tz)]) + by4 * (w_ez000[hook(12, tz)] - w_ez000[hook(12, tz + 65)]);
    w_hy000[hook(8, tz + 195)] += bx4 * (w_ez100[hook(15, tz)] - w_ez000[hook(12, tz)]) + bz4 * (w_ex000[hook(10, tz)] - w_ex000[hook(10, tz + 1)]);
    w_hz000[hook(9, tz + 195)] += by4 * (w_ex000[hook(10, tz + 65)] - w_ex000[hook(10, tz)]) + bx4 * (w_ey000[hook(11, tz)] - w_ey100[hook(14, tz)]);
  }

  {
    ...
    hh[hook(5, gci0103 + 0 * nz)] = w_hx000[hook(7, tz + 65)];
    hh[hook(5, gci0103 + 1 * nz)] = w_hy000[hook(8, tz + 65)];
    hh[hook(5, gci0103 + 2 * nz)] = w_hz000[hook(9, tz + 65)];

    hh[hook(5, gci0203 + 0 * nz)] = w_hx000[hook(7, tz + 130)];
    hh[hook(5, gci0203 + 1 * nz)] = w_hy000[hook(8, tz + 130)];
    hh[hook(5, gci0203 + 2 * nz)] = w_hz000[hook(9, tz + 130)];

    hh[hook(5, gci0303 + 0 * nz)] = w_hx000[hook(7, tz + 195)];
    hh[hook(5, gci0303 + 1 * nz)] = w_hy000[hook(8, tz + 195)];
    hh[hook(5, gci0303 + 2 * nz)] = w_hz000[hook(9, tz + 195)];
  }
}