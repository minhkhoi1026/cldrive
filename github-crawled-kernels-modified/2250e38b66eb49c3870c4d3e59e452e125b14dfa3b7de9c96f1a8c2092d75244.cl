//{"diffThresh":2,"input":0,"nCumLevels":5,"nHueLevels":3,"nSumLevels":4,"output":1}
...
kernel void quantize_HMMD(read_only image2d_t input, write_only image2d_t output, constant short* diffThresh, constant uchar* nHueLevels, constant uchar* nSumLevels, constant uchar* nCumLevels) {
