...
kernel void pcr_small_systems_kernel(global float* a_d, global float* b_d, global float* c_d, global float* d_d, global float* x_d, local float* shared, int system_size, int num_systems, int iterations) {
