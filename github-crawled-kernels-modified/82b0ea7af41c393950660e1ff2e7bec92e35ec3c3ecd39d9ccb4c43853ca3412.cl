//{"hiddenSummationTempBack":1,"hiddenSummationTempFront":2,"hiddenToVisible":5,"radius":6,"visibleSize":4,"visibleStates":0,"weights":3}
...
kernel void cscActivateIgnoreMiddle(read_only image2d_t visibleStates, read_only image2d_t hiddenSummationTempBack, write_only image2d_t hiddenSummationTempFront, read_only image3d_t weights, int2 visibleSize, float2 hiddenToVisible, int radius) {
