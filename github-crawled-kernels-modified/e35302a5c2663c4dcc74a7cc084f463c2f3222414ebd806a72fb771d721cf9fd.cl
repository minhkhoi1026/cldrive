...
kernel void arithm_phase_indegrees_D5(global float* src1, int src1_step1, int src1_offset1, global float* src2, int src2_step1, int src2_offset1, global float* dst, int dst_step1, int dst_offset1, int cols, int rows) {
  ...
  if (x < cols && y < rows) {
    ...
    tmp = 180 * tmp / 3.14159265358979323846264338327950288f;
