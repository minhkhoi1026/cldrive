...
kernel void transform_rot_180(write_only image2d_t img_y_dst, write_only image2d_t img_uv_dst, read_only image2d_t img_y_src, read_only image2d_t img_uv_src, unsigned int w, unsigned int h) {
