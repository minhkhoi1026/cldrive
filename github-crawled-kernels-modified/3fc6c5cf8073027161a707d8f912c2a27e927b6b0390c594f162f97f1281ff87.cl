//{"ce":8,"ce[m]":7,"dtemp":6,"g_rhs":0,"g_rms":1,"gp0":3,"gp1":4,"gp2":5,"l_rms":2,"rhs":13,"rhs[k]":12,"rhs[k][j]":11,"rhs[k][j][i]":10,"rms":15,"rms_local":9,"rms_other":14}
...
kernel void rhs_norm(global double* g_rhs, global double* g_rms, local double* l_rms, int gp0, int gp1, int gp2) {
  int i, j, k, m, lid;
  double add;
