...
kernel void _XACC_unpack_vector_32(global int* dst, unsigned long dst_off_e, global const int* src, unsigned long src_off_e, unsigned long blocklength_e, unsigned long stride_e, unsigned long count) {
