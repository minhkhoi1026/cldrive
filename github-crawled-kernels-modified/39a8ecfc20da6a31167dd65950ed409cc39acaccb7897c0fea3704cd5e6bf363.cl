...
kernel void vertical_convolution(const global float* input, global float* output, constant float* filter __attribute__((max_constant_size(16384))), int FILTER_SIZE, int IMAGE_W, int IMAGE_H) {
