//{"C":2,"D0":12,"D1":13,"EK":1,"F0_OUT":10,"FI_IN":3,"FI_KEY":6,"FL_IN":11,"FO_IN":8,"P":0,"S7TABLE":5,"S9TABLE":4,"_P":14,"outCipher":15,"t0":7,"t1":9}
...
kernel void misty1Cipher(global ulong* P, global ushort* EK, global ulong* C) {
 private
  int gid;
  gid = get_global_id(0);
 ...
 private
  ulong _P[1];
  _P[hook(14, 0)] = P[hook(0, gid)];

 private
  ulong outCipher[1];

  misty1_encrypt(_P, EK, outCipher);

  C[hook(2, gid)] = outCipher[hook(15, 0)];
}