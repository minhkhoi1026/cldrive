//{"hiddenBiases":0,"hiddenSummationTempFront":1}
...
kernel void swarmInitSummation(read_only image2d_t hiddenBiases, write_only image2d_t hiddenSummationTempFront) {
