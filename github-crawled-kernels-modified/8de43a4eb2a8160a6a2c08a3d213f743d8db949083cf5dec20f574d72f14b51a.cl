//{"l_2":3,"l_2[p_6->g_3]":2,"result":0,"sequence_input":1}
...
long func_1(struct S1* p_6) {
  ...
  for (p_6->g_3 = 0; p_6->g_3 < 6; p_6->g_3 += 1) {
    for (p_6->g_4 = 0; p_6->g_4 < 9; p_6->g_4 += 1) {
      l_2[hook(3, p_6->g_3)][hook(2, p_6->g_4)] = 251UL;
    }
  }
  p_6->g_4 = p_6->g_4;
  return p_6->g_4;
