//{"Diffusivity":1,"N":0,"N1":3,"deltaT":2}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void AnisotropicFilter_32f(global float* N, global float* Diffusivity, float deltaT, global float* N1) {
  ...
  float r = N[hook(0, linear_coords)];
  ...
  r_xminus1 = N[hook(0, linear_coord_minus_one_x)] - r;
  r_xplus1 = N[hook(0, linear_coord_plus_one_x)] - r;
  ...
  r_yminus1 = N[hook(0, linear_coord_minus_one_y)] - r;
  r_yplus1 = N[hook(0, linear_coord_plus_one_y)] - r;
  ...
  r_zminus1 = N[hook(0, linear_coord_minus_one_z)] - r;
  r_zplus1 = N[hook(0, linear_coord_plus_one_z)] - r;
