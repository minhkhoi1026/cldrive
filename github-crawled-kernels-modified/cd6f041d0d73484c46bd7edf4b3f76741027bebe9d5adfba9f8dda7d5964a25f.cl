//{"ablock":11,"ablock[0]":10,"ablock[1]":13,"ablock[2]":14,"ablock[3]":15,"ablock[4]":16,"avec":12,"bblock":20,"bblock[0]":19,"bblock[1]":22,"bblock[2]":24,"bblock[3]":26,"bblock[4]":28,"bvec":9,"c":36,"c[0]":35,"c[1]":37,"c[2]":38,"c[3]":39,"c[4]":40,"cblock":18,"cblock[0]":17,"cblock[1]":21,"cblock[2]":23,"cblock[3]":25,"cblock[4]":27,"fjac":47,"fjac[i]":46,"fjac[i][0]":45,"fjac[i][1]":48,"fjac[i][2]":49,"fjac[i][3]":50,"fjac[i][4]":51,"g_fjac":4,"g_njac":5,"g_qs":0,"g_rho_i":1,"g_square":2,"g_u":3,"gp0":6,"gp1":7,"gp2":8,"lhs":30,"lhs[0]":29,"lhs[1]":31,"lhs[2]":32,"lhs[3]":33,"lhs[4]":34,"njac":64,"njac[i]":63,"njac[i][0]":62,"njac[i][1]":65,"njac[i][2]":66,"njac[i][3]":67,"njac[i][4]":68,"qs":58,"qs[k]":57,"qs[k][j]":56,"r":41,"rho_i":44,"rho_i[k]":43,"rho_i[k][j]":42,"square":61,"square[k]":60,"square[k][j]":59,"u":55,"u[k]":54,"u[k][j]":53,"u[k][j][i]":52}
...
kernel void x_solve1(global double* g_qs, global double* g_rho_i, global double* g_square, global double* g_u, global double* g_fjac, global double* g_njac, int gp0, int gp1, int gp2) {
  int i, j, k;
  ...
  fjac[hook(47, i)][hook(46, 0)][hook(45, 0)] = 0.0;
  fjac[hook(47, i)][hook(46, 1)][hook(48, 0)] = 1.0;
  fjac[hook(47, i)][hook(46, 2)][hook(49, 0)] = 0.0;
  fjac[hook(47, i)][hook(46, 3)][hook(50, 0)] = 0.0;
  fjac[hook(47, i)][hook(46, 4)][hook(51, 0)] = 0.0;

  fjac[hook(47, i)][hook(46, 0)][hook(45, 1)] = -(u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * tmp2 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)]) + 0.4 * qs[hook(58, k)][hook(57, j)][hook(56, i)];
  fjac[hook(47, i)][hook(46, 1)][hook(48, 1)] = (2.0 - 0.4) * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] / u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 0)]);
  fjac[hook(47, i)][hook(46, 2)][hook(49, 1)] = -0.4 * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 2)] * tmp1);
  fjac[hook(47, i)][hook(46, 3)][hook(50, 1)] = -0.4 * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 3)] * tmp1);
  fjac[hook(47, i)][hook(46, 4)][hook(51, 1)] = 0.4;

  fjac[hook(47, i)][hook(46, 0)][hook(45, 2)] = -(u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 2)]) * tmp2;
  fjac[hook(47, i)][hook(46, 1)][hook(48, 2)] = u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 2)] * tmp1;
  fjac[hook(47, i)][hook(46, 2)][hook(49, 2)] = u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * tmp1;
  fjac[hook(47, i)][hook(46, 3)][hook(50, 2)] = 0.0;
  fjac[hook(47, i)][hook(46, 4)][hook(51, 2)] = 0.0;

  fjac[hook(47, i)][hook(46, 0)][hook(45, 3)] = -(u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 3)]) * tmp2;
  fjac[hook(47, i)][hook(46, 1)][hook(48, 3)] = u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 3)] * tmp1;
  fjac[hook(47, i)][hook(46, 2)][hook(49, 3)] = 0.0;
  fjac[hook(47, i)][hook(46, 3)][hook(50, 3)] = u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * tmp1;
  fjac[hook(47, i)][hook(46, 4)][hook(51, 3)] = 0.0;

  fjac[hook(47, i)][hook(46, 0)][hook(45, 4)] = (0.4 * 2.0 * square[hook(61, k)][hook(60, j)][hook(59, i)] - 1.4 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 4)]) * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * tmp2);
  fjac[hook(47, i)][hook(46, 1)][hook(48, 4)] = 1.4 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 4)] * tmp1 - 0.4 * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * tmp2 + qs[hook(58, k)][hook(57, j)][hook(56, i)]);
  fjac[hook(47, i)][hook(46, 2)][hook(49, 4)] = -0.4 * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 2)] * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)]) * tmp2;
  fjac[hook(47, i)][hook(46, 3)][hook(50, 4)] = -0.4 * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 3)] * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)]) * tmp2;
  fjac[hook(47, i)][hook(46, 4)][hook(51, 4)] = 1.4 * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * tmp1);

  njac[hook(64, i)][hook(63, 0)][hook(62, 0)] = 0.0;
  njac[hook(64, i)][hook(63, 1)][hook(65, 0)] = 0.0;
  njac[hook(64, i)][hook(63, 2)][hook(66, 0)] = 0.0;
  njac[hook(64, i)][hook(63, 3)][hook(67, 0)] = 0.0;
  njac[hook(64, i)][hook(63, 4)][hook(68, 0)] = 0.0;

  njac[hook(64, i)][hook(63, 0)][hook(62, 1)] = -(4.0 / 3.0) * (0.1 * 1.0) * tmp2 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)];
  njac[hook(64, i)][hook(63, 1)][hook(65, 1)] = (4.0 / 3.0) * (0.1 * 1.0) * tmp1;
  njac[hook(64, i)][hook(63, 2)][hook(66, 1)] = 0.0;
  njac[hook(64, i)][hook(63, 3)][hook(67, 1)] = 0.0;
  njac[hook(64, i)][hook(63, 4)][hook(68, 1)] = 0.0;

  njac[hook(64, i)][hook(63, 0)][hook(62, 2)] = -(0.1 * 1.0) * tmp2 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 2)];
  njac[hook(64, i)][hook(63, 1)][hook(65, 2)] = 0.0;
  njac[hook(64, i)][hook(63, 2)][hook(66, 2)] = (0.1 * 1.0) * tmp1;
  njac[hook(64, i)][hook(63, 3)][hook(67, 2)] = 0.0;
  njac[hook(64, i)][hook(63, 4)][hook(68, 2)] = 0.0;

  njac[hook(64, i)][hook(63, 0)][hook(62, 3)] = -(0.1 * 1.0) * tmp2 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 3)];
  njac[hook(64, i)][hook(63, 1)][hook(65, 3)] = 0.0;
  njac[hook(64, i)][hook(63, 2)][hook(66, 3)] = 0.0;
  njac[hook(64, i)][hook(63, 3)][hook(67, 3)] = (0.1 * 1.0) * tmp1;
  njac[hook(64, i)][hook(63, 4)][hook(68, 3)] = 0.0;

  njac[hook(64, i)][hook(63, 0)][hook(62, 4)] = -((4.0 / 3.0) * (0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp3 * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)] * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)]) - ((0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp3 * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 2)] * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 2)]) - ((0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp3 * (u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 3)] * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 3)]) - ((1.4 * 1.4) * (0.1 * 1.0)) * tmp2 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 4)];

  njac[hook(64, i)][hook(63, 1)][hook(65, 4)] = ((4.0 / 3.0) * (0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp2 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 1)];
  njac[hook(64, i)][hook(63, 2)][hook(66, 4)] = ((0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp2 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 2)];
  njac[hook(64, i)][hook(63, 3)][hook(67, 4)] = ((0.1 * 1.0) - ((1.4 * 1.4) * (0.1 * 1.0))) * tmp2 * u[hook(55, k)][hook(54, j)][hook(53, i)][hook(52, 3)];
  njac[hook(64, i)][hook(63, 4)][hook(68, 4)] = (((1.4 * 1.4) * (0.1 * 1.0))) * tmp1;
}