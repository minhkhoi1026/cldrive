...
kernel void test_block_6_1_kern(global int* a0, global int* a1, global int* a2, global int* a3, global int* a4, global int* a5, global int* b0, local int* c0, local int* c1, local int* c2, local int* c3, local int* c4, local int* c5) {
  int i;
  ...
  c5[hook(12, ltid)] = a5[hook(5, gtid)] + 5;
  barrier(0x01);
  int tmp0 = 0;
  int tmp1 = 0;
  int tmp2 = 0;
