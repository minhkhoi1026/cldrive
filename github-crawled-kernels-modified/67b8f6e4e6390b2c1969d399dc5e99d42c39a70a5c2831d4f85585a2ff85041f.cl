...
kernel void noise_backward(global float* dinp, global float* doutp, global float* outp, global float* inp, global float* dom, int inputWidth, float perc, int batchSize) {
