//{"c2":4,"n":3,"o":0,"prefactor":8,"q":2,"qlocal":11,"s":1,"slocal":10,"vlocal":9,"w":5,"xsize":6,"ysize":7}
...
kernel void coulomb2(global double* o, global int* s, global int* q, int n, int c2, global int* w, int xsize, int ysize, double prefactor) {
  ...
  vlocal[hook(9, get_local_id(0))] = 0;
  barrier(0x01);
  ...
  for (int load_number = 0; load_number < num_loads; load_number++) {
    ...
    if (load_id < n) {
      slocal[hook(10, get_local_id(0))] = s[hook(1, load_id)];
      qlocal[hook(11, get_local_id(0))] = q[hook(2, load_id)];
    } else {
      slocal[hook(10, get_local_id(0))] = -1;
      qlocal[hook(11, get_local_id(0))] = -1;
    }
    barrier(0x01);

    int sj = slocal[hook(10, get_local_id(0))];
    if (sj >= 0) {
      ...
      if (r > 0 && r < c2) {
        vlocal[hook(9, get_local_id(0))] = vlocal[hook(9, get_local_id(0))] + qlocal[hook(11, get_local_id(0))] * rsqrt(r);
      }
    }
    barrier(0x01);
  }
