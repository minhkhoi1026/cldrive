...
kernel void kmeans_kernel_c(global float* restrict feature, global float* restrict clusters, global int* restrict membership, int npoints, int nclusters, int nfeatures) {
  ...
  for (int point_id = 0; point_id < npoints / 16; point_id++) {
    ...
    p_feature8[hook(15, 0)] = feature[hook(0, 0 * npoints + point_id8)];
    p_feature8[hook(15, 1)] = feature[hook(0, 1 * npoints + point_id8)];
    p_feature8[hook(15, 2)] = feature[hook(0, 2 * npoints + point_id8)];
    p_feature8[hook(15, 3)] = feature[hook(0, 3 * npoints + point_id8)];
    p_feature8[hook(15, 4)] = feature[hook(0, 4 * npoints + point_id8)];
    p_feature8[hook(15, 5)] = feature[hook(0, 5 * npoints + point_id8)];
    p_feature8[hook(15, 6)] = feature[hook(0, 6 * npoints + point_id8)];
    p_feature8[hook(15, 7)] = feature[hook(0, 7 * npoints + point_id8)];

    p_feature9[hook(16, 0)] = feature[hook(0, 0 * npoints + point_id9)];
    p_feature9[hook(16, 1)] = feature[hook(0, 1 * npoints + point_id9)];
    p_feature9[hook(16, 2)] = feature[hook(0, 2 * npoints + point_id9)];
    p_feature9[hook(16, 3)] = feature[hook(0, 3 * npoints + point_id9)];
    p_feature9[hook(16, 4)] = feature[hook(0, 4 * npoints + point_id9)];
    p_feature9[hook(16, 5)] = feature[hook(0, 5 * npoints + point_id9)];
    p_feature9[hook(16, 6)] = feature[hook(0, 6 * npoints + point_id9)];
    p_feature9[hook(16, 7)] = feature[hook(0, 7 * npoints + point_id9)];

    p_feature10[hook(17, 0)] = feature[hook(0, 0 * npoints + point_id10)];
    p_feature10[hook(17, 1)] = feature[hook(0, 1 * npoints + point_id10)];
    p_feature10[hook(17, 2)] = feature[hook(0, 2 * npoints + point_id10)];
    p_feature10[hook(17, 3)] = feature[hook(0, 3 * npoints + point_id10)];
    p_feature10[hook(17, 4)] = feature[hook(0, 4 * npoints + point_id10)];
    p_feature10[hook(17, 5)] = feature[hook(0, 5 * npoints + point_id10)];
    p_feature10[hook(17, 6)] = feature[hook(0, 6 * npoints + point_id10)];
    p_feature10[hook(17, 7)] = feature[hook(0, 7 * npoints + point_id10)];

    p_feature11[hook(18, 0)] = feature[hook(0, 0 * npoints + point_id11)];
    p_feature11[hook(18, 1)] = feature[hook(0, 1 * npoints + point_id11)];
    p_feature11[hook(18, 2)] = feature[hook(0, 2 * npoints + point_id11)];
    p_feature11[hook(18, 3)] = feature[hook(0, 3 * npoints + point_id11)];
    p_feature11[hook(18, 4)] = feature[hook(0, 4 * npoints + point_id11)];
    p_feature11[hook(18, 5)] = feature[hook(0, 5 * npoints + point_id11)];
    p_feature11[hook(18, 6)] = feature[hook(0, 6 * npoints + point_id11)];
    p_feature11[hook(18, 7)] = feature[hook(0, 7 * npoints + point_id11)];

    p_feature12[hook(19, 0)] = feature[hook(0, 0 * npoints + point_id12)];
    p_feature12[hook(19, 1)] = feature[hook(0, 1 * npoints + point_id12)];
    p_feature12[hook(19, 2)] = feature[hook(0, 2 * npoints + point_id12)];
    p_feature12[hook(19, 3)] = feature[hook(0, 3 * npoints + point_id12)];
    p_feature12[hook(19, 4)] = feature[hook(0, 4 * npoints + point_id12)];
    p_feature12[hook(19, 5)] = feature[hook(0, 5 * npoints + point_id12)];
    p_feature12[hook(19, 6)] = feature[hook(0, 6 * npoints + point_id12)];
    p_feature12[hook(19, 7)] = feature[hook(0, 7 * npoints + point_id12)];

    p_feature13[hook(20, 0)] = feature[hook(0, 0 * npoints + point_id13)];
    p_feature13[hook(20, 1)] = feature[hook(0, 1 * npoints + point_id13)];
    p_feature13[hook(20, 2)] = feature[hook(0, 2 * npoints + point_id13)];
    p_feature13[hook(20, 3)] = feature[hook(0, 3 * npoints + point_id13)];
    p_feature13[hook(20, 4)] = feature[hook(0, 4 * npoints + point_id13)];
    p_feature13[hook(20, 5)] = feature[hook(0, 5 * npoints + point_id13)];
    p_feature13[hook(20, 6)] = feature[hook(0, 6 * npoints + point_id13)];
    p_feature13[hook(20, 7)] = feature[hook(0, 7 * npoints + point_id13)];

    p_feature14[hook(21, 0)] = feature[hook(0, 0 * npoints + point_id14)];
    p_feature14[hook(21, 1)] = feature[hook(0, 1 * npoints + point_id14)];
    p_feature14[hook(21, 2)] = feature[hook(0, 2 * npoints + point_id14)];
    p_feature14[hook(21, 3)] = feature[hook(0, 3 * npoints + point_id14)];
    p_feature14[hook(21, 4)] = feature[hook(0, 4 * npoints + point_id14)];
    p_feature14[hook(21, 5)] = feature[hook(0, 5 * npoints + point_id14)];
    p_feature14[hook(21, 6)] = feature[hook(0, 6 * npoints + point_id14)];
    p_feature14[hook(21, 7)] = feature[hook(0, 7 * npoints + point_id14)];

    p_feature15[hook(22, 0)] = feature[hook(0, 0 * npoints + point_id15)];
    p_feature15[hook(22, 1)] = feature[hook(0, 1 * npoints + point_id15)];
    p_feature15[hook(22, 2)] = feature[hook(0, 2 * npoints + point_id15)];
    p_feature15[hook(22, 3)] = feature[hook(0, 3 * npoints + point_id15)];
    p_feature15[hook(22, 4)] = feature[hook(0, 4 * npoints + point_id15)];
    p_feature15[hook(22, 5)] = feature[hook(0, 5 * npoints + point_id15)];
    p_feature15[hook(22, 6)] = feature[hook(0, 6 * npoints + point_id15)];
    p_feature15[hook(22, 7)] = feature[hook(0, 7 * npoints + point_id15)];
