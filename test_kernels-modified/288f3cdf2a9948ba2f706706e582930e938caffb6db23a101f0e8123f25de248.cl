...
kernel void moments(global float8* data, global float* group_result, int NUM_WORK_ITEMS, local float* local_result, global double* central_moments, global int* workgroups_left, float x_, float y_) {
  ...
  float8 input_data = data[hook(0, data_offset)];
  ...
  if (get_local_id(0) == 0) {
    ...
    if (0 == *workgroups_left) {
      ...
      central_moments[hook(4, 0)] = moment02;
      central_moments[hook(4, 1)] = moment03;
      central_moments[hook(4, 2)] = moment11;
      central_moments[hook(4, 3)] = moment12;
      central_moments[hook(4, 4)] = moment20;
      central_moments[hook(4, 5)] = moment21;
      central_moments[hook(4, 6)] = moment30;
    }
  }
}