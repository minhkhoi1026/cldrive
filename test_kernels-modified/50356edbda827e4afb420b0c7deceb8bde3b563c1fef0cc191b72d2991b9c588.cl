...
__attribute__((num_simd_work_items(4))) __attribute__((reqd_work_group_size(32, 1, 1))) __attribute__((reqd_work_group_size(32, 1, 1))) kernel void reduce_kernel(long d_no, int d_mul, global float* restrict d_sums, global float* restrict d_sums2, int gridDim) {
