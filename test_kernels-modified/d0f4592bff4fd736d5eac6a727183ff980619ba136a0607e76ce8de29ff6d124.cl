...
kernel void s_kernel_csr_spmv_vector(const int num_rows, global const int* row_offset, global const int* col, global const float* val, global const float* x, global float* y, local volatile float* sdata) {
