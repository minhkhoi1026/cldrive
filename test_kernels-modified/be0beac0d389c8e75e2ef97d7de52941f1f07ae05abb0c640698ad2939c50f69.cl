...
kernel void nw_kernel2(__attribute__((address_space(1))) int* reference_d, __attribute__((address_space(1))) int* input_itemsets_d, __attribute__((address_space(1))) int* output_itemsets_d, __attribute__((address_space(2))) int* input_itemsets_l, __attribute__((address_space(2))) int* reference_l, int cols, int penalty, int blk, int block_width, int worksize, int offset_r, int offset_c) {
  ...
  if (tx == 0)
    input_itemsets_l[hook(3, 0 + tx * (64 + 1))] = input_itemsets_d[hook(1, index_nw)];
  ...
  for (int ty = 0; ty < 64; ty++)
    input_itemsets_d[hook(1, index + ty * cols)] = input_itemsets_l[hook(3, (tx + 1) + (ty + 1) * (64 + 1))];
