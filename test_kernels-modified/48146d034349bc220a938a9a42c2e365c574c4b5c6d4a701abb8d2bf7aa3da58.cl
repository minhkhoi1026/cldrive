//{"input":1,"inputDimensions":3,"mask":2,"maskDimensions":4,"output":0}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void simpleConvolution(global unsigned int* output, global unsigned int* input, global float* mask, const uint2 inputDimensions, const uint2 maskDimensions) {
