//{"currPtr_0":6,"currPtr_1":7,"currPtr_2":8,"currPtr_3":9,"currPtr_4":10,"currPtr_5":11,"currPtr_6":12,"currPtr_7":13,"dataArray":0,"interval":5,"iter":2,"localArray":1,"num":3,"stride":4}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void Process_8(global ulong* dataArray, local ulong* localArray, long iter, int num, int stride, int interval) {
  int idx = 0;
