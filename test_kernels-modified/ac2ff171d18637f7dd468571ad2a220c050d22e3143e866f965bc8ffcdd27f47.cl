...
kernel void test_arg_8_1_kern(global float4* a0, global float4* a1, global float4* a2, global float4* a3, global float4* a4, global float4* a5, global float4* a6, global float4* a7, global float4* b0) {
  ...
  float4 tmp7 = a7[hook(7, gtid)] + 7.1f + za;
