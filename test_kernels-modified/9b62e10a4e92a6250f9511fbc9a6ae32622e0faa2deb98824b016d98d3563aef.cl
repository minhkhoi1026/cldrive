...
__attribute__((reqd_work_group_size(64, 1, 1))) __attribute__((reqd_work_group_size(64, 1, 1))) __attribute__((reqd_work_group_size(64, 1, 1))) kernel void scan_exclusive_part_int4(global int4 const* in_array, global int4* out_array, unsigned int numElems, global int* out_sums, local int* shmem) {
