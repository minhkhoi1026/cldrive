...
inline void sha512_block(unsigned long* w) {
  unsigned long a = H[hook(2, 0)];
  unsigned long b = H[hook(2, 1)];
  unsigned long c = H[hook(2, 2)];
  unsigned long d = H[hook(2, 3)];
  unsigned long e = H[hook(2, 4)];
  unsigned long f = H[hook(2, 5)];
  unsigned long g = H[hook(2, 6)];
  unsigned long h = H[hook(2, 7)];
  unsigned long t1, t2;
