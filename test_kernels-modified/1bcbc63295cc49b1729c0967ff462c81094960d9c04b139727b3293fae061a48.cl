//{"data":0,"direction":3,"mmm0":6,"mmm1":7,"stage":1,"subStage":2,"temp0":4,"temp1":5}
...
kernel void bitonic_sort(global float4* data, const unsigned int stage, const unsigned int subStage, const unsigned int direction) {
  ...
  float4 leftElement = data[hook(0, leftId)];
  float4 rightElement = data[hook(0, rightId)];
