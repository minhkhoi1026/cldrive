...
kernel void smooth_lmem(global const float4* restrict vertex4_array, local float* restrict local_vertex_array, global const unsigned int* restrict adjs_array, global float4* restrict result_vertex4_array, unsigned int nels, float factor) {
