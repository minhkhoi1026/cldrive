//{"currPtr_0":4,"currPtr_1":5,"currPtr_2":6,"currPtr_3":7,"currPtr_4":8,"currPtr_5":9,"currPtr_6":10,"currPtr_7":11,"dataArray":0,"interval":3,"num":1,"stride":2}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void GeneratePattern_8(global ulong* dataArray, int num, int stride, int interval) {
  int idx = 0;
