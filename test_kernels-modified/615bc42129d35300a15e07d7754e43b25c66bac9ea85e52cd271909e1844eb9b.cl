//{"a0":0,"a1":1,"a2":2,"b0":3,"b1":4,"c0":5,"c1":6,"c2":7}
int hook(int argId, int id) {
	int gID = get_global_id(0);
	printf("%d,%d,%d\n", gID, argId, id);
	return id;
}
kernel void test_block_3_2_kern(global float* a0, global float* a1, global float* a2, global float* b0, global float* b1, local float* c0, local float* c1, local float* c2) {
  int i;
