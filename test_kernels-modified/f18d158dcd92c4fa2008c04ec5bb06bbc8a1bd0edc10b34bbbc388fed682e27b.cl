//{"R":5,"V":6,"d_Call":0,"d_Put":1,"d_S":2,"d_T":4,"d_X":3,"optN":7}
...
kernel void BlackScholes(global float* d_Call, global float* d_Put, global float* d_S, global float* d_X, global float* d_T, float R, float V, unsigned int optN) {
