...
__attribute__((num_simd_work_items(4))) __attribute__((reqd_work_group_size(32, 1, 1))) __attribute__((reqd_work_group_size(32, 1, 1))) __attribute__((num_simd_work_items(2))) __attribute__((reqd_work_group_size(32, 1, 1))) kernel void srad_kernel(int d_Nr, long d_Ne, global int* restrict d_iN, global int* restrict d_iS, global int* restrict d_jE, global int* restrict d_jW, global float* restrict d_dN, global float* restrict d_dS, global float* restrict d_dE, global float* restrict d_dW, float d_q0sqr, global float* restrict d_c, global float* restrict d_I) {
