...
kernel void smpol_computeSseMaskFn(int layerSize, global char* patTypes, global float* targets, global float* outputs, global float* out, local float* shared, int n) {
