...
kernel void compObjWave_MultiPass_aligned(global float4* pc, unsigned int pc_size, global float2* of, int offset, int num_cols, float hologram_z, float k, float pitch, float corner_x, float corner_y) {
