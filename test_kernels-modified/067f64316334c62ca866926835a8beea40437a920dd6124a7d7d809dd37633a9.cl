//{"Neffect_radius":6,"Nq":2,"background":8,"cutoff":5,"loops":4,"loops_g":3,"q":0,"result":1,"scale":7,"volfraction":9}
...
kernel void hardsphere_Iq(global const float* q, global float* result, const int Nq,
...

  {
    ...
    for (int effect_radius_i = 0; effect_radius_i < Neffect_radius; effect_radius_i++) {
      ...
      if (weight > cutoff) {
        const float scattering = Iq(qi, effect_radius, volfraction);
