//{"FEs":2,"dTip":9,"dinvA":3,"dinvB":4,"dinvC":5,"dpos0":10,"imgIn":0,"nz":11,"points":1,"tipA":6,"tipB":7,"tipC":8}
...
kernel void getFEinStrokesTilted(read_only image3d_t imgIn, global float4* points, global float4* FEs, float4 dinvA, float4 dinvB, float4 dinvC, float4 tipA, float4 tipB, float4 tipC, float4 dTip, float4 dpos0, int nz) {
