...
kernel void conv2d1x1(const int input_channels, const int input_size, global float* input_im, global const float* filter_weight, global const float* filter_bias, global float* restrict output_im) {
