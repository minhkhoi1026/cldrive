...
kernel void test_block_3_4_kern(global int* a0, global int* a1, global int* a2, global int* b0, global int* b1, global int* b2, global int* b3, local int* c0, local int* c1, local int* c2) {
  int i;
