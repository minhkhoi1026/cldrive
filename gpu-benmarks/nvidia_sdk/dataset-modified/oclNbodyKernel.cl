//{"<recovery-expr>()":11,"<recovery-expr>(sharedPos)":10,"damping":5,"deltaTime":4,"i++ + <recovery-expr>(mul24, get_local_size(0), get_local_id(1))":9,"newPos":0,"newVel":1,"numBodies":7,"oldPos":2,"oldVel":3,"sharedPos":8,"softeningSquared":6}
                           ...
                           __local REAL4* sharedPos)
{
    ...
    {
        sharedPos[hook(10, threadIdxx + blockDimx * threadIdxy)] = 
                             ...
                             __local REAL4* sharedPos)
{
    ...
    for (unsigned int tile = blockIdxy; tile < numTiles + blockIdxy; tile++) 
    {
        sharedPos[hook(10, threadIdxx + mul24(blockDimx, threadIdxy))] = 
