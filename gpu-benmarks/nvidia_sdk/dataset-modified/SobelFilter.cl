//{"fHSum":12,"fThresh":6,"fVSum":13,"iDevGMEMOffset + <recovery-expr>(mul24, get_local_size(1), get_global_size(0))":7,"iDevImageHeight":5,"iImageWidth":4,"iLocalPixPitch":3,"mul24((iDevYPrime + (int)get_local_size(1)), (int)get_global_size(0)) + <recovery-expr>(mul24, (get_group_id(0) + 1), get_local_size(0))":11,"mul24((iDevYPrime + (int)get_local_size(1)), (int)get_global_size(0)) + <recovery-expr>(mul24, get_group_id(0), get_local_size(0)) - 1":9,"mul24(iDevYPrime, (int)get_global_size(0)) + <recovery-expr>(mul24, (get_group_id(0) + 1), get_local_size(0))":10,"mul24(iDevYPrime, (int)get_global_size(0)) + <recovery-expr>(mul24, get_group_id(0), get_local_size(0)) - 1":8,"uc4LocalData":2,"uc4Source":0,"uiDest":1}
                      ...
                      int iImageWidth, int iDevImageHeight, float fThresh)
{
    ...
    else if (get_local_id(0) == 0) // Work items with x ID at left workgroup edge will read right apron pixel
    {
        ...
        if (get_local_id(1) < 2)
        {
            ...
            if (((iDevYPrime + get_local_size(1)) < iDevImageHeight) && (mul24((get_group_id(0) + 1), get_local_size(0)) < iImageWidth) )
            {
                ...
                uc4LocalData[hook(2, iLocalPixOffset)] = hook(11, uc4Source)];
            }
            else 
            {
                uc4LocalData[hook(2, iLocalPixOffset)] = (uchar4)0; 
    ...
    // NW
	fHSum[hook(12, 0)] += (float)uc4LocalData[hook(2, iLocalPixOffset)].x;    // horizontal gradient of Red
	fHSum[hook(12, 1)] += (float)uc4LocalData[hook(2, iLocalPixOffset)].y;    // horizontal gradient of Green
	fHSum[hook(12, 2)] += (float)uc4LocalData[hook(2, iLocalPixOffset)].z;    // horizontal gradient of Blue
    fVSum[hook(13, 0)] -= (float)uc4LocalData[hook(2, iLocalPixOffset)].x;    // vertical gradient of Red
	fVSum[hook(13, 1)] -= (float)uc4LocalData[hook(2, iLocalPixOffset)].y;    // vertical gradient of Green
	fVSum[hook(13, 2)] -= (float)uc4LocalData[hook(2, iLocalPixOffset++)].z;  // vertical gradient of Blue

    // N
	fVSum[hook(13, 0)] -= (float)(uc4LocalData[hook(2, iLocalPixOffset)].x << 1);  // vertical gradient of Red
	fVSum[hook(13, 1)] -= (float)(uc4LocalData[hook(2, iLocalPixOffset)].y << 1);  // vertical gradient of Green
	fVSum[hook(13, 2)] -= (float)(uc4LocalData[hook(2, iLocalPixOffset++)].z << 1);// vertical gradient of Blue
    ...
    // W
	fHSum[hook(12, 0)] += (float)(uc4LocalData[hook(2, iLocalPixOffset)].x << 1);  // vertical gradient of Red
	fHSum[hook(12, 1)] += (float)(uc4LocalData[hook(2, iLocalPixOffset)].y << 1);  // vertical gradient of Green
	fHSum[hook(12, 2)] += (float)(uc4LocalData[hook(2, iLocalPixOffset++)].z << 1);// vertical gradient of Blue
	...
	fTemp =  0.30f * sqrt((fHSum[hook(12, 0)] * fHSum[hook(12, 0)]) + (fVSum[hook(13, 0)] * fVSum[hook(13, 0)]));
	fTemp += 0.55f * sqrt((fHSum[hook(12, 1)] * fHSum[hook(12, 1)]) + (fVSum[hook(13, 1)] * fVSum[hook(13, 1)]));
	fTemp += 0.15f * sqrt((fHSum[hook(12, 2)] * fHSum[hook(12, 2)]) + (fVSum[hook(13, 2)] * fVSum[hook(13, 2)]));
