//{"a":4,"a0":4,"a1":5,"a2":6,"a3":7,"b1":8,"b2":9,"coefn":11,"coefp":10,"iHeight":3,"iWidth":2,"uiDataIn":0,"uiDataOut":1,"uiLocalBuff":4}
                        ...
                        __local unsigned int* uiLocalBuff)
{
    ...
    {
        uiLocalBuff[hook(4, get_local_id(1) * (get_local_size(0) + 1) + get_local_id(0))] = uiDataIn[hook(0, (yIndex * iWidth) + xIndex)];
    }
    ...
    {
        uiDataOut[hook(1, (yIndex * iHeight) + xIndex)] = uiLocalBuff[hook(4, get_local_id(0) * (get_local_size(1) + 1) + get_local_id(1))];
    }
}
